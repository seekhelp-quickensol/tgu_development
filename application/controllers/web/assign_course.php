											...
											<table border="1">
												...
												<tbody>
													<tr>
														...
														<td><input type="text" class="form-control" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="registration_fees" id="registration_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?php if($stream_result->registration_fees == "") { echo "1000"; } else { echo $stream_result->registration_fees; } ?>"></td>
														<td><input type="text" class="form-control" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="examination_fees" id="examination_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?php if($stream_result->exam_fees == "") { echo "500"; } else { echo $stream_result->exam_fees; } ?>"></td>
													</tr>
												</tbody>
												<?php }} ?>
											</table>
