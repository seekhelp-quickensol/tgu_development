...
$session = array( 
	'session_amount' 	=> $fees->total_fees, 
	'order_id' 			=> $fees->id, 
); 
...
<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
	...
	<table width="40%" height="100" border='1' align="center" style="display:none;"> 
		...
		<tr> 
			<td>Amount	:</td><td><input type="text" name="amount" value="<?=$fees->total_fees?>.00"/></td> 
		</tr> 
		<tr> 
		...
		<tr> 
			<td>shipping City	:</td><td><input type="text" name="delivery_city" value="Itanagar"/></td> 
		</tr> 
		<tr> 
