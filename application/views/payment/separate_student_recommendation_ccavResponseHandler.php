<?php include('Crypto.php');
	...
	$exist = $this->db->get('tbl_separate_student_recommendation_letter');
	...
	$real_fees = $this->db->get('tbl_separate_student_recommendation_letter');
...
for($i = 0; $i < $dataSize; $i++) 
	...
	$this->db->select('tbl_separate_student_recommendation_letter.*, tbl_separate_student.student_name, tbl_separate_student.mobile, tbl_separate_student.address');

	$this->db->where('tbl_separate_student_recommendation_letter.id',$order_id);
...
<body>
	...
	<div class="container">
		...
		<table>
			...
			<thead>
				...
				<tr style="text-align:center;">
					...
					<td>Recommendation Letter Fees</td>
		...
		<a href="<?=base_url()?>s-latter-of-recommendation" style="text-decoration: none;margin-top:10px;background:#000;color:#fff;padding:10px 21px;border-radius:3px;border:none;cursor:pointer;font-size: 13px;">Back</a>
