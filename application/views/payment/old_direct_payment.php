...
<div class="header_cc_area" style="background-image:url('<?=$this->Digitalocean_model->get_photo('images/header_area.jpg')?>')">
				<div class="container">
					<div class="row">
						<h1>Direct Payment Form</h1>
						<p>Payment / Direct Payment Form</p>
					</div>
				</div>
			</div>
	...
	<div class="container">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
        	 ...
        	 <form enctype="application/json" action="https://checkout.freecharge.in" id="searchForm" method="post">
		     <fieldset>
             ...
             <form method="post" name="customerData" action="<?=base_url();?>direct_ccavRequestHandler">
				<div class="row">
					<div class="col-lg-12">
						<div class="btn_center" style="width: 175px;margin: 25px auto 0px;">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?=$payment->amount?>.00"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>direct_ccavResponseHandler"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>direct_ccavResponseHandler"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$payment->name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$payment->address?>"/></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$payment->pincode?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Country	:</td><td><input type="text" name="billing_country" value="India"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$payment->mobile_number?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$payment->email?>"/></td>
		        </tr>
		        <tr>
