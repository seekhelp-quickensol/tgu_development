...
$this->db->where('id !=', $order_id);
$exist = $this->db->get('tbl_center_wallet_history');
$exist = $exist->row();
if (!empty($exist)) {
	//echo "exist";
...
$this->db->where('id', $order_id);
$real_fees = $this->db->get('tbl_center_wallet_history');
$real_fees = $real_fees->row();
$session_data = array(
	'center_id' => $real_fees->center_id
);
...
if(strlen($result->id) == "1"){
	$receipt_no = "WAL-000".$result->id;    
}else if(strlen($result->id) == "2"){
	$receipt_no = "WAL-00".$result->id;     
}else if(strlen($result->id) == "3"){
	$receipt_no = "WAL-0".$result->id;     
}else{
	$receipt_no = "WAL-".$result->id;
}
$date_of_receipt = date("d/m/Y",strtotime($result->created_on));
$enrollment_number = $result->id;
$student_name = $center_profile->center_name; 
$address = $center_profile->address.', '.$center_profile->city_name.', '.$center_profile->state_name.', '.$center_profile->country_name.'-'.$center_profile->pincode;
$mobile = $center_profile->head_contact_number;
$email = $center_profile->head_email;
$ref_level = "Pyament#";
$pay_for="Wallet Recharge";
    ...
    <div class="tm_invoice_wrap">
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="<?=base_url();?>assets/images/global_university_logo.png" style="max-height: 107px;" alt="Logo"></div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0" style="color:white;">Receipt No: <b><?=$receipt_no?></b></p>
              <p class="tm_invoice_date tm_m0" style="color:white;">Date: <b><?=$date_of_receipt?></b></p>
            </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    ...
                    <tr class="tm_accent_bg">
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"><?=$print_amount?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div class="tm_invoice_btns tm_hide_print">
        ...
        <button id="tm_download_btn" class="tm_invoice_btn tm_color2">
          ...
          <a href="<?=base_url();?>wallet-recharge-history" class="tm_invoice_btn tm_color1">
  <span class="tm_btn_icon">
