...
<body>
	<div class="container">
		...
		<table>
				...
				<td colspan="2" rowspan="2" style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
				...
				<h2 style="font-size: 15px;margin: 0px;margin-bottom:5px; text-align:;left">User Details:</h2>
					<span style="float:left">Registration Number- <?=$result->id?></span><br>
					<span style="float:left">Name- <?=$student->student_name?></span><br>
					<span style="float:left">Invoice No - <?=$result->transaction_id?></span><br>
					<span style="float:left">Payment status - <?=$order_status?></span><br>
					<span style="float:left">Address: <?=$student->address?></span><br/>
					<span style="float:left">Contact Number: <?=$student->mobile?></span><br/>
				</td>
				</thead>
				<tbody>
				...
				<tr style="text-align:center;">
					...
					<td><?=$order_status?></td>
					<td colspan="2" >Rs. <?=$result->total_fees?></td>
				...
				<tr style="background:#ccc;text-align:center;">
					...
					<td>-</td>
					<td>-</td>
					<td colspan="2" ><b>Rs.<?=$result->total_fees;?></b></td>
				</tr>
