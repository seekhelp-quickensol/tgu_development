...
// echo"<pre>";print_r($dataSize);exit;
        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0" style="margin-right:10px">Receipt No: <b>#<?=$result->transaction_id?></b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
            <div class="tm_invoice_left">
			 <p class="tm_mb2"><b class="tm_primary_color">Receipt To:</b></p>
              <p>
                Student Name: <?=$result->student_name?><br>
                Print Name: <?=$result->print_name?><br>
                Stream Name: <?=$result->stream_name?><br>
               Address: <?=$result->address.', '.$result->city_name.', '.$result->state_name.', '.$result->country_name.'-'.$result->pincode?><br>
          ...
          <div class="tm_table tm_style1">
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
						...
						<td class="tm_width_4">Coursework Fees</td>
						<td class="tm_width_2"><?=$result->transaction_id?></td>
						<td class="tm_width_1"><?=$result->payment_ammount?></td>
						<td class="tm_width_2 tm_text_right"><?=$result->payment_ammount?></td>
                    </tr> 
                  </tbody>
                </table>
              </div> 
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                ...
                <p class="tm_m0">Payment By: <?=$payment_by?> <br>Amount: <?=$result->payment_ammount?></p>
              </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$result->payment_ammount?></td>
                    </tr>
                    <tr class="tm_gray_bg">
                    ...
                    <tr class="tm_accent_bg">
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"><?=$result->payment_ammount?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
