...
$order_id = $order_id[1];
	...
	$exist = $this->db->get('tbl_student_recommendation_letter');
	...
	$real_fees =$this->db->get('tbl_student_recommendation_letter');
	...
	echo "</table><brBIR TIKENDRAJIT UNIVERSITY
	...
	*/
	...
	$this->db->select('tbl_student_recommendation_letter.*, tbl_student.student_name, tbl_student.mobile, tbl_student.address, tbl_student.pincode, countries.name as country_name, states.name as state_name, cities.name as city_name');

	$this->db->where('tbl_student_recommendation_letter.id',$order_id);
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
						...
						<td class="tm_width_4">Recommendation Letter Fees</td>
