...
$session = array(
	'session_amount' 	=> $center_data->amount, 
	'order_id' 			=> $center_data->fees_id, 
); 
	...
	<div class="container">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
             ...
             <form method="post" name="customerData" action="<?=base_url();?>center_payment_ccavRequestHandler_foregin">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			...
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					...
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$center_data->fees_id?>"/></td>
				...
				<tr>
					...
					<td>Amount	:</td><td><input type="text" name="amount" value="<?=$center_data->amount?>.00"/></td>
				...
				<tr>
					...
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>center_payment_ccavResponseHandler_foregin"/></td>

				</tr>

			 	<tr>

			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>center_payment_ccavResponseHandler_foregin"/></td>
		        ...
		        <tr>
		        	...
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$center_data->head_name?>"/></td>

		        </tr>

		        <tr>

		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$center_data->address?>"/></td>
		        ...
		        <tr>
		        	...
		        	<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$center_data->pincode?>"/></td>
		        ...
		        <tr>
		        	...
		        	<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$center_data->head_contact_number?>"/></td>

		        </tr>

		        <tr>

		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$center_data->head_email?>"/></td>
