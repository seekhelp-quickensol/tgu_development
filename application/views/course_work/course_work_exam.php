...
// echo "<pre>";print_r($text_data->options->question);exit;
...
include('header.php');
   ...
   $duration = $test_time->exam_duration . ' minute';
      ...
      <div class="col-md-9 grid-margin stretch-card">
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p>Total Number of Questions Attempted: <span id="totalAttemptedCount">0</span></p>
               ...
               <form class="forms-sample" name="question_paper_form" id="question_paper_form" method="post" enctype="multipart/form-data">
                  ...
                  <?php
                     ...
                     for ($i=0; $i < count($question_paper); $i++) {
                     	...
                     	$fieldset_class_id = $question_set->id;

                     	?>

                  <div class="row">

                     <p style="font-size: 18px;font-weight: 600;margin-bottom: 10px;padding: 10px;width: 100%;background: #eee;"><?=$q_no?> : <?php if($text_data->options->question != ""){ echo str_replace('�',' ',$text_data->options->question) ;}?></p>

                    

                     <div class="input-group mb-12" id='<?= $fieldset_class?>'>

                     	<input type="hidden" name="question_name[]" id="question_name_<?=$fieldset_class_id;?>" value="<?=$fieldset_class_id;?>">
                        ...
                        <fieldset class='<?=$fieldset_class?>'>
                           ...
                           <ul style="list-style: none;width: 100%;">
                              ...
                              <li style="display: inline-block;width: 49%;"><input type="radio" value="<?= ($j+1)?>" name='<?= $fieldset_class?>'  onclick="updateCount('<?= $fieldset_class?>')"> <?=str_replace('�',' ',$op_data) ?></li>
...
<script>
   ...
   setInterval(function(){
       ...
       console.log($("#exam_timer").TimeCircles().getTime());
   ...
   //window.open ("https://www.birtikendrajituniversity.ac.in/show_exam/","mywindow","status=1,toolbar=0");
...
$(document).ready(function() {
    ...
    function updateCount(fieldsetClass) {
        var selectedCount = $('input[name=' + fieldsetClass + ']:checked').length;
        attemptedCounts[fieldsetClass] = selectedCount;
        $('#attemptedCount_' + fieldsetClass).text(selectedCount);
    ...
    $('input[type="radio"]').on('click', function() {
        var fieldsetClass = $(this).closest('fieldset').attr('class');
        updateCount(fieldsetClass);
    });
});
</script>
