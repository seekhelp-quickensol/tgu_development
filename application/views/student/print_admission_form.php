    ...
    <head>
        ...
        <style type="text/css">
            ...
            table.examTable td{
            	...
            	font-weight: bold;THE GLOBAL UNIVERSITY
...
<?php     
    ...
    <button class="btn btn-primary" onclick="window.print()">Click Here To Print</button>

    <!-- <button class="btn btn-primary" onclick="printChallan()">Print Form</button> -->

	</div>

	<div style="width: 670px;margin: 0px auto;border: 2px dashed #e93803;" id="challanDiv">
          ...
          <tr><td colspan="4" style="border-bottom: 2px solid #cccccc;">
            ...
            <table class="headerTable" width="100%" cellpadding="2" align="center">
                ...
                <tbody>
                    ...
                    <tr><td align="right" rowspan="2"><img src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->logo)?>" width="90" height="90" /></td>

                        <td class="colhead" align="center">THE GLOBAL UNIVERSITY



						<br>Complete Learning Management
    ...
    <tbody>
        ...
        <tr><td colspan="2">
            ...
            <table width="100%">
                ...
                <tr><td class="heading1" width="160px">Username:</td>

                    <td class="data1" width="170px"><?=$admission->username?></td>

                    <td class="heading1" width="160px">Password:</td>

                    <td class="data1" width="170px"><?=$admission->password?></td>
        ...
        <tr><td colspan="2">
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="160px">Enrollment No:</td>

                        <td class="data" width="170px"><?=$admission->enrollment_number?></td>

                        <!-- <td class="heading1" width="160px">Enrollment Date:</td>

                        <td class="data" width="170px"><?php //date("d-m-Y",strtotime($admission->enrollment_date))?></td> -->
        ...
        <tr><td class="heading1">Name of the Candidate:</td>

            <td class="data"><?=$admission->student_name?></td>

        </tr>

        <tr><td class="heading1">Father's Name:</td>

            <td class="data"><?=$admission->father_name?></td>

        </tr>

        <tr><td class="heading1">Mother's Name:</td>

            <td class="data"><?=$admission->mother_name?></td>
        ...
        <tr><td colspan="2">
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="160px">Date Of Birth:</td>

                        <td class="data" width="170px"><?=date("d-m-Y",strtotime($admission->date_of_birth))?></td>

                        <td class="heading1" width="160px">Nationality:</td>

                        <td class="data" width="170px"><?=$admission->nationality?></td>
        ...
        <tr><td class="heading1">Candidate Address:</td>
            ...
            <td class="data"><?=$admission->address?></td>
			...
			<td>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="data" width="150px"><?=$admission->city_name?></td>

                        <td class="heading1" width="100px">Pin Code:</td>

                        <td class="data" width="150px"><?=$admission->pincode?></td>
        ...
        <tr><td>&nbsp;</td><td>
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="100px">State:</td>

                        <td class="data" width="150px"><?=$admission->state_name?></td>

                        <td class="heading1" width="100px">Country:</td>

                        <td class="data" width="150px"><?=$admission->country_name?></td>
        ...
        <tr><td colspan="2">
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="160px">Contact Number:</td>

                        <td class="data" width="170px"><?=$admission->mobile?></td>

                        <td class="heading1" width="160px">Email Address:</td>

                        <td class="data" width="170px"><?=$admission->email?></td>
        ...
        <tr><td colspan="2">
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="160px">Category:</td>

                        <td class="data" width="170px"><?=$admission->category?></td>

                        <td class="heading1" width="160px">Gender:</td>

                        <td class="data" width="170px"><?=$admission->gender?></td>
        ...
        <tr><td colspan="2">
                ...
                <table width="100%">
                    ...
                    <tr><td class="heading1" width="160px">Study Mode:</td>

                        <!-- <td class="data" width="170px"><?php //if($admission->admission_type=="0"){ echo "Regular";}else if($admission->admission_type=="1"){ echo "Lateral";}else{ echo "Credit Transfer";}?></td> -->



                        <td class="data" width="170px"><?php 
                        ...
                        <td class="heading1" width="160px">Year/Sem/Month:</td>

                        <td class="data" width="170px"><?=$admission->year_sem?></td>
