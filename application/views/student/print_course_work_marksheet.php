...
<div class="container" id="printDiv" >
	<div  style="background-image: url('<?=$this->Digitalocean_model->get_photo('images/marksheet-bg.jpeg')?>'); background-position: center; background-repeat: no-repeat; width: 100%;height:100%">
    ...
    <div style="" class="certificate_main_div">
			...
			<table class="detailTable3  table-bordered" width="760px" cellpadding="2" align="center">
				...
				<?php
					$subject_details = $this->Students_model->get_course_work_marksheet_details($marksheet_result->id);
				...
				<tr class= "detail table-bordered" width="600px">
					...
					<td>
						<table width="100%">
							<tr>
								<td class="noborder" width="70px"><?=$subject_details_result->int_max+$subject_details_result->ext_max?></td>
								<td class="noborder"><?php if($subject_details_result->int_max !="0"){ echo $subject_details_result->int_max;}?>
									<?php //echo $subject_details_result->ext_max?>40
								</td>
							</tr>
						</table>
					</td>
