              ...
              <div class="card">
                <div class="card-body">
					<ul class="nav nav-tabs tab-no-active-fill" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link pl-2 pr-2" id="data-managed-tab1" data-toggle="tab" href="#data-managed-tab-industrial" role="tab" aria-controls="data-managed" aria-selected="false">Industrial Assessment</a>
						</li>
						<li class="nav-item">
							<a class="nav-link pl-2 pr-2" id="data-managed-tab1" data-toggle="tab" href="#data-managed-tab-guardian" role="tab" aria-controls="data-managed" aria-selected="false">Guardian Assessment</a>
						</li>
					</ul>
					<div class="tab-content tab-no-active-fill-tab-content">
											...
											<tbody>
												...
												<tr>
													...
													<td style="text-align:center">
														<a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/assessment/SELF__PARENT_ASSESSMENT_FORM.pdf')?>" download="" class="btn btn-primary">Download Form</a>
													</td>
													<td style="text-align:center">
										...
										<tbody>
											...
											<?php if(!empty($teacher_assement)){ foreach($teacher_assement as $teacher_assement_result){?>
												<tr>
													...
													<td><a href="<?=$this->Digitalocean_model->get_photo('uploads/assesment_form/self_assement/teacher_assement/'.$teacher_assement_result->file)?>" target="_blank"><i class="mdi mdi-eye"></i></a></td>
												</tr>
											<?php }}?>
										</tbody>
									</table>
						...
						<div class="tab-pane fade" id="data-managed-tab-industrial" role="tabpanel" aria-labelledby="data-managed-tab">
							<div class="d-flex justify-content-between">
								<div class="col-lg-12">
									<form method="post" name="teacher_form" id="teacher_form" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered" width="100%">
										...
										<tbody>
											...
											<?php if(!empty($industrial)){ foreach($industrial as $industrial_result){?>
												<tr>
													...
													<td><a href="<?=$this->Digitalocean_model->get_photo('uploads/assesment_form/self_assement/industry_assesment/'.$industrial_result->file)?>" target="_blank"><i class="mdi mdi-eye"></i></a></td>
												</tr>
											<?php }}?>
										</tbody>
									</table>
						...
						<div class="tab-pane fade" id="data-managed-tab-guardian" role="tabpanel" aria-labelledby="data-managed-tab">
							<div class="d-flex justify-content-between">
								<div class="col-lg-12">
									<form method="post" name="teacher_form" id="teacher_form" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered" width="100%">
											<tbody>
												...
												<tr>
													<td>GUARDIAN ASSESSMENT FORM</td>
													<td style="text-align:center">
														<a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/assessment/')?>" download="" class="btn btn-primary">Download Form</a>
													</td>
													<td style="text-align:center">
														<select class="form-control" name="year_sem" id="year_sem" >
															<option value="">Select Your Sem/Year</option>
													...
													<td style="text-align:center">
														<input class="btn btn-sm btn-primary" type="submit" name="guardian" value="Upload Form">
													</td>
												</tr>
											</tbody>
										</table>
										...
										<tbody>
											...
											<?php if(!empty($guardian)){ foreach($guardian as $guardian_result){?>
												<tr>
													...
													<td><a href="<?=$this->Digitalocean_model->get_photo('uploads/assesment_form/self_assement/guardian_assement/'.$guardian_result->file)?>" target="_blank"><i class="mdi mdi-eye"></i></a></td>
												</tr>
											<?php }}?>
										</tbody>
									</table>
