				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-lg-6 grid-margin grid-margin-md-0">
							<div class="card">
								<div class="card-body col-lg-12">
									<h3 class="bold_bx">Upcoming Exam</h3>
									<div class="row icons-list">
										<?php if(!empty($upcoming)){ foreach($upcoming as $upcoming_result){?>
										<div class="col-sm-12">
											<a <?php if($upcoming_result->exam_date == date("Y-m-d")){?>target="_blank" href="<?=base_url();?>start_exam/<?=base64_encode($upcoming_result->id);?>"<?php }else{?>href="javascript:void(0)"<?php }?>">
												<i class="mdi mdi-access-point"></i> <?=$upcoming_result->exam_name?>
											</a>
										</div>
										<?php }}else{?>
										<div class="col-sm-12">
						...
						<div class="col-lg-6 grid-margin grid-margin-md-0">
							<div class="card">
								<div class="card-body col-lg-12">
									<h3 class="bold_bx">Completed Exam</h3>
									<div class="row icons-list">
										<?php if(!empty($completed)){ foreach($completed as $completed_result){?>
										<div class="col-sm-12">
											<a href="javascript:void(0)">
											  <i class="mdi mdi-access-point"></i> <?=$completed_result->exam_name?> - <?=date("d/m/Y",strtotime($completed_result->exam_date))?>
											</a>
										</div>
										<?php }}else{?>
										<div class="col-sm-12">
											<a href="javascript:void(0)">
											  <i class="mdi mdi-access-point"></i> No Exam Appeared!
											</a>
										</div>
										<?php }?>
									</div>
