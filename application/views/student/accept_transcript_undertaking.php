...
<div class="jumbotron text-center thank-you-container animate animated fadeInDown">
    ...
    <p class="thank-you-content"><strong>Please check your registered email to </strong>Accept our terms & conditions!</p>
    <hr> 
    <p class="lead">
        <a class="thank-you-btn" href="<?=base_url();?>student-dashboard" role="button">Continue to Dashboard</a>
    </p>
</div>
