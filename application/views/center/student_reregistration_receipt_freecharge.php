...
<body>
	...
	<div class="container">
		...
		<table>
				...
				<td colspan="2" rowspan="2" style="border-top: 1px solid #000; border-bottom: 1px solid #000;text-align:center;">
				...
				<td colspan="3" rowspan="2" style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
					...
					<span>Address:THE GLOBAL UNIVERSITY, Thoubal Leishangthem <br>Wangma Taba District Thoubal, Imphal. Arunachal Pradesh, Pin - 795138 </span><br/>
				...
				<h2 style="font-size: 15px;margin: 0px;margin-bottom:5px; text-align:left">Student Details:</h2>
					...
					<span style="float:left">Invoice No - <?=$student_data["transaction_id"]?></span><br>

					<span style="float:left">Payment status - <?=$student_data["payment_status"]?></span><br>
				...
				<tbody>
					...
					<tr style="background:#ccc;text-align:center;">
						...
						<td style="font-weight:600;">Late Fees</td>
				...
				<tr style="text-align:center;">
					...
					<td>Re-Registration Fees</td>

					<td colspan="4"><?=$student_data["transaction_id"]?></td>

					<td>Rs. <?=$student_data["late_fees"]?></td>

					<td>Rs. <?=$student_data["ammount"]?></td>
				...
				<tr style="background:#ccc;text-align:center;">
					...
					<td><b>Rs.<?=$student_data["ammount"];?></b></td>
		...
		<a href="<?=base_url('center-dashboard')?>" style="text-decoration: none;margin-top:10px;background:#000;color:#fff;padding:10px 21px;border-radius:3px;border:none;cursor:pointer;font-size: 13px;">Back</a>
