...
<html>
<head>
    <title>Medium Of Instruction Letter</title>
					...
					<div>
						<div class="letter_area" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/new_marksheet-without.jpeg')?>);background-position: center;background-size: cover;border: 2px solid #e8612b;height: 100%;">  
            							...
            							<div class="head_top_logo"><img src="<?=$this->Digitalocean_model->get_photo('images/only-logo.png')?>"></div>
                                        	...
                                        	<p style="float: left;font-size: 15px;color: #000;font-weight: 700;">Ref No.: TGU/<?=$single->id;?>/MOI/<?= date('Y');?></p>
                                            </div>
							                <div style="clear:both"></div>
							
									<p style="color: #000;font-weight: 700;font-size: 25px; margin-top: 25px;text-align: center"><u>Medium Of Instruction Letter</u> </p>
							...
							<div style="display: block;">
                                    ...
                                    <?php }else{ ?>
                                        D/O 
                                    <?php } ?>
                                    <b><?php if(!empty($single)){echo $single->father_name;}?></b> , Enrollment No . <b><?php echo $single->enrollment_no;?></b>, was a bonafide Regular student ofTHE GLOBAL UNIVERSITY. 
                                    <?php if($single->gender = 'Male'){?>
                                        He
                                    <?php }else{ ?>
                                        She
									...
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">
                                    The medium of instructions of above programme was English language in our University.                               
                                    </p>
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">
                    ...
                    <p style="float: left;padding-left: 30px; margin-bottom:0px;font:bold; font-weight: 700">Sr No. : <?=date('Y',strtotime($single->created_on));?><?=substr($single->enrollment_number,-6);?></p>	
						...
						<div class="letter_area" style=" background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet_background.png')?>);background-position: center top; background-size: cover;border: 2px solid #e8612b;height: 100%;">  
            							...
            							<!-- <div class="head_top_logo"><img src="<?=$this->Digitalocean_model->get_photo('images/only-logo.png')?>"></div> -->
                                        	...
                                        	<p style="float: left;font-size: 15px;color: #000;font-weight: 700;">Ref No.: TGU/<?=$single->id;?>/MOI/<?= date('Y',strtotime($single->application_date));?></p>
                                            </div>
							                <div style="clear:both"></div>
							
									<p style="color: #000;font-weight: 700;font-size: 25px; margin-top: 25px;text-align: center"><u>MEDIUM OF INSTRUCTION</u> </p>
							...
							<div style="display: block;">
                                    ...
                                    <b><?php if(!empty($single)){echo $single->father_name;}?></b> , Enrollment No. <b><?php echo $single->enrollment_no;?></b>, was a bonafide Regular student of The Global University. 
                                        He/She
                                    has successfully completed the <b><?php echo $course_name;?> (<?php echo $stream_name;?>)</b> Degree Programme in <b><?php if(!empty($passing_year)){ echo $passing_year->examination_month.' '.$passing_year->examination_year;}?></b> from our University.
									</p>
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">
                                    The medium of instructions of above programme was English language in our University.                               
                                    </p>
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">
                                    This Certificate is issued on his/her own request. We wish him/her all success in life.
                                    </p>
							...
							<div style=" text-align: center;margin-top: 250px;margin: 0px auto;">
							<!-- <img style="width: 145px;margin-top: 150px;" src="<?=$this->Digitalocean_model->get_photo('images/btu-seal.png')?>"> -->
                            <img style="width: 145px;margin-top: 150px;" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->stamp)?>">   
