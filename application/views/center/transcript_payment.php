...
//$transcript_fee = 1; 
$session = array( 
	'session_amount' 	=> $transcript_fee, 
	'transcript_id' 	=> $student_details->id, 
); 
								...
								<div class="col-md-12"> 
									<div class="card"> 
										...
										<div class="card-body"> 
											...
											<form method="post" name="customerData" action="<?=base_url();?>center_student_transcript_ccavRequestHandler"> 
												<div class="row"> 
													<div class="col-lg-12"> 
														<div class="btn_center" style="width: 175px;margin: 25px auto 0px;"> 
												...
												<tr> 
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student_details->id?>"/></td> 
												</tr> 
												<tr> 
													<td>Amount	:</td><td><input type="text" name="amount" value="<?=$transcript_fee?>.00"/></td> 
												</tr> 
												<tr> 
													<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td> 
												</tr> 
												<tr> 
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>center_student_transcript_ccavResponseHandler"/></td> 
												</tr> 
												<tr> 
													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>center_student_transcript_ccavResponseHandler"/></td> 
												</tr> 
												<tr> 
