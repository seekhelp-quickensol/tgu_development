        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Self Assessment Approved List</h4><p class="card-description">
          ...
          <div class="modal-dialog" id="order_note_dialog" style="margin-top:125px;width:500px;">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="float:none !important; position:absolute;right:10px;top:10px;"  onclick="closePopup('selfNoteModal')">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			{
				extend: "excelHtml5",
                title:"Self Assessment Approved List",
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_ajax_controller/get_self_assessment_approved_ajax",
			"type": "POST",
		},	
		"complete": function() {
