...
if(!empty($bonafide)){
$student = $this->Center_details_model->get_single_student_details_new($bonafide->student_id);
if(!empty($student)){
?>
<script>
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Payment for Character Certificate</h2>
									...
									<div class="card-body">
										<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler">
											<div class="row">
												...
												<div class="box_layer_t">
													<div class="btn_center"> 
											    		<span><b>Student Name</b> : <?=$student->student_name;?></span><br>
											    		<span><b>Enrollment Number</b> : <?=$student->enrollment_number;?></span><br>
											    		<span><b>Mobile</b> : <?=$student->mobile;?></span><br>
												...
												<br><br>
													<div class="box_layer_t">
													    <div class="btn_center"> 
														 ...
														 <p class="mid_bix">Please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees; }?></b> to get your Character Certificate, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$bonafide->id?>"/></td>
												</tr>
												<tr>
													<!-- <td>Amount	:</td><td><input type="text" name="amount" value="<?=$bonafide->amount?>.00"/></td> -->
...
<?php }}else{
	redirect('apply_student_character_certificate/'.$this->uri->segment(2));
} include('footer.php');?>
