        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Teacher Assessment Approved List</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			{
				extend: "excelHtml5",
                title:"Teacher Assessment Approved List",
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_ajax_controller/get_teacher_assessment_approved_ajax",
			"type": "POST",
		},	
		"complete": function() {
