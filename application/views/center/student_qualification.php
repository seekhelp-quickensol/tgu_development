					...
					<table id="examplea" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
						...
						<tbody>
							...
							<tr>
								...
								<td>
								    <?php if(!empty($student) && $student->undertaking !=""){?>
								        <a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/permission_letter/'.$student->undertaking)?>"><i class="mdi mdi mdi-eye"></i></a>
								    <?php }?>
								    
								    <input type="file" name="undertaking">

									<input type="hidden" name="old_undertaking" value="<?=$student->undertaking?>">
