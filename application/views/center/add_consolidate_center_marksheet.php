				 ...
				 <div class="row">
                    <div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="enrollment" id="enrollment" class="form-control" value="<?php if(!empty($student)){ echo $student->enrollment_number;}?>">
						</div>
					</div>
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="internal_mark[]"   id="internal_mark" class="form-control subject_code" value="<?=$subject_result->internal_marks_obtained?>">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>External</label>
                                    <input type="text" readonly name="external_mark[]"   id="external_mark" class="form-control subject_code" value="<?=$subject_result->external_marks_obtained?>">
                                </div>
                            </div> 
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="total_marks[]" id="total_marks" class="form-control subject_code" value="<?=$subject_result->internal_max_marks+$subject_result->external_max_marks?>">
                                </div>
                            </div> 
							<div class="col-md-2">
                                <div class="form-group">
                                    <label>Grade</label>
                                    <input type="text"  name="grade[]" id="grade" class="form-control subject_code" value="<?=$subject_result->grade?>">
                                </div>
                            </div> 
							<div class="col-md-2">
                                <div class="form-group">
