				...
				<div class="col-md-12">        
					<div class="card">            
						...
						<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler">				
							<div class="row">					
								<div class="col-lg-12">						
									<div class="btn_center" style="width: 500px;margin: 75px auto 0px;">						
										<div class="row">							
											<div class="col-lg-4">								
												<button type="submit" style="height: 38px;" class="btn btn-primary" value="CheckOut">Pay Online</button>
											</div>							
											<?php /*if(!empty($wallet_balance) && $wallet_balance->amount >= $total_fees){?>							
											<div class="col-lg-4">								
												<a href="<?=base_url();?>pay_admission_via_wallet/<?=$this->uri->segment(2)?>/<?=$this->uri->segment(3)?>" class="btn btn-info" value="CheckOut">Pay Via Wallet</a>	
											</div>							
											<?php }*/?>						
										</div>					
									</div>					
							...
							<tr>					
								<td>Order Id:</td>
								<td><input type="text" name="order_id" value="<?=$fees->id?>"/></td>				
							</tr>				
							<tr>					
								<td>Amount:</td>
								<td><input type="text" name="amount" value="<?=$total_fees?>.00"/></td>				
							</tr>				
							<tr>					
								<td>Currency:</td>
							...
							<tr>					
								<td>Redirect URL:</td>
								<td><input type="text" name="redirect_url" value="<?=base_url();?>ccavResponseHandler"/></td>				
							</tr>			 	
							<tr>			 		
								<td>Cancel URL	:</td>
								<td><input type="text" name="cancel_url" value="<?=base_url();?>ccavResponseHandler"/></td>			 	
							</tr>			 	
							<tr>					
								<td>Language:</td>
							...
							<tr>		        	
								<td>Billing Name:</td>
								<td><input type="text" name="billing_name" value="<?=$student->student_name?>"/></td>		        
							</tr>		        
							<tr>		        	
								<td>Billing Address	:</td>
								<td><input type="text" name="billing_address" value="<?=$student->address?>"/></td>		        
							</tr>		        
							<tr>		        	
								<td>Billing City:</td>
							...
							<tr>		        	
								<td>Billing Zip	:</td>
								<td><input type="text" name="billing_zip" value="<?=$student->pincode?>"/></td>
							</tr>		        
							<tr>		        	
							...
							<tr>		        	
								<td>Billing Tel	:</td>
								<td><input type="text" name="billing_tel" value="<?=$student->mobile?>"/></td>		        
							</tr>		        
							<tr>		        	
								<td>Billing Email:</td>
								<td><input type="text" name="billing_email" value="<?=$student->email?>"/></td>		        
							</tr>		        
							<tr>		        	
							...
							<tr>		        	
								...
								<td><input type="text" name="delivery_address" value="<?=$student->address?>"/></td>		       
							</tr>		        
							<tr>		        	
								<td>shipping City:</td>
							...
							<tr>		        	
								<td>Shipping Tel:</td><td>
								<input type="text" name="delivery_tel" value="<?=$student->mobile?>"/></td>		        
							</tr>		        
							<tr>		        	
								<td>Merchant Param1	:</td>
								<td><input type="text" name="merchant_param1" value="The Global University"/></td>		        
							</tr>		        
							<tr>		        	
								<td>Merchant Param2	:</td>
								<td><input type="text" name="merchant_param2" value="tbl_student"/></td>		        
							</tr>				
							<tr>					
							...
							<tr>		        	
								...
								<td><input type="text" name="integration_type" value="iframe_normal"/></td>		        
							</tr>		        
							<tr>		        	
								<td></td>
								<td></td>		        
