                  ...
                  <form class="forms-sample" name="paper_form" id="paper_form" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <select class="form-control js-example-basic-single course_relation" id="stream" name="stream">
						...
						<?php if(!empty($single) && !empty($stream)){ foreach($stream as $stream_result){?>
					...
					<div class="form-group">
                      ...
                      <select class="form-control js-example-basic-single course_relation" id="subject" name="subject">
						...
						<?php if(!empty($single) && !empty($subject)){ foreach($subject as $subject_result){?>
...
$("#file").change(function () {
    ...
    switch (ext) {
        ...
        case 'xlsx':
            break;
        default:
            alert('Only jpg, png, pdf, doc, docx, and xlsx files are supported.');
            this.value = '';
    }
});
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_controller/get_all_paper_ajax",
			"type": "POST",
