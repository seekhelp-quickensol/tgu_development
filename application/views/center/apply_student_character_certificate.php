            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Apply Character Certificate
                  ...
                  <form class="forms-sample" action="<?=base_url();?>pay_student_character_certificate/<?php if(!empty($student)){ echo $student->id;}?>" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
 ...
 <script>
     ...
     $("#enrollment_no").keyup(function(){ 
      ...
      $.ajax({
            ...
            data:{'enrollment_no':$("#enrollment_no").val(),'table':'tbl_character_certificate'},
