...
$this->db->where('id',$order_id);	$real_fees =$this->db->get('tbl_student_degree');	
...
for($i = 0; $i < $dataSize; $i++) 	{		
	...
	$information=explode('=',$decryptValues[$i]);		if($i==0)	
		...
		?>
	<!DOCTYPE html><html class="no-js" lang="en"><head>  <!-- Meta Tags -->  <meta charset="utf-8">  <meta http-equiv="x-ua-compatible" content="ie=edge">  
	<meta name="viewport" content="width=device-width, initial-scale=1">  <meta name="author" content="Laralink">  <!-- Site Title -->  <title>Payment Receipt</title> 
	<link rel="stylesheet" href="invoice_assests/style.css"></head><body>  <div class="tm_container">    <div class="tm_invoice_wrap">     
	<div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">        <div class="tm_invoice_in">         
	<div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">            <div class="tm_invoice_left">            
	<div class="tm_logo"><img src="assets/images/global_university_logo.png" style="max-height: 107px;" alt="Logo"></div>            </div>         
	<div class="tm_invoice_right tm_text_right tm_mobile_hide">              <div class="tm_f50 tm_text_uppercase tm_white_color">Receipt</div>            </div>        
    <div class="tm_shape_bg tm_accent_bg tm_mobile_hide"></div>          </div>          <div class="tm_invoice_info tm_mb25">           
	<div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Payment Status: </b><?=$order_status?></div> 
	<div class="tm_invoice_info_list tm_white_color">              <p class="tm_invoice_number tm_m0" style="margin-right:10px">Receipt No: <b>#<?=$result->transaction_id?></b></p>       
	<p class="tm_invoice_date tm_m0" style="margin-right:-30px">Date: <b><?=date("d/m/Y",strtotime($result->created_on));?></b></p>    
	</div>            <div class="tm_invoice_seperator tm_accent_bg"></div>          </div>          
	<div class="tm_invoice_head tm_mb10">            <div class="tm_invoice_left">			 <p class="tm_mb2"><b class="tm_primary_color">Receipt To:</b></p>              <p>                <?=$result->student_name?>
	<br>               <?=$result->address.', '.$result->city_name.', '.$result->state_name.', '.$result->country_name.'-'.$result->pincode?><br>                <?=$result->mobile?>              </p>            </div>       
	<div class="tm_invoice_right tm_text_right">              <p class="tm_mb2"><b class="tm_primary_color">Pay To:</b></p>             
	<p>                <?=$university_details->university_name?><br>				<?=$university_details->address?><br>                <?=$university_details->email?>              </p>   
	</div>          
	</div>          
	...
	<td class="tm_width_4">Degree Fees</td>						
	<td class="tm_width_2"><?=$result->transaction_id?></td>						
	...
	<div class="tm_right_footer">               
	<div class="tm_sign tm_text_center">                  <!--<img src="assets/img/sign.svg" alt="Sign">-->                  
	...
	<script src="invoice_assests/main.js">
	</script>
	</body>
	</html>  