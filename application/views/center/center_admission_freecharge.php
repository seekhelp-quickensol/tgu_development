...
<body>
	<div class="container">
		...
		<a href="<?=base_url()?>center_new_admisison" style="text-decoration: none;margin-top:10px;background:#000;color:#fff;padding:10px 21px;border-radius:3px;border:none;cursor:pointer;font-size: 13px;">Back</a>
		<?php }?>
	</div>
<script>
	function myFunction() {
