    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Payment for Degree Application</h2>
                        ...
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
									...
									<div class="card-body">
										...
										<form method="post" name="customerData" action="<?=base_url();?>center_degree_ccavRequestHandler">
												...
												<br><br>
													<div class="box_layer_t">
													    <div class="btn_center"> 
														 ...
														 <p class="mid_bix">Please complete the payment of <b>Rs. <?php if($this->session->userdata('center_id') == 9){ echo "10000";}else{ echo "3500";}?></b> to get your Degree, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													...
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student->order_id?>"/></td>
												...
												<tr>
													...
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>center_degree_ccavResponseHandler"/></td>

												</tr>

												<tr>

													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>center_degree_ccavResponseHandler"/></td>
