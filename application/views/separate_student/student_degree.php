                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
					...
					<?php if(empty($degree)): ?>
						...
						<a href="<?=base_url("s_pay_degree_fees");?>" class="btn btn-success">Pay Degree fees</a>

						<?php else: ?>



							<?php if($degree->status == '0'): ?>Model Village Naharlagun, Itanagar, Arunachal Pradesh - 791110

								<button  class="btn btn-primary">Waiting for UNIVERSITY Approval .....</button>
			...
			<div class="row" id="letter_section">
				...
				<div class="col-md-10">
					...
					<div style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet-bg-with-logo.jpeg')?>);background-position: center;background-size: cover;padding: 370px 25px;border: 2px solid #e8612b;">
						...
						<!-- <img style="float: right;margin-top: -300px;" src="<?=base_url("images/profile_pic/".$degree->photo);?>" width="95px" height="110px"> -->
						...
						<div class="row" style="padding-right: 20px;padding-left: 20px">
							...
							<div class="col-lg-12 col-md-12">
								...
								<img style="width: 150px;" src="<?=$this->Digitalocean_model->get_photo('images/images/degree_seal.png')?>" alt="image">
							...
							<div class="col-lg-12 col-md-12">
								...
								<div style="width: 205px;float: left;text-align: center;margin-top: 35px;">
								    ...
								    <?php if($degree->issue_date < "2022-02-19"){?>

									<img style="width: 110px;" src="<?=$this->Digitalocean_model->get_photo('images/Deputy_Registrar.png')?>">

									<?php }else{?>

									<img style="width: 110px;" src="<?=$this->Digitalocean_model->get_photo('images/seprate_reg.PNG')?>"> 
