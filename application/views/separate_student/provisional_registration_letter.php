					...
					<div class="letter-padding" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/BTU.jpeg')?>);background-position: top;background-size: cover;padding: 297px 25px;border: 2px solid #e8612b;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								...
								<p class="letter-ref" style="color: #000;font-weight: 700;font-size: 14px;margin-top: 20px;">Ref. No.: BTU/PRL/<?php if($stu_data->admission_date != ""){ echoBIR TIKENDRAJIT UNIVERSITYata->admission_date)); }else{ echo date("Y",strtotime($stu_data->created_on));}?>/<?php print_r(array_reduce(array_slice(str_split((string)$stu_data->enrollment_number),-5),function($a,$b){return $a.$b;}))?></p>

							</div>

							<div class="col-lg-6 col-md-6">

								<!--<p class="letter-ref" style="color: #000;font-weight: 700;font-size: 14px;text-align: right;margin-top: 20px;">Dated: <?=date("d-m-Y",strtotime($stu_data->admission_date));?></p>-->
							...
							<div class="col-lg-12 col-md-12">
								...
								</p>BIR TIKENDRAJIT UNIVERSITY

							</div>

							<div class="col-lg-12 col-md-12">
BIR TIKENDRAJIT UNIVERSITY
								<p style="font-size: 15px;color: #000;font-weight: 700;margin-top: 10px;margin-bottom: 10px;">Subject: Provisional Registration for Ph.D. Degree</p>
							...
							<div class="col-lg-12 col-md-12">
								...
								<p style="font-size: 16px;font-weight: 700;color: #000;margin-bottom: 15px;">Registration/Enrollment No.: <span style="margin-left: 15px;"><?=$stu_data->enrollment_number?></span></p>

								<p style="font-size: 16px;font-weight: 700;color: #000;margin-bottom: 15px;">Date of Registration:  <span style="margin-left: 74px;"><?php if($stu_data->date_of_registration != ""){ echo date("d-m-Y",strtotime($stu_data->date_of_registration)); }?></span></p>
							...
							<img style="width: 120px;" src="<?=$this->Digitalocean_model->get_photo('images/seprate_reg.PNG')?>">

								

								<?php }?>

									<p style="color: #000;font-size: 15px;font-weight: 700;margin-bottom: 0px;">Research Director</p>
