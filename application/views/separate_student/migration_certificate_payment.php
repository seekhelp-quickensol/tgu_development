							...
							<div class="col-md-12">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<form method="post" name="customerData" action="<?=base_url();?>s_student_migration_ccavRequestHandler">
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													...
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>s_student_migration_ccavResponseHandler"/></td>

												</tr>

												<tr>

													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>s_student_migration_ccavResponseHandler"/></td>
