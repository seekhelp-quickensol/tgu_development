<?php 
	$student_profile = $this->Separate_student_model->get_student_profile();
	...
	if($student_profile->identity_softcopy == "" || $student_profile->id_number == ""){
		if($this->uri->segment(1) != "s_update_document"){
			//redirect('s_update_document');
							...
							<ul class="navbar-nav navbar-nav-right">
								...
								<li class="nav-item nav-profile dropdown">
									<a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
										...
										<img src="<?=$this->Digitalocean_model->get_photo('images/profile_pic/default.jpg')?>" alt="profile"/>
									</a>
									<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
										<?php /*<a class="dropdown-item" target="_blank" href="<?=base_url();?>s_admission_form_print">
											<i class="mdi mdi-settings text-primary"></i>Admission Form
										</a>*/?>
										<a class="dropdown-item" href="<?=base_url();?>s_student_password">
											<i class="mdi mdi-settings text-primary"></i>Password
										</a>
										<a class="dropdown-item" href="<?=base_url();?>s_student_logout">
				...
				<nav class="bottom-navbar">
					<div class="container">
						<ul class="nav page-navigation">
							<li class="nav-item">
								<a class="nav-link iconBox" href="<?=base_url();?>s_student_dashboard">
							...
							<li class="nav-item">
								<a class="nav-link iconBox" href="<?=base_url("s_id_card_print");?>">
								<i class="fas fa-tachometer-alt"></i>
									<span class="menu-title">ID Card</span>
								</a>
							</li> 
							<li class="nav-item">
								<a class="nav-link iconBox" href="<?=base_url();?>s_my_results">
								<i class="fas fa-tachometer-alt"></i>
									<span class="menu-title">Result</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link iconBox" href="<?=base_url("s_marksheets");?>">
								<i class="fas fa-tachometer-alt"></i>
									<span class="menu-title">Marksheet</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link iconBox" href="<?=base_url();?>s_e_library">
							...
							<li class="nav-item">
								...
								<div class="submenu">
									<ul>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s_admission_form_print">Admission Form</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s-student-qualification-details">Qualification Details</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s_id_card_print">ID Card</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>examination-form" target="_blank">Examination Form</a></li>
										<li><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/assessment/self-&-parent-assessment-form.pdf')?>">Self Assessment & Parent Assessment Form </a></li>
										<li><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/assessment/teacher-assessment-form.pdf')?>">Teacher Assessment Form</a></li>
									</ul>
								</div>
							</li>
							...
							<li class="nav-item">
								...
								<div class="submenu">
									<ul>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s_my_results">Results</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>upload_assessment_seperate_student">Upload Assessment forms</a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
								...
								<div class="submenu">
									<ul>
										<li class="nav-item"><a class="nav-link" href="<?=base_url("s_marksheets");?>">Marksheet</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url("s-student-provisional-degree")?>">Provisional Degree</a></li>
										<!--<li class="nav-item"><a class="nav-link" href="<?=base_url("s-student-degree")?>">Degree</a></li>-->
										...
										<li class="nav-item"><a class="nav-link" href="<?=base_url("s-transfer-certificate")?>">Transfer Certificate</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url()?>s_transcript_application">Transcript</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url("s-migration-certificate")?>">Migration</a></li>
									</ul>
								</div>
							</li> 
							<?php if(!empty($student_profile) && $student_profile->course_id == "23"){?>
								...
								<a href="#" class="nav-link iconBox">
									...
									<span class="menu-title">Provisional Registration Letter</span>
									<i class="menu-arrow"></i>
								</a>
								<div class="submenu">
									<ul>
										<li class="nav-item"><a class="nav-link" href="<?=base_url("s-student-provisional-registration-letter")?>">Provisional Registration Letter</a></li> 
									</ul>
								</div>
							</li>
							<?php }?>
							<li class="nav-item">
								...
								<div class="submenu">
									<ul>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s_student_password">Password</a></li>
										<li class="nav-item"><a class="nav-link" href="<?=base_url();?>s_student_logout">Logout</a></li>
									</ul>
								</div>
							</li>
							<!-- <li class="nav-item">
