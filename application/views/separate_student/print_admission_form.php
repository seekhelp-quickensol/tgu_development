...
<?php     
    ...
    <div style="width: 670px;margin: 0px auto;border: 2px dashed #e93803;" id="challanDiv">
        <table class="detailTable" width="670" cellpadding="6">
          ...
          <tr><td colspan="4" style="border-bottom: 2px solid #cccccc;">
            <table class="headerTable" width="100%" cellpadding="2" align="center">
                <tbody>
                    <tr><td align="right" rowspan="2"><img src="<?=base_url();?>images/logo/<?php if(!empty($university_details) && $university_details->logo !=""){ echo $university_details->logo;}else{ echo "demolog.png";}?> " width="90" height="90" /></td>
        ...
        <tr><td width="150px"><!--Application Date:&nbsp;&nbsp;<?=date("d-m-Y",strtotime($admission->admission_date))?>--></td>
            <td align="center"><span class="form">ADMISSION FORM&nbsp;-&nbsp;#<?=$admission->id?></span></td>
            <td>&nbsp;</td>
           <td rowspan="5" align="right" width="105px">
                <div style="position: absolute;top: 200px;">
                    <img src="<?=base_url();?>images/profile_pic/defalt.jpg"  alt="" style="border: 1px dotted #333333;" width="95" height="100"/>
                </div>
           </td>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td class="heading1" width="160px">Name of the Candidate:</td>
                        <td class="data" width="170px"><?=$admission->student_name?></td>
                        <td></td>
                        <td></td>
        ...
        <tr>
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td class="heading1" width="160px">Father's Name:</td>
                        <td class="data" width="170px"><?=$admission->father_name?></td>
                        <td></td>
                        <td></td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td class="heading1" width="160px" >Mother's Name:</td>
                        <td class="data" width="170px" ><?=$admission->mother_name?></td>
                        <td></td>
                        <td></td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td class="heading1" width="160px" >Candidate Address:</td>
                         <td class="data" width="170px" ><?=$admission->address?></td>
                         <td></td>
                         <td></td>
                    </tr>
                </table>
        ...
        <tr><td colspan="2">
                <table width="100%">
                    <tr><!-- <td class="heading1" width="160px">Study Mode:</td>
                        ...
                        <td class="heading1" width="160px">Year:</td>
