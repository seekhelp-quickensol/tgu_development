        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved KYC List</h4><p class="card-description">
				...
				if(!empty($kyc)){ foreach($kyc as $kyc_result){?>
                    <tr>
                        ...
                        <td>
							<a target="_blank" download href="https://personalkyc.com/uploads/video_kyc/<?=$kyc_result->video?>">View Video</a>
						</td>
						<td>
						...
						<!-- <a href="<?=base_url();?>reject_blen_kyc/<?=$kyc_result->kyc_id?>" onclick="return confirm('Are you sure to reject this record?');" class="btn btn-danger">Reject</a> -->
...
function click_popup(str){
            $.ajax({
                type: "POST",
                url: "<?=base_url();?>admin/Ajax_controller/get_reject_popup_blended",
                data: {'id': str},
