...
<body>
    <div class="page"
        style="background-image:url(<?=base_url();?>images/img/bg-img-degree.png);background-position: center;background-size: cover;">
                                ...
                                <div class="letter_area">
                                    <div class="head_row"
                                        ...
                                        <div style="padding-right: 40px;">
                                            <p style="font-family: sans-serif;font-size: 15px;">Serial No.:
                                                <?=$degree->sr_no?></p>
                                        </div>
                                    </div>
                                    <div class="padd_wrapper">
                                        ...
                                        <!--</div>-->
                                        <h1
                                            style="font-family: sans-serif-400; color: #000; text-align: center; font-size: 30px; margin-bottom: 0px; text-transform:uppercase; padding-top:55px;">
                                        ...
                                        <div
                                            ...
                                            <div style="text-align: center;"> <img style="width: 115px;"
                                                ...
                                                <p
                                                    ...
                                                    Manipur, Dated <?=date('jS F Y',strtotime($degree->issue_date)); ?>
                                                </p>
                                            </div>
