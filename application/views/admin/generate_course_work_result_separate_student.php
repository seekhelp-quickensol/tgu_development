            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <form method="post" name="AddForm" id="AddForm" enctype="multipart/form-data">
					...
					<div class="col-md-3">
                    <div class="form-group">
                       <label for="exampleInputEmail1">Issue Date *
						<!-- <?php print_r($single->issue_date);?> -->
					</label>
                       <input type="text" name="issue_date" id="issue_date" class="form-control datepicker" value="<?php if(!empty($single) && ($single->issue_date == '01-01-1970' )){ echo date("d-m-Y",strtotime($single->issue_date));}?>" placeholder="Issue Date">
                    </div>
					</div>
					</div>
					<div class="row">
				...
				<div class="col-md-12">	
					<table class="resultTable" align="center"  cellspacing="5" cellpadding="3" border="1" style="width: 100%;">
						...
						<tr>
							...
							<td align="center"><input type="text" name='txtEMO1' id='txtEMO1' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/></td>
							</td>
						</tr>
						<tr>
							...
							<td align="center">
								<input type="text" name='txtEMO2' id='txtEMO2' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/>
							</td>
							</td>
						</tr>
						<tr>
							...
							<td class="data">REVIEW LITERATURE & SEMINAR
								<input type="hidden" name='subject_name3' id='subject_name3' value="REVIEW LITERATURE & SEMINAR"/>
							</td> 
							<td class="data" align="center">100
								<input type="hidden" name='ext_max_mark3' id='ext_max_mark3' value="100"/>
							</td>
							<td align="center">
								<input type="text" name='txtEMO3' id='txtEMO3' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/>
							</td>
							</td>
						</tr>
