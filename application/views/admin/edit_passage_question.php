							...
							<div class="col-md-12">
                                    <div class="row"> 
                                        <div class="form-group col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                            <label>Passage <span class="required_input">*</span></label>
                                            <textarea type="text" class="form-control" id="passage" name="passage" placeholder="Passage"><?php if(!empty($single)){ echo $single->passage;}?></textarea>
                                        </div>	
								...
								<div class="col-md-12">
										...
										<br>									
											<button id="saver" class="btn btn-sm btn-success submit-btn" name="submit_pass" value="submit_pass" type="submit">Submit</button>
										</div>	
								</div>
							</div>
									</form>
