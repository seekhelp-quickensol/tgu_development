    ...
    <div class="container-fluid page-body-wrapper">
      <div class="main-panel">
        <div class="content-wrapper">
         ...
         <form method="POST" name="admission_form" class="admission_form" id="admission_form" >
                  <div class="row">
                        <div class="col-md-12">
               ...
               <div class="row">
                              ...
                              <div class="row">
									  ...
									  <div class="col-sm-3">
										 <div class="form-group">
											...
											<select id="course" name="schedule" class="form-control box-size">
                              ...
                              <div class="row">
									  ...
									  <div class="col-sm-3">
										 <div class="form-group">
											...
											<input type="text" name="date_of_registration" id="date_of_registration" placeholder="Date of Registration" class="form-control back-white" readonly>
										 </div>									 
								     </div>
                             <div class="col-sm-3">
                             <div class="form-group">
                              <label for="exampleInputUsername1">Payment Status *</label>
                                 <select class="form-control box-size" id="payment_status" name="payment_status">
                              ...
                              <div class="col-sm-3">
										 <div class="form-group">
											...
											<input type="text" name="transaction_id" value="<?php if(!empty($single)){ echo $single->transaction_id;}?>" class="form-control" placeholder="Transaction ID">
										 </div>
									  </div>
                              </div>
                           </div>
                     ...
                     <div class="row" >
                        ...
                        <div class="row" >
                           ...
                           <div class="col-sm-3 lateral_entry" >
                              <div class="form-group">
                                 <label>Payment Mode</label>
                                 <!-- <input  type="text"  name="payment_mode" id="payment_mode" class="form-control" >  -->
                                 <select name="payment_mode[]" id="payment_mode1" class="form-control box-size">
                                    <option value="">Select</option>
                           ...
                           <div class="col-sm-2">
                              <div class="form-group">
                                 ...
                                 <input placeholder="Deposit Date" readonly type="text" id="deposit_date1" c name="deposit_date[]" class="form-control datepicker back-white" >
                              </div>
                           </div>
                           <div class="col-sm-2">
                              <div class="form-group">
                        ...
                        <div class="col-sm-12">
                        <a onclick="add_more_fields()" class="btn btn-danger font-clr" style="margin-left: 15px;margin-top:10px">Add</a>
                        </div>
                     </div
                     <hr>
                     <!-- <div class="common_details">
...
?>
 <script>
 /*$('form.admission_form').on('submit', function(event) {
    ...
    if($('form.admission_form').validate().form()) {
       
    } else {
        //alert('Please fill all fees details that is added in form');
    }
});*/
   ...
   //$.validator.addMethod("allBankNameRequired", function (value, element) {
	...
	// 		$(this).parent('p').append('<label  id="id_ct' + i + '-error" class="error">please enter bank name.</label>');
	// 	}
	// });
	// return flag;
   // }, "");
   ...
   //$.validator.addMethod("allPaymentModeRequired", function (value, element) {
	...
	// 		$(this).parent('p').append('<label  id="id_ct' + i + '-error" class="error">Please select payment mode.</label>');
	// 	}
	// });
	// return flag;
   // }, "");
   ...
   // $.validator.addMethod("allTransactionNumberRequired", function (value, element) {
	...
	// 		$(this).parent('p').append('<label  id="id_ct' + i + '-error" class="error">please enter transaction number.</label>');
	// 	}
	// });
	// return flag;
   // }, "");
   ...
   //$.validator.addMethod("allDepositDateRequired", function (value, element) {
	...
	// 		$(this).parent('p').append('<label  id="id_ct' + i + '-error" class="error">please select deposit date.</label>');
	// 	}
	// });
	// return flag;
   // }, "");
   ...
   // $.validator.addMethod("allAmmountRequired", function (value, element) {
	...
	// 		$(this).parent('p').append('<label  id="id_ct' + i + '-error" class="error">please enter amount.</label>');
	// 	}
	// });
	// return flag;
   // }, "");
     ...
     //  ignore:'',
   	...
   	messages: {
        ...
        date_of_registration: {
         ...
         payment_status: {
            required:"Please select payement status",
            noHTMLtags:"HTML tags not allowed",
         },
         course_work_type: {
            required:"Please select course work type", 
         },
    ...
    function add_more_fields(){
        ...
        <div class="row">
                           <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                 <label>Bank Name</label>
                                 <input  placeholder="Bank name" type="text" id="bank_name${field_count}" name="bank_name[]" class="form-control"  >
                              </div>
                           </div>
                           <div class="col-sm-3 lateral_entry" >
                              <div class="form-group">
                                 <label>Payment Mode</label>
                                 <!-- <input  type="text"  name="payment_mode" id="payment_mode" class="form-control " >  -->
                                 <select  name="payment_mode[]" id="payment_mode${field_count}" class="form-control box-size" >
                                    <option value="">Select</option>
                                    <option value="cash">Cash</option>
                                    <option value="online">Online</option>
                                 </select>
                           ...
                           <div class="col-sm-2">
                              <div class="form-group">
                                 <label>Transaction No</label>
                                 <input  placeholder="Transaction No" type="text" id="transaction_no${field_count}" name="transaction_no[]" class="form-control" >
                              </div>
                           </div>
                           <div class="col-sm-2">
                              <div class="form-group">
                                 <label>Deposit Date</label>
                                 <input  placeholder="Deposit Date " type="text" readonly id="deposit_date${field_count}" name="deposit_date[]" class="form-control datepicker back-white box-size" >
                              </div>
                           </div>
                           <div class="col-sm-2">
                              <div class="form-group">
                                 <label>Amount</label>
                                 <input  placeholder="Amount " min=1  type="number" id="amount${field_count}" name="ammount[]" class="form-control" >
                              </div>
                           </div>
                           <div class="col-sm-2">
                              <div class="form-group" style="margin-top:25px">
                                 <a class="btn btn-success font-clr" onclick="remove_field(${field_count})">Remove</a>
                              </div>
                           </div>
                           </div>
                        </div>`;
