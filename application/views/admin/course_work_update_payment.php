        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Payment Details <?php if(!empty($single)){ echo $single->student_name;}?> <?php if(!empty($single)){ echo $single->enrollment_number;}?> </h4>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control datepicker" id="payment_date" name="payment_date" placeholder="Payment Date" value="<?php if(!empty($single->payment_date)){ echo date("d/m/Y",strtotime($single->payment_date));}?>">
					 </div>
					 </div>
					 <div class="col-md-3">
                    <div class="form-group">
