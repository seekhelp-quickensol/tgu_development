      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved II Recomandation Letter</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved II Recomandation Letter",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_approv_reccom_list_second",
			"type": "POST",
		},	
		"complete": function() {
