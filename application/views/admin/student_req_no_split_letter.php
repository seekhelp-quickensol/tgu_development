        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
			  ...
			  <h4 class="card-title">Requested No Split Issue Letter</h4>
              </div>
                <div class="card-body">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
				title:"Requested No Split Issue Letter",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_req_no_split_list",
			"type": "POST",
		},	
		"complete": function() {
