			...
			<div class="row">
				<div class="col-md-12 grid-margin stretch-card">
					...
					<form id="topic" method="post" enctype="multipart/form-data">
        			 	<div class="col-lg-12">
					   		<div class="row">
				  				<p>Update Passage Reading question</p>
					 		</div>
				 		</div>
						 <div class="row questions_div">
					    	...
					    	<textarea type="text" class="form-control" id="passage" name="passage" required ><?php if($question){ echo($question->passage);} ?></textarea>
			    			</div>
						 	<div class="form-group col-lg-12 col-md-12 col-sm-6 col-xs-12">
