      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Document Setting for <?php if(!empty($employee)){ echo $employee->first_name.' '.$employee->last_name;}?></h4>
                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
					  ...
					  <input type="hidden" name="employee_id" id="employee_id" value="<?=$this->uri->segment(2)?>">
                    ...
                    <div class="form-group">
					  ...
					  <span>Only .pdf file should be upload</span>
					</div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Documents List  for <?php if(!empty($employee)){ echo $employee->first_name.' '.$employee->last_name;}?></h4>
                  <p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_employee_documents",
			"type": "POST",
			"data":{employee_id:'<?=$this->uri->segment(2)?>'},
		},	
		"complete": function() {
