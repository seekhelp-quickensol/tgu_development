...
if(!empty($student)){
    $guide = $this->Research_model->get_assigned_guide($student->guide_id);
    $co_guide = $this->Research_model->get_assigned_guide($student->co_guide_id);
?>
                                ...
                                <div class="row">
									<div class="col-md-3">
										<div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-single" id="scholar_type" name="scholar_type">
									...
									<div class="col-md-3">
										<div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-single" id="entrance_exam" name="entrance_exam">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="guide_allocation_process" id="guide_allocation_process"  class="form-control" value="<?php if(!empty($extra_details)){ echo $extra_details->guide_allocation_process;}?>">
										</div>
									</div>
								</div>
                                <div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-single" id="is_regular_teacher" name="is_regular_teacher">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" name="scholars_under_guide" id="scholars_under_guide"  class="form-control" value="<?php if(!empty($extra_details)){ echo $extra_details->scholars_under_guide;}?>">
										</div>
									</div>
								</div>
                                <div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label>Is Regular Teacher?*</label>
                                            <select class="form-control js-example-basic-single" id="co_is_regular_teacher" name="co_is_regular_teacher">
                                                <option value="">Select Option</option>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" name="scholars_under_co_guide" id="scholars_under_co_guide"  class="form-control" value="<?php if(!empty($extra_details)){ echo $extra_details->scholars_under_co_guide;}?>">
										</div>
									</div>
								</div>
                                <div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input type="text" class="form-control datepicker" name="course_work_start_date" id="course_work_start_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->course_work_start_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Course Work Period From<span class="req">*</span></label>
											<input type="text" class="form-control" name="course_work_period_from" id="course_work_period_from" value="<?php if(!empty($extra_details)){ echo $extra_details->course_work_period_from;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Course Work Period To<span class="req">*</span></label>
											<input type="text" class="form-control" name="course_work_period_to" id="course_work_period_to" value="<?php if(!empty($extra_details)){ echo $extra_details->course_work_period_to;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Course Work Report Type*</label>
                                            <select class="form-control js-example-basic-single" id="course_work_report_type" name="course_work_report_type">
                                                <option value="">Select Option</option>
									...
									<div class="col-sm-3">
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="research_committee" id="research_committee" value="<?php if(!empty($extra_details)){ echo $extra_details->research_committee;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Research Proposal Topic Report<span class="req">*</span> <br><small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="research_proposal_link" id="research_proposal_link" value="<?php if(!empty($extra_details)){ echo $extra_details->research_proposal_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Periodical Review (6 Monthly) Report<span class="req">*</span> <br><small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="periodical_review_link" id="periodical_review_link" value="<?php if(!empty($extra_details)){ echo $extra_details->periodical_review_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Presentation Date<span class="req">*</span><br></label>
											<input type="text" class="form-control datepicker" name="presentation_date" id="presentation_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->presentation_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Research Papers Published<span class="req">*</span></label>
                                            <input type="text" class="form-control" name="research_papers" id="research_papers" value="<?php if(!empty($extra_details)){ echo $extra_details->research_papers;}?>">
                                        </div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Thesis Submission Date<span class="req">*</span></label>
											<input type="text" class="form-control datepicker" name="thesis_submission_date" id="thesis_submission_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->thesis_submission_date));}?>">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Examiner Name*</label>
											<input type="text" name="examiner" id="examiner"  class="form-control" value="<?php if(!empty($extra_details)){ echo $extra_details->examiner;}?>">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Examiner From*</label>
                                            <select class="form-control js-example-basic-single" id="examiner_from" name="examiner_from">
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="plagiarism_check_review_link" id="plagiarism_check_review_link" value="<?php if(!empty($extra_details)){ echo $extra_details->plagiarism_check_review_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Thesis Sent To Examiner Date<span class="req">*</span></label>
											<input type="text" class="form-control datepicker" name="thesis_examiner_submission_date" id="thesis_examiner_submission_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->thesis_examiner_submission_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Thesis Received From Examiner Date<span class="req">*</span></label>
											<input type="text" class="form-control datepicker" name="thesis_examiner_receive_date" id="thesis_examiner_receive_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->thesis_examiner_receive_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Examiner Thesis Suggestions Report <span class="req">*</span><small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="examiner_thesis_suggestion_link" id="examiner_thesis_suggestion_link" value="<?php if(!empty($extra_details)){ echo $extra_details->examiner_thesis_suggestion_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Examiner Report <span class="req">*</span><small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="examiner_report_link" id="examiner_report_link" value="<?php if(!empty($extra_details)){ echo $extra_details->examiner_report_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Viva-Voce Date<span class="req">*</span></label>
											<input type="text" class="form-control datepicker" name="viva_date" id="viva_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->viva_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Viva-Voce Report <span class="req">*</span><small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="viva_report_link" id="viva_report_link" value="<?php if(!empty($extra_details)){ echo $extra_details->viva_report_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>PH.D. Award Date<span class="req">*</span></label>
											<input type="text" class="form-control datepicker" name="phd_award_date" id="phd_award_date" value="<?php if(!empty($extra_details)){ echo date("d-m-Y",strtotime($extra_details->phd_award_date));}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Evidence of Thesis Upload on Shodhganga<span class="req">*</span> <small>(Google drive link)</small></label>
											<input type="text" class="form-control" name="thesis_evidence_link" id="thesis_evidence_link" value="<?php if(!empty($extra_details)){ echo $extra_details->thesis_evidence_link;}?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Provisional Certificate Field<span class="req">*</span></label>
											<input type="text" class="form-control" name="provisional_certificate" id="provisional_certificate" value="<?php if(!empty($extra_details)){ echo $extra_details->provisional_certificate;}?>">
                                        </div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
                                            <label>Other Information<span class="req">*</span></label>
											<textarea class="form-control" name="other_information" id="other_information"><?php if(!empty($extra_details)){ echo $extra_details->other_information;}?></textarea>
										</div>
									</div>
								</div>
