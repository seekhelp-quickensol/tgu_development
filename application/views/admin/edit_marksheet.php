								...
								<div class="row">
									...
									<div class="col-md-4 credit_transfer_remark" style="<?php if($marksheet->credit_transfer == '0'){?>display:none;<?php }else if($marksheet->credit_transfer == '1'){?>display:block<?php }else{?>display:none;<?php }?>">
										<div class="form-group">
											...
											<input type="text" name="remark" id="remark" placeholder="Remark" class="form-control" value="<?=$marksheet->credit_transfer_remark?>">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<select class="form-control" id="signature" name="signature">
												...
												<option value="<?=$signature_result->id?>" <?php if(!empty($marksheet) && $marksheet->signature_id == $signature_result->id){?>selected="selcted"<?php }else if(empty($exam_setup) && $signature_result->id == '5') {?>selected<?php }?>><?=$signature_result->name?> <?=$signature_result->dispalay_signature?> </option>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<select class="form-control" id="checked_by_signature" name="checked_by_signature">

												<option value="">Checked By Signature</option>

												<?php if(!empty($signature)){ foreach($signature as $signature_result){?>

												<option value="<?=$signature_result->id?>" <?php if(!empty($marksheet) && $marksheet->checked_signature_id == $signature_result->id){?>selected="selcted"<?php } else if(empty($exam_setup) && $signature_result->id == '6') {?>selected<?php }?>><?=$signature_result->name?> <?=$signature_result->dispalay_signature?> </option>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<select class="form-control" id="prepared_by_signature" name="prepared_by_signature">

												<option value="">Select Prepared By Signature</option>

												<?php if(!empty($signature)){ foreach($signature as $signature_result){?>

												<option value="<?=$signature_result->id?>" <?php if(!empty($marksheet) && $marksheet->prepared_signature_id == $signature_result->id){?>selected="selcted"<?php }else if (!empty($exam_setup) &&  $signature_result->id == '7') {?>selected<?php }?>><?=$signature_result->name?> <?=$signature_result->dispalay_signature?> </option>
