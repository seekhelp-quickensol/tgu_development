        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Payment Details for Blended Student Medium of Instrunction Letter Application</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="<?php echo !empty($amount) ? $amount->certificate_fees : 0; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
