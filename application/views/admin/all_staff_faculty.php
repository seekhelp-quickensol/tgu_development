            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">All Report List</h4>
				  ...
				  <!-- <button type="reset" class="btn btn-primary search_button" onclick="resetDates()">Reset</button> -->
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			...
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_daily_report",
