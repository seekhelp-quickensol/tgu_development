        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ph.D Course work  Approved Application Result List
          ...
          <br>
                  ...
                  Ph.D Course work  Approved Application Result List
                  </p> -->
                  <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
				<thead>
					<tr>
						<th>Sr. No.</th>
						<th>Check for Print</th>
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Ph.D Course Work Approved Application Result List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_course_work_result_list_separate_student",
			"type": "POST",
		},	
		"complete": function() {
