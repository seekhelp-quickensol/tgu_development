        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Guide Payment Details:</h4>
				  ...
				  <div class="row">
					<div class="col-lg-3">
                        <?php $total_fees = 0;
                            ...
                            $total_fees = $total_fees + $all_guide_fees_result->guide_fees; 
                        }}?>
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Guide Payment Details: (Blended Students)</h4>
                  <h4 class="card-title">Name: <?php if(!empty($single_guide)){ echo $single_guide->name;}?></h4>
				  <div class="row">
					<div class="col-lg-3">
                        <?php $total_fees = 0;
                            if(!empty($all_guide_fees_blended)){ foreach($all_guide_fees_blended as $all_guide_fees_blended_result){		
                            $total_fees = $total_fees + $all_guide_fees_blended_result->guide_fees; 
                        }}?>
						<h5 class="card-title">Total Guide Fees: ₹ <?=number_format($total_fees,2);?></h5>
					</div>
					<?php $total_paid_amt = 0;
