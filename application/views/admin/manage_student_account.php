									...
									foreach ($payment as $payment_result) { ?>
										<tr>
											...
											<td>
											    ...
											    <?php if ($payment_result->fees_type == "1") {?>
    													<a target="_blank" data-toggle="tooltip" title="Print Receipt" href="<?=base_url()?>print_payment_receipt/<?=$payment_result->id?>/tbl_student" class="btn btn-danger btn-sm"><i class="mdi mdi mdi-printer"></i></a>
											    
    											<?php } else if ($payment_result->fees_type == "2") {?>
    												<a target="_blank" data-toggle="tooltip" title="Print Receipt" href="<?=base_url()?>print_payment_receipt/<?=$payment_result->id?>/tbl_examination_form" class="btn btn-danger btn-sm"><i class="mdi mdi mdi-printer"></i></a>
											    
    											<?php } else if ($payment_result->fees_type == "3") {?>
    												<a target="_blank" data-toggle="tooltip" title="Print Receipt" href="<?=base_url()?>print_payment_receipt/<?=$payment_result->id?>/tbl_student_degree" class="btn btn-danger btn-sm"><i class="mdi mdi mdi-printer"></i></a>
											    
    											<?php } else if ($payment_result->fees_type == "4") {?>
    												<a target="_blank" data-toggle="tooltip" title="Print Receipt" href="<?=base_url()?>print_payment_receipt/<?=$payment_result->id?>/tbl_re_registered_student" class="btn btn-danger btn-sm"><i class="mdi mdi mdi-printer"></i></a>
