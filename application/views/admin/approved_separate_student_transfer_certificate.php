        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved Separate Student Transfer Certificates</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved Separate Student Transfer Certificates List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_appproved_separate_student_transfer_certificate_list",
			"type": "POST",
		},	
		"complete": function() {
