        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Rejected Assignment List</h4>
            ...
            <div class="modal-dialog" id="order_note_dialog" style="margin-top:125px;width:500px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="noteModalLabel">Data</h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" onclick="closePopup('selfNoteModal')" style="position:absolute;right:10px;top:10px;">
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url(); ?>admin/Ajax_controller/get_all_rejected_assignment_ajax",
            "type": "POST"
        },
        "complete": function() {
...
// Optional reject validation function (commented out)
