			...
			<div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
				  ...
				  <a class="btn btn-primary float-right" href="<?=base_url();?>assignments_mcq?course=<?=$this->uri->segment(2)?>&stream=<?=$this->uri->segment(3)?>&year_sem=<?=$this->uri->segment(4)?>&subject=<?=$this->uri->segment(5)?>">Back to Form</a>
						...
						<tbody>
							<?php $sr=1;if(!empty($questions)){ foreach($questions as $questions_result){?>
								<tr>
									...
									<td><?=$questions_result->correct_answer?></td>
									<td>
