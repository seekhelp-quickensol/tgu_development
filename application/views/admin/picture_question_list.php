				...
				<div class="col-md-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							...
							<hr>
							<p>Test Picture Question list</p>
							<hr>
							<table id="example" class="table table-striped table-bordered table-responsive dt-responsive nowrap" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>D</td>
										 <?php } ?>
										<td><?=$question_result->question_description?></td>
									...
									<td>
										<a href="<?=base_url();?>delete/<?=$question_result->id;?>/tbl_picture_question" onclick="return confirm('Are you sure to delete this record?');" class="btn btn-danger"><i class="glyphicon glyphicon-trash icon-white"></i> Delete</a>
										<a href="<?=base_url();?>update_picture_question/<?=$question_result->id;?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit icon-white"></i> Edit</a>
									</td>
									<?php }} ?>
									</tr>
...
$('#picture_question').addClass('active');    
</script>
