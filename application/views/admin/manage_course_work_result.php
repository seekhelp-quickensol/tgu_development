              ...
              <div class="card">
                ...
                <form method="post" name="AddForm" id="AddForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                       ...
                       <input type="text" name="issue_date" id="issue_date" class="form-control datepicker" value="<?php if(!empty($single) && $single->issue_date != ""){ echo date("d-m-Y",strtotime($single->issue_date));}?>">
                    </div>
					</div>
					</div>
					<div class="row">
					...
					<table class="resultTable" align="center"  cellspacing="5" cellpadding="3" border="1" style="width: 100%;">
						...
						<tr>
							<td class="data">PHD-001
								<input class="form-control" type="hidden" name='subject_code1' id='subject_code1' value="PHD-001"/>
							</td>
							<td class="data">RESEARCH METHODOLOGY
								<input class="form-control" type="hidden" name='subject_name1' id='subject_name1' value="RESEARCH METHODOLOGY"/>
							</td>  
							<td class="data" align="center">100 
								<input class="form-control" type="hidden" name='ext_max_mark1' id='ext_max_mark1' value="100"/>
							</td>
							<td align="center"><input class="form-control" type="text" name='txtEMO1' id='txtEMO1' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/></td>
							</td>
						</tr>
						<tr>
							<td class="data">PHD-002</td>
							    <input class="form-control" type="hidden" name='subject_code2' id='subject_code2' value="PHD-002"/>
							<td class="data">
								<input class="form-control" type="text" name='subject_name2' id='subject_name2' class="form-control" value="" required/>
							</td> 
							<td class="data" align="center">100
								<input class="form-control" type="hidden" name='ext_max_mark2' id='ext_max_mark2' value="100"/>
							</td> 
							<td align="center">
								<input class="form-control" type="text" name='txtEMO2' id='txtEMO2' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/>
							</td>
							</td>
						</tr>
						<tr>
							<td class="data">PHD-003
								<input class="form-control" type="hidden" name='subject_code3' id='subject_code3' value="PHD-003"/>
							</td>
							<td class="data">REVIEW OF LITERATURE FOR Ph.D. TOPIC & SEMINAR
								<input class="form-control" type="hidden" name='subject_name3' id='subject_name3' value="REVIEW OF LITERATURE FOR Ph.D. TOPIC & SEMINAR"/>
							</td> 
							<td class="data" align="center">100
								<input class="form-control" type="hidden" name='ext_max_mark3' id='ext_max_mark3' value="100"/>
							</td>
							<td align="center">
								<input class="form-control" type="text" name='txtEMO3' id='txtEMO3' onblur='addMarks();' class="detail_text_right2" maxlength="2" onkeypress='disableNonNumeric(event)' required/>
							</td>
							</td>
						</tr>
						...
						<tr class="result1">
							<td class="data" colspan="2" align="right">TOTAL MARKS
								<input class="form-control" type="hidden" name='total_marks' id='total_marks' value="TOTAL MARKS"/>
							</td>  
							<td class="data" align="center">300
								<input class="form-control" type="hidden" name='total_ext_max_marks' id='total_ext_max_marks' value="300"/>
							</td> 
							</td>
							<td align="center"><input class="form-control" type="text" name='txtTEMO' id='txtTEMO' class="detail_text_right2" readonly="readonly"/></td>
							</td>
						</tr>
						<!-- <tr><td>&nbsp;</td></tr> -->
						<tr><td align="center" colspan="8"><input type="submit" name="buttSave" value="Add Certificate" class="btn btn-primary btn-sm" />
							&nbsp;<input class="form-control" type="button" name="buttSave" value="Cancel" onclick="resetForm()" class="btn btn-danger btn-sm" /></td></tr>

							<!-- &nbsp;<input class="form-control" type="button" name="buttSave" value="Cancel" onclick="hideDiv('addnewdiv');" class="btn btn-danger btn-sm" /></td></tr> -->
...
function addMarks(){
	if(document.AddForm.attending_status.selectedIndex==2  && document.AddForm.issue_status.selectedIndex==2){
