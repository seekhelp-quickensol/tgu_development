...
<div class="row grid-margin stretch-card">
  ...
  <a href="<?=base_url();?>created_exam_list" class="btn btn-danger row-btns">Reset</a>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
					...
					<h4 class="card-title">Exam List 

                    <a href="<?=base_url();?>create_exam" class="btn btn-primary mr-2 float-right">Add New</a>
      ...
      <input type="hidden" id="start_date" value="<?php if(isset($_GET['start_date'])){ echo $_GET['start_date'];}?>">

      <input type="hidden" id="end_date" value="<?php if(isset($_GET['end_date'])){ echo $_GET['end_date'];}?>">
...
$(document).ready(function() { 
    ...
    var table = $('#example').DataTable({
        ...
        "ajax":{
            ...
            "url" : "<?=base_url();?>admin/Online_controller/get_all_created_exam_ajax",
