...
<style>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="main-panel">
        ...
        <h4 class="card-title">Apply II Recommendation Letter
				  </h4>
              </div>
                <div class="card-body">
                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <input type="hidden" class="form-control" name="amount" id="amount" value="<?php echo !empty($amount) ? $amount->certificate_fees : 0;  ?>">
					        </div>	
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
 ...
 <script>
     $("#enrollment_no").keyup(function(){ 
        $.ajax({
            ...
            data:{'enrollment_no':$("#enrollment_no").val(),'table':'tbl_reccom_letter_application_second'},
