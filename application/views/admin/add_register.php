        ...
        <div class="content-wrapper">
			<div class="row">
				<div class="col-md-6 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Add Register</h4>
							<p class="card-description"> Please enter Register details </p>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="subject_name" name="subject_name" placeholder="Subject Name" value="<?php if(!empty($single)){ echo $single->subject_name;}?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" id="mode_of_study" name="mode_of_study">
												...
												<option value="1" <?php if(!empty($single) && $single->mode_of_study == '1'){?>selected="selected"<?php }?>>Year</option>
												<option value="0" <?php if(!empty($single) && $single->mode_of_study == '0'){?>selected="selected"<?php }?>>Sem</option>
											</select>
										</div>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="register_name" name="register_name" placeholder="Register Name" value="<?php if(!empty($single)){ echo $single->register_name;}?>">
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="exampleInputUsername1">Syllabus <?php if(!empty($single) && $single->syllabus !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('uploads/syllabus/'.$single->syllabus)?>">View</a><?php }?></label>
											<input type="file" class="form-control" id="userfile" name="userfile[]" multiple>
											<input type="hidden" class="form-control" id="old_syllabus" name="old_syllabus" value="<?php if(!empty($single)){ echo $single->syllabus;}?>">
										</div>
									</div>
									<?php if(empty($single)){?>
									<div class="col-md-6">
								...
								<div class="row">
									<div class= "col-lg-12 col-md-12 col-sm-12">
										<div class="plus-btn add">
											<a class="btn btn-success" href="javascript:void(0)"><i class="mdi mdi-plus"></i></a>
										</div>
									</div>
								</div>
								<?php }?>
...
$('.add').click(function() {
    $('.optionBox').append('<div class="col-md-12">\
		...
		<div class="remove btn btn-danger"><i class="mdi mdi-delete"></i></div>\
	</div>');
});
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_my_register_ajax",
			"type": "POST",
		},	
		"complete": function() {
