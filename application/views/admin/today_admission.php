					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title"> <?php if (isset($_GET['type']) && $_GET['type'] == '1') {
														...
														echo 'Regular';
													} ?> Today's Success Admission List</h4>
							...
							<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
								<thead>
									<tr>
										...
										<th>Total Received Admission Fees</th>
										<th>Total Received Admission + Late + Lat Fees</th>
										<th>Identity Type</th>
			...
			$(document).ready(function() {
				...
				var table = $('#example').DataTable({
					...
					buttons: [
						...
						{
							extend: "excelHtml5",
							title: "Today's Success Admission List",
					...
					"ajax": {
						"url": "<?= base_url(); ?>admin/Ajax_controller/get_today_admission_list",
						"type": "POST",
						"data": {
							'type': type
						},
