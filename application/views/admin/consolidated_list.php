            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h4 class="card-title">Consolidated Marksheet List</h4><p class="card-description">
                 ...
                 <p class="card-description">
                  ...
                  <form method="post" name="send_to_print" id="send_to_print" action="<?=base_url();?>student_consolidated_send_to_print">

						   <?php if($this->session->userdata('admin_id') != "79"){?>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>Previous University Subject</th>

                        <th>Previous University Name</th>
    ...
    var table = $('#example').DataTable({
        ...
        buttons:[
...

            {
                ...
                extend: "excelHtml5",
                title:"Consolidated Marksheet List",
        ...
        "ajax":{
            ...
            "url" : "<?=base_url();?>admin/Ajax_controller/get_consolidate_list",
