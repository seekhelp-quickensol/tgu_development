							...
							<div style="display: block;">
								...
								<div>
									...
									<div style="width: 205px;float: right;text-align: center;margin-top: 125px;">
										<img src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$provisional_degree->signature)?>">   
									...
									<img style="width: 145px;margin-top: 250px;" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->stamp)?>">   
