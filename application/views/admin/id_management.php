        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ID Name Setting</h4>
                  <p class="card-description">
                    Please enter ID Name details
                  </p>
                  <form class="forms-sample" name="id_form" id="id_form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">ID Name *</label>
                      <input type="text" class="form-control" id="id_name" name="id_name" placeholder="ID Name" value="<?php if(!empty($single)){ echo $single->id_name;}?>">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ID Name List</h4>
                  <p class="card-description">
                    All list of Id name 
                  </p>
