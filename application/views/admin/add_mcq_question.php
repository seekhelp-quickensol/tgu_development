							 		...
							 		<form id="topic" name="topic" method="post" enctype="multipart/form-data"> 
										...
										<div class="col-md-4">
											<div class="form-group ">
												<label for="exampleInputUsername1">Select Number Of Questions <span class="required_input">*</span></label>
	...
	for($i=1;$i<=$number_of_questions;$i++){
		$('.dynamic_input').append('<hr><div class="row questions_div">\
			...
			<label for="exampleInputUsername1">Marks<span class="required_input">*</span></label>\
				<input type="number" min="1" class="form-control marker" id="marks_'+$i+'" name="marks_'+$i+'" placeholder="Enter Marks" required>\
			</div>\
			<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">\
