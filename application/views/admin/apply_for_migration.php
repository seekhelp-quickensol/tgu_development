        ...
        <div class="content-wrapper">
			<div class="row">
				<div class="col-md-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Apply For Migration</h4>
							...
							<form class="forms-sample" name="syllabus_form" id="syllabus_form" method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputUsername1">Migration Year *</label>
											<input type="text" class="form-control" id="migration_session" name="migration_session" placeholder="Migration Year" value="<?php if(!empty($single)){ echo $single->migration_session;}?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control datepicker" id="issue_date" name="issue_date" placeholder="Issue Date" value="<?php if(!empty($single)){ echo $single->issue_date;}?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
 ...
 $(document).ready(function () {		
	...
	$('#syllabus_form').validate({
		...
		messages: {
			...
			// },  
			migration_session: {
				required: "Please enter migration year",
			}, 
			// father_name: {
