...
<head>
	...
	<div class="page">
         	<div id="letter_section"> 
            	...
            	<div id="letter_section">
					<div>
						<div class="letter_area" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet_background.png')?>);background-position: center;background-size: cover;border: 2px solid #e8612b;height: 100%;margin-right:9px;margin-top:12px;">  
                            ...
                            <img style="width: 145px;margin-top: 135px;margin-right: 75px;" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->stamp)?>">   
