    ...
    <div class="transcript_container"> 
        <div class="header_details" style="height:140px;">  
            <div class="logo_details"> 
                <img src="<?=$this->Digitalocean_model->get_photo('images/logo/logo.png')?>" style="display:block;max-width:50%;margin: 0px auto;"> 
		...
		">
		<h4 class="text-center" style="color: #335c9e;margin-top:20px;"><?php if(!empty($university_details)){ echo $university_details->address;}?></h4>
            ...
            <tbody>  
				<?php  
					...
					for($l=1;$l<=$transcript->sem;$l++){ 
						$subject = $this->Separate_student_certificate_model->get_this_transcript_subject($l,$transcript->id);  
						if($i==1){ 
				?> 
				<tr>  	
					<?php 
        ...
        <table class="border mb-10"> 
        <?php  
			$total = $this->Separate_student_certificate_model->get_this_transcript_total($transcript->id);  
		?> 
			<tbody> 
				<tr> 
					<td> 
					...
					<table class="top_table"> 
						<tr> 
							<td class="w-50 text-center">   
								...
								<!-- <br><span>Dy Registrar <br> GLOBAL UNIVERSITY</span> -->
							</td> 
						</tr>  
					</table> 
				</td> 
