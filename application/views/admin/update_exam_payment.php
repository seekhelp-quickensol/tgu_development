				  ...
				  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="year_sem" name="year_sem">
						...
						<option value="<?=$single->year_sem?>"><?=$single->year_sem?></option>
					  </select>
					 </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exam_month" name="exam_month" placeholder="Exam Month" value="<?php if(!empty($single)){ echo $single->exam_month;}?>">
					 </div>
					 </div> 
					  <div class="col-md-3">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Exam Year *</label>
                      <input type="text" class="form-control" id="exam_year" name="exam_year" placeholder="Exam Year" value="<?php if(!empty($single)){ echo $single->exam_year;}?>">
					 </div>
					 </div>
					<div class="col-md-3">
					 <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" readonly class="form-control datepicker" id="payment_date" name="payment_date" placeholder="Payment Date" value="<?php if(!empty($single) && $single->payment_date != "1970-01-01" && $single->payment_date != "0000-00-00"){ echo date("d-m-Y",strtotime($single->payment_date));}?>">
					 </div>
					 </div>
					 <div class="col-md-3">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="total_fees" name="total_fees" placeholder="Total Fees" value="<?php if(!empty($single)){ echo $single->total_examination_fees;}?>" readonly>
					 </div>
					 </div>
					 <div class="col-md-7">
                    <div class="form-group">
 ...
 $(document).ready(function () {		
	...
	$('#bank_form').validate({
		...
		messages: {
			...
			exam_month:{
				noSpaceatfirst:"First letter can't be space",
				alphabetsOnly:'Exam month must contain only alphabets',
			},
			exam_year:{
				noSpaceatfirst:"First letter can't be space",
				number:"Please enter valid exam year",
			},
			remark:{
				noSpaceatfirst:"First letter can't be space",
			},
