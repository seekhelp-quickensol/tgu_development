        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Apply Recommendation Letter</h4>
                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <input type="hidden" name="amount" id="amount" class="form-control" value="<?php echo !empty($amount) ? $amount->certificate_fees : 0; ?>">
                    </div>	
                      <div class="row">
                          <div class="col-md-4">
                              <div class="form-group">
 ...
 <script>
     $("#enrollment_no").keyup(function(){ 
        $.ajax({
            ...
            data:{'enrollment_no':$("#enrollment_no").val(),'table':'tbl_reccom_letter_application'},
