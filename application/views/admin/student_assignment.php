							...
							<form method="get">
							   ...
							   <div class="row">
									...
									<div class="col-md-12">
                                        ...
                                        <a href="<?=base_url();?>student_assignment" class="btn btn-danger">Reset</a>
									</div> 
		...
		<div class="col-md-12 grid-margin stretch-card p-0">
              ...
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h4 class="card-title">Student Assignment</h4><p class="card-description">

                 <!-- <p class="card-description">

                    All list of Assignment details 
             ...
             if(!empty($assignment)){
                ...
                <tr>
                   ...
                   <td><?=$assignment_result->assignment_title?></td>
                    ...
                    <form name="rejection_remark_assignment_form" id="rejection_remark_assignment_form" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="assignment_id" value="<?=$assignment_result->id?>">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;margin-left: 40%;">
                                        ...
                                        <button type="submit" name="reject_assignment" value="reject_assignment" class="btn btn-primary">Reject</button>
        ...
        var table = $('#separate_student_table').DataTable({
            ...
            buttons: [

                {
					...
					filename: 'Student Assignment List',
