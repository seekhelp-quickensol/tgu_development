	...
	<body>
	    	<div class="page">
					<div class="row" id="letter_section"> 
							...
							<div class="letter_area" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/new_marksheet-background.png')?>);background-position: center;background-size: cover;border: 2px solid #e8612b;height: 100%;">  
            						    <div class="padd_wrapper">
            							<!-- <div class="head_top_logo"><img src="<?=$this->Digitalocean_model->get_photo('images/new_marksheet-background.png')?>"></div> -->
            						<p style="text-align: center; margin-top: 32%;"><b>University Campus: </b><?php if(!empty($university_details)){ echo $university_details->address; }?></p> 
								...
								<div> 
									...
									<div class="data_box">  
										...
										<table> 
											...
											<tr class="mt-3"> 
												<td>Imphal <br> 
												Date : <?=date("d/m/Y",strtotime($transfer->issue_date));?>
												</td> 
												<td></td>  
											</tr> 
										</table>  
										...
										<div class="layer_s"> 
											<img style="width: 110px;margin-left: 30%;" src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$transfer->signature)?>">   
                            				<p style="width: 110px;margin-left: 57%;"><?=$transfer->dispalay_signature;?></p>
