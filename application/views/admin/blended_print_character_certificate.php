					...
					<div>
						<div class="letter_area" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/new_marksheet-background.png')?>);background-position: center;background-size: cover;border: 2px solid #e8612b;height: 100%;">  
                            ...
                            <div class="head_top_logo">
                                ...
                                <p style="float: left;font-size: 15px;color: #000;font-weight: 700;">Ref No.: TGU/<?=$single->id;?>/SCS/<?= date('Y', strtotime($single->application_date));?></p>
                                </div>
                                <div style="clear:both"></div>
							...
							<div style="display: block;">
                                ...
                                <p style="margin-top: 10px;color: #000;font-size: 15px;font-weight: 500;margin-bottom: 0px;line-height: 30px; word-spacing: 10px">
                                    This is to certify that
                                    <b><?=$single->student_name?></b> S/D of Shri <b><?=$single->father_name?></b> Bearing enrollment <b><?=$single->enrollment_number?></b>
									course <b><?php echo $course_name; ?></b> completed.</p>
								<div>
