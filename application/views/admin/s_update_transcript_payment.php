                ...
                <div class="card-body">
				  ...
				  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" id="payment_date" name="payment_date" placeholder="Payment Date" value="<?php if(!empty($transcript)){ echo date("d-m-Y",strtotime($transcript->payment_date));}?>">
					 </div>
					 </div>
					 <div class="col-md-3">
                    <div class="form-group">
