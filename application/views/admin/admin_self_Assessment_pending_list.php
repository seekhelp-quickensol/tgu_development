...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Self Assessment Pending List</h4>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#example').DataTable({
                    ...
                    "ajax": {
                        ...
                        "url": "<?= base_url(); ?>admin/Ajax_controller/get_self_assessment_pending_ajax",
            ...
            //         // $("#reject_remark_" + id).attr("required",false);
