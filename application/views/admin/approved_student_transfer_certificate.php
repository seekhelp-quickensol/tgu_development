					...
					<div class="card">
						<div class="card-header custom-header">
							<h4 class="card-title"><?php if (isset($_GET['type']) && $_GET['type'] == '1') {
								...
								Approved Student Transfer Certificates</h4>
						</div>
						...
						<div class="card-body">
							...
							<form method="post" name="send_to_print" id="send_to_print" action="<?= base_url(); ?>student_transfer_cer_send_to_print">
			...
			$(document).ready(function() {
				...
				var table = $('#example').DataTable({
					...
					buttons: [
						...
						{
							extend: "excelHtml5",
							title: "Approved Student Transfer Certificates",
					...
					"ajax": {
						"url": "<?= base_url(); ?>admin/Ajax_controller/get_all_appproved_student_transfer_certificate_list",
						"type": "POST",
						"data": {
							'type': type
						},
