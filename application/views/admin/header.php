								...
								<li class="nav-item">
									...
									<div class="submenu" id="overflow_y_scroll">
										...
										<ul>
											...
											<?php } ?>
											<?php if (in_array('pending_course_list', $access)) { ?>

												<li class="nav-item"><a class="nav-link <?php if ($this->uri->segment(1) == "pending_course_list") { ?>active<?php } ?>" href="<?= base_url(); ?>pending_course_list">Pending For Approval Course List</a></li>
											<?php } ?>
											...
											<?php } ?>
											<?php if (in_array('pending_stream_list', $access)) { ?>
												<li class="nav-item"><a class="nav-link <?php if ($this->uri->segment(1) == "pending_stream_list") { ?>active<?php } ?>" href="<?= base_url(); ?>pending_stream_list">Pending For Approval Stream List</a></li>
											<?php } ?>
