        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Apply Scholarship Bonafide Certificate
				  </h4>
                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                         ...
                         <!-- <input type="hidden" class="form-control" id="amount" name="amount" value="<?php if(!empty($amount)){ echo $amount->certificate_fees;}?>"> -->
                         <input type="hidden" class="form-control" id="amount" name="amount" value="<?php echo !empty($amount) ? $amount->certificate_fees : 100; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label for="exampleInputUsername4" class="hidden-label">Mobile :</label><br>

                                <label for="exampleInputUsername5" class="hidden-label">Course :</label><br>
                                <label for="exampleInputUsername6" class="hidden-label">Stream :</label>
 ...
 <script>
     $("#enrollment_no").keyup(function(){ 
      $.ajax({
            ...
            data:{'enrollment_no':$("#enrollment_no").val(),'table':'tbl_bonafide_cer_application_scholarship'},
        ...
        $.ajax({
            ...
            success: function(data){
              console.log(data);
                ...
                $("label[for='exampleInputUsername5']").text("Course: " + studentInfo.course).removeClass("hidden-label");
                $("label[for='exampleInputUsername6']").text("Stream: " + studentInfo.stream).removeClass("hidden-label");
