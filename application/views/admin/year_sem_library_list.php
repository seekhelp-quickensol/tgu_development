            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <h4>Stream Name:
                  <?php if(isset($_GET['course']) && isset($_GET['stream'])){
                      $name = $this->Library_model->get_course_stream_name($_GET['course'],$_GET['stream']);
                    
                      echo $name->stream_name. '' .$name->course_name;
                    }  ?> 
                  </h4> -->
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
      ...
      //           action: newExportAction,
		...
		dom:"Bfrtip",
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_year_sem_library_list_ajax",
			"type": "POST",
