					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select name="month" id="month" class="form-control">
								...
								<?php if($this->session->userdata('admin_id') == '39'){?>
								    <option value="June" <?php if($this->input->post('show_subject') != "" && $this->input->post('month') == "June"){ ?>selected="selected"<?php }?>>June</option>
								<?php }?>
								...
								<!--<option value="May" <?php if($this->input->post('show_subject') != "" && $this->input->post('month') == "May"){ ?>selected="selected"<?php }?>>May</option>-->
							</select>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
				...
				<?php if($this->input->post('show_subject') == "Show Subject"){
					...
					<!-- <?php
						// $exam_form_disabled = ($exam_form == "0") ? true : false;
					?>
					<?php if($exam_form != "0"){?>
					...
					if(!empty($subject)){
						...
						?>
							<tr>
                                  ...
                                  <td align="center"><input type="number" name="txtIMO<?=$i?>" id="txtIMO<?=$i?>" onkeyup="addMarks();" class="detail_text_right2 max_number" maxlength="3"/>
                                  ...
                                  <td align="center"><input type=number name="txtEMO<?=$i?>" id="txtEMO<?=$i?>" onkeyup="addMarks();" class="detail_text_right2 max_number" maxlength="3"/> 
...
$('#month').on('change', function() {
    const $year = $('#year');
    const $optionToHide = $year.find('option[value="2024"]');

    // Show all options initially
    $year.find('option').show();

    // Hide 2024 if June is selected
    if ($(this).val() === 'June') {
      $optionToHide.hide();
      // Reset year dropdown if 2024 was selected
      if ($year.val() === '2024') {
        $year.val('');
      }
    }
