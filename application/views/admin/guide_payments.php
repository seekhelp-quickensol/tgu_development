...
<link rel="stylesheet" href="<?=base_url();?>back_panel/css/date-picker.min.css">
        ...
        <div class="content-wrapper">
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
				  ...
				  <div class="col-md-3">
					...
					//   print_r($guide);exit();
					  ?>
						<input type="text" placeholder="Bank Account Number" class="form-control" id="guide_account" name="guide_account" value="<?php if(!empty($single)){ echo $single->accounr_number;}else{ if(!empty($guide)){ echo $guide->account_number;}else{ echo "NA"; }}?>">
                      ...
                      <input type="hidden" class="form-control" id="guide_id" name="guide_id" value="<?php if(!empty($student)){ echo $student->guide_id;}?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" autocomplete="off" class="form-control" id="transaction_id" name="transaction_id" placeholder="Transaction Number" value="<?php if(!empty($single)){ echo $single->transaction_no;}?>">
					  <div class="error" id="transaction_error"></div>
					 </div>
					 </div> 
					<div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="payment_date" id="payment_date" class="form-control datepicker" placeholder="Payment Date" autocomplete="off" value="<?php if(!empty($single)){ echo $single->payment_date;}?>">
					 </div>
					 </div>
					 <!-- <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Guide Payment List for - <?php if(!empty($student)){ echo $student->student_name;}?></h4>
				  <div class="row">
					<div class="col-lg-3">
                        <?php if(!empty($student)){ 
                            $total_fees = $student->guide_fees;
                        } ?>
...
<!-- <script src="<?=base_url();?>back_panel/js/bootstrap-datepicker.min.js"></script> -->
<!-- <script>
