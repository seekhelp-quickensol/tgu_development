						 ...
						 <div class="col-md-6">
							<div class="form-group">
								...
								<select name="issue_status" id="issue_status" class="form-control">
									<option value="0" <?php if(!empty($single) && $single->issue_status == "0"){?>selected="selected"<?php }?>>Inactive</option>
									<option value="1" <?php if(!empty($single) && $single->issue_status == "1"){?>selected="selected"<?php }?>>Active</option>
								</select>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="payment_date" id="payment_date" class="form-control datepicker" value="<?php if(!empty($single)){ echo date("d-m-Y",strtotime($single->payment_date));}?>">
							</div>
						</div>
						 <div class="col-md-6">
							<div class="form-group">
                    ...
                    <div class="row count_loop" id="po_div_<?=$k?>">                          
                          <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Total</label>
                                    <input type="text" name="total[]"  id="total<?=$k?>" class="form-control subject_code" value="<?=$consolidate_details_result->total?>">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Total Marks</label>
                                    <input type="text"  name="total_marks[]" id="total_marks" class="form-control subject_code" value="<?=$consolidate_details_result->total_marks?>">
                                </div>
                            </div> 
							<div class="col-md-2">
                                <div class="form-group">
