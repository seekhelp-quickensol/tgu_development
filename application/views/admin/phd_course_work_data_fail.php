...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
				title:"Course Work Data Fail List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_phd_course_work_list_fail",
			"type": "POST",
		},	
		"complete": function() {
