                    ...
                    <p style="float: left;padding-left: 30px; margin-bottom:0px;font:bold; font-weight: 700">Sr No. : <?=date('Y',strtotime($single->created_on));?><?=substr($single->enrollment_number,-6);?></p>	
						...
						<div class="letter_area" style=" background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet_background.png')?>);background-position: center top; background-size: cover;border: 2px solid #e8612b;height: 100%;margin-right:9px;margin-top:12px;">  
            							...
            							<!-- <div class="head_top_logo"><img src="<?=$this->Digitalocean_model->get_photo('images/only-logo.png')?>"></div> -->
                                        	...
                                        	<p style="float: left;font-size: 15px;color: #000;font-weight: 700;">Ref No.: TGU/<?=$single->id;?>/LOR/<?= date('Y', strtotime($single->application_date));?></p>
                                            </div>
							                <div style="clear:both"></div>
							
									<p style="color: #000;font-weight: 700;font-size: 25px; margin-top: 25px;text-align: center">II LETTER OF RECOMMENDATION FOR HIGHER STUDIES</p>
							...
							<div style="display: block;">
                                    ...
                                    <b> 
                                    Mr./Ms.  
                                    <?=$single->student_name;?></b> S/D of <b><?=$single->father_name;?></b>. 
                                    
									
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">I have been his/her mentor during the course of study and found him/her to be a hardworking, dedicated & very sincere student. He/She is a very motivated and responsible individual, who can be a positive addition for your institution as well.</p>
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">I have witnessed <b> 
                                    Mr./Ms.   <?=$single->student_name;?></b> trying to perform with the best of his/her abilities. He/She is able to establish camaraderie and a wonderful rapport with people of all ages and has excellent verbal communication skills.</p>
                            ...
                            <img style="width: 145px;margin-top: 132px;margin-right: 77px;" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->stamp)?>">   
