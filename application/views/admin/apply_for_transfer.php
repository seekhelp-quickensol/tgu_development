        ...
        <div class="content-wrapper">
			<div class="row">
				<div class="col-md-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Apply For Transfer</h4>
							...
							<form class="forms-sample" name="syllabus_form" id="syllabus_form" method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<!-- <div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputUsername1">Transfer Year *</label>
											<input type="text" class="form-control" id="transfer_session" name="transfer_session" placeholder="Transfer Year" value="<?php if(!empty($single)){ echo $single->transfer_session;}?>">
										</div>
									</div> -->
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control datepicker" id="issue_date" name="issue_date" placeholder="Issue Date" value="<?php if(!empty($single)){ echo $single->transaction_id;}?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
 ...
 $(document).ready(function () {		
	...
	$('#syllabus_form').validate({
		...
		messages: {
			...
			// },  
			transfer_session: {
				required: "Please enter transfer year",
			}, 
			// father_name: {
