                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" enctype="multipart/form-data">
                                                        <?php if ($document_result->document == "") { ?><span style="font-size: 16px; color: red;">❌</span><?php } else { ?><span style="font-size: 16px; color: green;">✔️</span><?php } ?>
                                                        <input type="file" name="document">
                                                        <input type="submit" name="document_btn" value="Upload" class="btn btn-primary">
