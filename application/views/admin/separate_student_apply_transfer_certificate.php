						...
						<div class="card-body">
							...
							<form class="forms-sample" name="syllabus_form" id="syllabus_form" method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputUsername1">Reason for Transfer</label>
											<textarea class="form-control" id="reason_of_transfer" placeholder="Reason for Transfer" name="reason_of_transfer"><?php if(!empty($single)){ echo $single->reason_of_transfer;}?></textarea>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputUsername1">Character Conduct</label>
											<textarea class="form-control" id="character_conduct" placeholder="Character Conduct" name="character_conduct" placeholder=""><?php if(!empty($single)){ echo $single->character_conduct;}?></textarea>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
