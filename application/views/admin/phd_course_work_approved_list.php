        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Course Work Data Approved List
					<!-- <a href="<?=base_url();?>add_employee" class="btn btn-primary mr-2 float-right">Add New</a> -->
				  </h4>
                  <p class="card-description">
                    <!-- Course Work Application Approved List -->
                  </p>
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
				title:"Course Work Data Approve List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_phd_course_work_list_approved",
			"type": "POST",
		},	
		"complete": function() {
