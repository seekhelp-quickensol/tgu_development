							...
							<form method="get">
							   ...
							   <div class="row">
									...
									<div class="col-md-12">
                                        ...
                                        <a href="<?=base_url();?>student_industry_assessment" class="btn btn-danger">Reset</a>
									</div> 
...
<div class="col-md-12 grid-margin stretch-card p-0">
              ...
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <h4 class="card-title">Industry Assesment</h4><p class="card-description">

                 <!-- <p class="card-description">

                    All list of Industry Assesment details 
             ...
             if(!empty($industry_assesment)){
                ...
                <tr>
                   ...
                   <td><?=$industry_assesment_result->assignment_title?></td>
                    ...
                    <form name="rejection_remark_form_industy" id="rejection_remark_form_industy" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="industry_id" value="<?=$industry_assesment_result->id?>">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;margin-left: 40%;">
                                        ...
                                        <button type="submit" name="reject_industry" value="reject_industry" class="btn btn-primary">Reject</button>
        ...
        var table = $('#industry_assmsnet').DataTable({
            ...
            buttons: [
...

                {
					...
					filename: 'Student Industry Assesment List',
