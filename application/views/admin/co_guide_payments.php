              ...
              <div class="card">
                <div class="card-body">
				  ...
				  <div class="row">
					...
					$total_pending_amt = $total_fees - $total_paid_amt ;
				...
				<tbody>
						...
						if(!empty($payment)){ foreach($payment as $payment_result){?>							
							<tr>
								...
								<td>
									<a type="button" title="Edit" data-toggle="tooltip" href="<?=base_url()?>co_guide_payments/<?=$this->uri->segment(2)?>/<?=$payment_result->id?>"  class='btn btn-success btn-sm'><i class='mdi mdi-table-edit'></i></a>
