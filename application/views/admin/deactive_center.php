        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Deactivated Center List
					<a href="<?=base_url();?>manage_center" class="btn btn-primary mr-2 float-right">Add New</a>
				  </h4>
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_deactive_center_ajax",
			"type": "POST",
		},	
		"complete": function() {
