        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved Separate Student Provisional Degrees</h4><p class="card-description">
				   <form method="post" name="send_to_print" id="send_to_print">
						...
						<p class="card-description">All list</p> 
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved Separate Student Provisional Degrees List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_approved_separate_student_provisional_degrees_list",
			"type": "POST",
