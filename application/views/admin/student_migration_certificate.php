          ...
          <div class="card">
            ...
            <div class="card-header custom-header">
              <h4 class="card-title"> <?php if (isset($_GET['type']) && $_GET['type'] == '1') {
                                        ...
                                        echo 'Regular';
                                      } ?> Student Migration Certificates</h4>
            </div>
            <div class="card-body">
              ...
              <form method="post" name="send_to_print" id="send_to_print" action="<?= base_url(); ?>student_migration_send_to_print">
      ...
      $(document).ready(function() {
        ...
        var table = $('#example').DataTable({
          ...
          buttons: [
            ...
            {
              extend: "excelHtml5",
              title: "Student Migration Certificates",
          ...
          "ajax": {
            "url": "<?= base_url(); ?>admin/Ajax_controller/get_all_migration_certificates_list",
            "type": "POST",
            "data": {
