        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Assign Guide To Blended Scholar</h4>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Assign Guide To Blended Scholar List</h4>
                  <p class="card-description">
                    All list of Assigned Seperate Students
                  </p>
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
				title:"Assign Guide To Blended Scholar List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_assigned_seperate_students_ajax",
			"type": "POST",
		},	
		"complete": function() {
...
<script>
		$(".scholar_relation").on("keyup change", function(){  
				if($("#guide_name").val() != "" && $("#student_name").val() != ""){
			$.ajax({
				type: "POST",
				url: "<?=base_url();?>admin/Ajax_controller/get_unique_guide_student_separate",
