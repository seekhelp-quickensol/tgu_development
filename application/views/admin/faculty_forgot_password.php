          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <img src="<?=base_url();?>images/logo/<?php if(!empty($university_details) && $university_details->logo != ""){ echo $university_details->logo;}else{ echo "demologo.png";}?>" alt="logo">
              </div>
              ...
              <form class="pt-3" id="login_form" name="login_form" method="post" >
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="<?=base_url();?>faculty_login" class="auth-link text-black">Back to Login?</a>
                </div>
                <div class="my-3">
