...
<head>
    <title>Bachelor Of Law(LLB) | Birtikendrajit University </title>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-8">
                        <div class="hero_content">
                            ...
                            <div class="herotext_2">Admission Open For LLB 2022-23</div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="enquir_form">
                            ...
                            <form method="post" name="course_form" id="course_form">
                                ...
                                <div class="clearfix" style="margin-bottom: 5px;"></div>
                                <div class="form-group">
                                    <input type="text" name="course" id="course" placeholder="Course Name*" class="form-control select-arrow-cust widget_input" value="Bachelor Of Law">
...
.home_banner {
            ...
            background: url('landing_assets/images/BTU/bachelor_of_law_bg1.jpg');
    ...
    <div class="container info_group_main">
            <div class="edu_tabs" style="text-align:center">
                <a class="active showSingle" target="1">
                   <li> <img src="<?=base_url()?>landing_assets/images/t1.png"> <span class="edu_p">Bachelor Of Law
            ...
            <section>
                <div class="main">
                    <div class="container info_group_main">
                        <h2 class="course_heading">Bachelor Of Law(LLB)</h2>
                        ...
                        <div class="container info_group">    
                            <div class="what_llb">
                                <h3 class="course_heading">What Is LLB (Bachelor Of Law)?</h3>
                                  <p class="capitalize">LLB, also known as Bachelor of Law or Legum Baccalaureus, is an undergraduate law program of 3-year or 5-year duration that can be pursued after graduation and 10+2 respectively. </p>
                                  <p class="capitalize">The Bachelor of Law is a foundational course in law that teaches students about legal procedures followed in the profession. </p>
                                  <p class="capitalize">The course help students develop a logical, analytical and critical understanding of legal affairs and teach them how to use these skills to resolve social, and legal issues in society. </p>
                                  <p class="capitalize">Competitors who have finished their graduation in any discipline are qualified to seek after 3-year LLB, The 5-year LLB is a coordinated regulation program that can be sought after in the middle of the road.</p>
                                  <p class="capitalize">The course is offered by colleges that are approved by the Bar Council of India (BCI).</p>
                                  <p class="capitalize">Also note that to pursue law in India, the LLB degree holder also has to qualify in the All India Bar Examination (AIBE) conducted by the BCI. </p>
                            </div>
                        </div>
                        ...
                        <div class="container info_group">
                            <div class="law_eligi">
                                ...
                                <p class="capitalize">Since 3-year LLB is a law course offered after graduation, candidates aspiring for a law degree must have passed graduation with a minimum of 45% marks from a recognized institute in any discipline like BA, B.Com, B.Sc, BBA, BCA, etc.</p>
                      ...
                      <div class="container info_group">
                        ...
                        <p class="capitalize">There is no limit as to what level one can reach after completing an LLB degree. Because if we look at social personalities dominating the public, starting from the late Arun Jaitley and Ram Jethmalani, to present luminaries like Harish Salve and Aryama Sundaram, to the former Chief Justice Ranjan Gogoi, the sky's the limit. </p>
                        <p class="capitalize">Then some may also decide to go for higher studies and pursue LLM and even Ph.D. At the master's level, one may opt for specialization, which can give more muscle to one’s resume and job prospects. Again, some may decide to become teachers, a profession which is getting more attention in recent times.</p>
                        <p class="capitalize">After completing the LLB degree, one may work in a variety of roles - corporate lawyer, judge, legal advisor, or legal manager. How far one goes, however, depends on factors like skills levels, profession chosen, experience, etc. Some individuals again become social activists and fight for the legal rights of marginal sections of society. The role can be unglamorous and require a lot of sacrifices and standing up to powerful people, but the job satisfaction can be immense. </p>
                     ...
                     <div class="container info_group">
                        <div class="advocate">
                             ...
                             <p class="capitalize">Advocacy is a popular career path for LLB graduates. Students who choose this route can practice in the courts. It should be noted that in order to qualify for their profession, candidates must first pass the All India Bar Council test.</p>
                            </div>
                     </div>    
                     ...
                     <div class="container info_group">
                        <div class="selc_process">
                           ...
                           <p class="capitalize">Those who meet the requirements could even join the Air Force, Indian Army, or Navy. </p>
                           <p class="capitalize">They are also eligible to take UPSC (Union Public Service Commission) or SPSC examinations such as HAS and IAS (State Public Service Commission).</p>
                           <p class="capitalize">Ph.D At the master's level, one may opt for specialization, which can give more muscle to one’s resume and job prospects. Again, some may decide to become teachers, a profession which is getting more attention in recent times.</p>
                        </div>
                     </div>
                     ...
                     <div class="container info_group">
                        <div class="leagl_cou">
                             ...
                             <p class="capitalize">Following the successful completion of your LLB, you can work as a legal counselor in law offices, private companies, corporate firms, or banks. You can give legal advice on a variety of topics. Furthermore, your legal knowledge might be put to use in NGOs.</p>
                            </div>
                     </div>  
                     ...
                     <div class="container info_group">
                        <div class="Judiciary">
                             ...
                             <p class="capitalize">students could also work for the country's justice system as judges or magistrates. A judicial exam is conducted by the public service commission and candidates are required to pass the exam to be appointed as a judge or magistrate. This is an extremely difficult exam to pass.</p>
                     ...
                     <div class="container info_group">
                        <div class="Teaching">
                             ...
                             <p class="capitalize">Then some may also decide to go for higher studies and pursue LLM and even Ph.D. At the master's level, one may opt for specialization, which can give more muscle to one’s resume and job prospects. Again, some may decide to become teachers, a profession which is getting more attention in recent times.</p>
                            <p class="capitalize">Students with strong academic credentials and the ability to explain and narrate various topics to a group of people are ideal candidates for the position of lecturer at one of the country's most prestigious universities or law schools.</p>
                            </div>
                     </div> 
                     ...
                     <div class="container info_group">
                        <div class="low_qa">
                          <h3 class="course_heading">FAQs LLB (Bachelor of Law)</h3>
