...
<head>
    <title>Diploma In Acupressure & Acupuncture | Global University </title>
...
<div class="main">
    <div class="container">
        <h2 class="course_heading">MBA Admissions 2022</h2>
        <h2 class="course_heading">Top MBA College In Manipur, India</h2>
        <p class="class_paragraph">Are you looking for the best MBA college in Manipur, India? Look no further!THE GLOBAL UNIVERSITY is the top choice for students seeking quality education in business administration. We offer a comprehensive curriculum that will prepare you for a successful career in the business world. Our faculty are experienced professionals who will guide you through your studies and help you reach your goals. We are proud to offer a top-notch education at an affordable price. Contact us today to learn more about our college and how we can help you achieve your dreams!
          </p>
                <div class="col-6 mba">
                <img src="<?=base_url()?>landing_assets/images/mba_1.jpg">
                </div>
                <h2 class="course_heading">Why should you pursue MBA as a career?
                </h2>
                <p class="class_paragraph">If you're considering your career options, MBA may be a good choice. An MBA can give you the skills and knowledge you need to succeed in business. 
                ...
                <div class="col-6 mba">
                <img src="<?=base_url()?>landing_assets/images/mba_2.jpg">
                </div>
                ...
                <h2  class="course_heading">MBA Admissions 2022-23 At BTU -
                </h2>
                <p class="class_paragraph">For its MBA programs, BTU offers more than 15 different specialties. Admission to this degree program requires both a counseling session and valid mark sheets.
                BTU University's MBA Program For the Year 2022-23 -
                </p>
                <h2  class="course_heading">MBA Top Courses At BTU -
                </h2>
                <div class="col-6 mba">
                <img src="<?=base_url()?>landing_assets/images/mba_3.png">
                </div>
                ...
                <li><b>Human Resource Management</b> - The practice of recruiting, hiring, assigning, and managing personnel is known as human resource management. Human resource is a common abbreviation for HRM.
                </li>
                <li><b>Marketing Management & Finance</b> -   Financial marketing management is a concept in business that entails efficiently managing an organization's resources by using recognized macroeconomic and microeconomic aspects in relation to the firm in question.
                </li>
                <li><b>Banking & Insurance</b> -  A two-year postgraduate program in management called the MBA in Banking and Insurance examines management theories in the banking and insurance sectors. One of the main industries in India where financial experts are employed in the banking and insurance sector, which is the target audience for the course. </li>
                    <div class="col-6 mba">
                    <img src="<?=base_url()?>landing_assets/images/mba_4.jpg">
                    </div>
                    <li><b>Finance</b> -  Students with an MBA in Finance have access to a range of career prospects in the financial sector. Students learn how to evaluate corporate reports, predict economic trends, maximize stock value, select investment portfolios, and strike a balance between risk and profitability in this course.
                </li>
                <li><b>Travel & Tourism Management</b> -  A two-year post-graduate specialized course called an MBA in Travel and Tourism covers many different facets of business management but places a particular emphasis on travel, tourism, and hospitality.
                </li>
                <div class="col-6 mba">
                <img src="<?=base_url()?>landing_assets/images/mba_5.jpg">
                </div>
                <li><b>Journalism & Mass Communication </b> - Managing teams of media experts, media entertainment production companies, numerous mass communication channels, and technology are all part of the field of business administration known as "media management."
                </li>
                <li><b>Executive</b> -  For students who are further along in their careers and wish to continue working full-time while attending school, an executive MBA program, often known as an EMBA program, has been developed. While every program has a different schedule, the majority provide part-time options including weekend classes.
                </li>
                <li><b>Supply Chain Management</b> -  Management of the supply chain MBA programs are professional master's degrees that combine supply chain management specialized courses with a primary business administration curriculum. Master's degrees in business administration typically take one to three years to complete.
                </li>
                <li><b>Industrial Engineering </b> - Students in industrial engineering gain knowledge of optimizing complex organizations, processes, and systems. Engineering, science, and math are all combined in this subject of study. Students may also learn about topics including quality assurance, operations management, and statistical analysis.
                </li>
                <li><b>Hotel Management</b> - The goal of the postgraduate MBA in Hotel Management program is to help students develop the managerial skills necessary for working in the services, tourism, or hotel industries.
                </li>
                <div class="col-6 mba">
                    <img src="<?=base_url()?>landing_assets/images/mba_6.png">
                    </div>
                    <li><b> Pharmaceutical Management/Biotechnology  </b> - The goal of this management is to train managers in the biopharmaceutical, bio agricultural, bio-supplier, bio-services, and bioinformatics industries. The course structure has been created to meet the demands of this industry.
                </li>
                <li><b> IT </b> - With the typical business understanding of an MBA combined with specialist courses on information security, telecommunications, and IT project management, to mention a few, an MBA in IT will equip you with the abilities required to manage both IT systems and personnel.
                </li>
                <li><b> Operations & Production  </b> -  The management of the procedures and activities used by businesses to create their products and services falls under the category of production and operations. It is the research into the planning, running, and enhancement of production systems for effectiveness and efficiency.
                </li>
                <li><b>International Business Development  </b> - Similar to a conventional MBA, an MBA in International Business also teaches you the leadership and communication skills required to succeed in multinational firms, as well as information on international markets, global economics, and cross-border partnerships.
                </li>
                ...
                <li><b>Project Management </b> -  Graduates who combine their project management training with an MBA have a more comprehensive understanding of how projects can help overall business operations. It comes with definite advantages by nature. The future of business lies in project management.
                </li>
                <li><b> Retail </b> -  Knowledge of the management of the retail industry is provided via an MBA in Retail Management. In order to streamline the retail process, key managerial skills must be learned and practiced through this program.
                </li>
                <li><b> Medical Plants & Agriculture </b> - The student learns the methods used in the production and distribution of foods and fibers, as well as related business concepts, in the Master of Business Administration course in Agriculture.
                </li>
                <div class="col-6 mba">
                    <img src="<?=base_url()?>landing_assets/images/mba_7.png">
                    </div>
                    <li><b> Health Administration  </b> -  A two-year postgraduate management degree program called the MBA in Healthcare Management prepares students to oversee various operations in healthcare systems like hospitals and pharmaceutical corporations.
                </li>
                    <li><b> Management </b> -  A student with a general management MBA will be prepared to enter a variety of industries and professional pathways because it covers numerous business-related topics. Graduating students should anticipate gaining a solid understanding of financial models, human resource management, as well as marketing, and corporate strategy.
                </li>
                    <li><b> Business Analytics </b> - One of the most popular MBA specializations available is the MBA in Business Analytics, an MBA degree with a focus on analytics. The course material covers the principles of business while preparing you to approach a company from a data-driven viewpoint.
                </li>
                    <li><b> Marketing Management </b> - The most popular mainstream course is an MBA in marketing. Students with an MBA in Marketing who possess strong marketing skills are always in demand because marketing is the driving force behind any organization that brings in customers and money for the business.
                </li>
                <div class="col-6 mba">
                    <img src="<?=base_url()?>landing_assets/images/mba_8.jpg">
                    </div>
                    ...
                    <li><b> Data Science </b> - The MBA in Data Science and Analytics is a specialized program that trains professionals to address complex business problems in the future that call for the integration of data-driven decision-making modules into IT, contemporary software, and mobile applications.
                </li>
                <h2 class="course_heading">Eligibility Criteria -</h2>
                <p class="class_paragraph">Candidates must have passed at least a Bachelor's Degree Examination <b>(3 years)</b>
                </p>
                <h2 class="course_heading"> Skillset Required For MBA - </h2>
                <div class="col-6 mba">
                    <img src="<?=base_url()?>landing_assets/images/mba_9.png">
                    </div>
                    <h2 class="course_heading">BTU’s Admission Process for MBA in 2022-23 -
                </h2>
                <p class="class_paragraph">
                Candidates for admission must complete the application form according to the instructions below.
                </p>
                <p class="class_paragraph"><b> step 1 - </b>Visit the official website of <a href="https://www.theglobaluniversity.edu.in" target="_blank">BIR TIKENDRAJIT UNIVERSITY</a> (https://www.theglobaluniversity.edu.in/)                                              then select the "Admission" tab. Select “Admission Form” and fill in details respectively.
                </p>
