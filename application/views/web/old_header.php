		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<div class="discrimination_top_tab" id="demo">
					<h5><a href="<?=base_url();?>caste-based-discrimination">Caste Based Discrimination</a></h5>
				</div>
		        <div class="header_box ">
				    ...
				    <a href="<?=base_url();?>student-login" target="_blank"  class="admin center_login hidden-xs"><i class="fa fa-user" aria-hidden="true"></i> Student <span class="hide_sm">Login </span></a>
					<a href="<?=base_url();?>center-access" target="_blank" class="center_login  hidden-xs"><i class="fa fa-university" aria-hidden="true"></i> Center <span class="hide_sm">Login</span></a>
                    <a href="<?=base_url();?>erp-access" target="_blank"  class="admin_Area center_login hidden-xs"><i class="fa fa-user" aria-hidden="true"></i> Employee </a>
                    <a href="<?=base_url();?>faculty_login" target="_blank"  class="admin_Area center_login hidden-xs"><i class="fa fa-user" aria-hidden="true"></i> Faculty Login</a>
                    <a href="<?=base_url();?>direct_pay" target="_blank"  class="admin_Area center_login hidden-xs"><i class="fa fa-credit-card" aria-hidden="true"></i> Pay Online </a>
					...
					<div class="row">
						<ul class="uni_header_menu_main">
							...
							<li class="mega_bar "><a href="#">Courses <i class="fas fa-angle-down"></i></a>
								<ul class="submenu slideInUp animated course_submenu">
									<?php 
							...
							<li class="mega_bar "><a href="#">Recognition<i class="fas fa-angle-down"></i></a>
								<ul class="submenu slideInUp animated">
									...
									<li><a href="#">Pharmacy Council of India (PCI)</a></li>
								</ul>
							</li>
							...
							<li class="mega_bar "><a href="#">Research<i class="fas fa-angle-down"></i></a>
								<ul class="submenu slideInUp animated">
									...
									<li><a href="<?=base_url();?>course_work_login">Course Work Exam</a></li>
							...
							<li class="mob_discrimination_tab"><a href="<?=base_url();?>caste-based-discrimination">Caste Based Discrimination</a></li>
						</ul>
					</div>
				</div>
			</div>
