	...
	<div class="header_cc_area slide-bg">
		<div class="container  overlay-about" style="width: 100%;">
			...
			<div class=" container-fluid text-center inner-heading-content">
				<h2 class="main-heading-inner-pages border-b border"> Press Release </h2>
...
<section class="c-padding inner-bg-99">
	...
	<div class="uni_mainWrapper container box-shadow-global">
		...
		<div class="content_work">
			<div class="container">
				<div class="row">
					<h2 class="title">University Press Release</h2>
					<div class="col-md-12">
						<embed src="<?= base_url(); ?>images/notice_board/BTU-News-paper-Article.pdf" type="application/pdf" width="100%" height="600px" />
					</div>
				</div>
				<div class="row">
					<div class="grid" id="masonry-grid">
						<!--<div class="item">
							<div class="card">
								<img src="<?= base_url(); ?>images/notice_board/press_rel1.jpeg" alt="Notice Board" style="width:100%">
							</div>
						</div>-->
