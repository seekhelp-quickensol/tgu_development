...
<head>
   ...
   <link rel="shortcut icon" href="<?= base_url(); ?>images/logo/<?php if (!empty($university_details) && $university_details->logo != "") {
            ...
            <div class="col-md-12 upper-text">
               <div class="col-md-5">
                  <span class="helpline"> <i class="fa fa-phone-square" aria-hidden="true"></i>
                     ...
                     <a href="tel:+9190909090990"> Helpline Number : 90909090990</a> | (10 AM to 5 PM) </span>
                  <!-- <span class="caste"> <a href="<?= base_url(); ?>caste-based-discrimination">Caste Based Discrimination</a> </span> -->
               </div>
               <!-- <div class="col-md-6">
               ...
               <div class="noti_link_view_result hidden-sm hidden-md hidden-lg" id="demo-second">
                  ...
                  <div class="right-icons">
                     <!-- <a title="student login" href="<?= base_url(); ?>student-login" target="_blank" class="center_login hidden-xs">
                        <i class="top-btns student" aria-hidden="true"></i> <img src="images/icons/student2.png" width="18" height="18px">
                     ...
                     <!-- <a title="Center Login" href="<?= base_url(); ?>center-access" target="_blank" class="center_login hidden-xs ">
                        ...
                        <img src="images/icons/center2.png" width="18" height="18px">
                        <span class="hide_sm"> CC Login</span>
                    </a> -->

                     <span class="span-pipe">|</span> <a title="Employee Login" href="<?= base_url(); ?>erp-access" target="_blank" class="center_login hidden-xs"><i class="top-btns" aria-hidden="true"></i> <img src="images/icons/employee.png" width="18" height="18px"> <span> Employee </span> </a>

                     <!-- <span class="span-pipe">|</span> -->
                     <!-- <a title="Faculty Login" href="<?= base_url(); ?>faculty_login" target="_blank" class="center_login hidden-xs"><i class="top-btns" aria-hidden="true"></i> <img src="images/icons/faculty2.png" width="18" height="18px"> <span> Faculty Login </span></a>
                     <span class="span-pipe">|</span>
                     <a title="Pay Online" href="<?= base_url(); ?>direct_pay" target="_blank" class="center_login hidden-xs"><i class="top-btns" aria-hidden="true"></i> <img src="images/icons/pay-online2.png" width="18" height="18px"> <span> Pay Online </span> </a>
