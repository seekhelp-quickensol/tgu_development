								...
								<div class="col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="hidden" name="std_id" id="std_id" readonly  value="<?php if(!empty($student)){ echo $student->id;}?>">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select name="religion" id="religion" class="form-control charector" maxlength="100" placeholder="Religion">
												...
												<option value="Hindu" <?php if(!empty($student) && $student->religion == "Hindu"){ ?><?php }?>>Hindu</option>
												<option value="Sikh" <?php if(!empty($student) && $student->religion == "Sikh"){ ?><?php }?>>Sikh</option>
												<option value="Christian" <?php if(!empty($student) && $student->religion == "Christian"){ ?><?php }?>>Christian</option>
												<option value="Muslims" <?php if(!empty($student) && $student->religion == "Muslims"){ ?><?php }?>>Muslims</option>
												<option value="Others" <?php if(!empty($student) && $student->religion == "Others"){ ?><?php }?>>Others</option>
											</select>
										</div>
									</div>
									...
									<div class="col-md-12">
										...
										<div class="row">
											<div class="col-md-12 edu">
												<div class="form-group">
													<label></label>
													<button type="submit" class="btn btn-primary s" name="register" id="register">Next</button>
...
$("#admission_form").validate({
	...
	messages: {
		...
		exam_year: {
			required: required:"Please enter exam year !",
		},	
	}, 
