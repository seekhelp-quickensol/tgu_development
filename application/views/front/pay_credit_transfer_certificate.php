											...
											<form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler"> 
													...
													<div class="box_layer_t"> 
														<div class="btn_center"> 
														    ...
														    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. 1000</b> to get your Medium of Instruction Letter ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
															<button type="submit" class="btn btn-success" value="CheckOut">Pay Via CC Avenue</button> 
														</div> 
													</div> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>credit_transfer_certificate_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>credit_transfer_certificate_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
