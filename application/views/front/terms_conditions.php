<?php include('header.php')?>
		...
		<section class="terms-conditions-area pt-4 pb-4">
			<div class="container">
				...
				<div class="main-default-content">
					...
					<p>By accessing and using the Global University website, you agree to comply with and be bound by the following terms and conditions of use. If you do not agree to these terms, please refrain from using our website.</p>
					<h3>2. Use of Website</h3>
					<p>a. The content of this website is for general information and use only. It is subject to change without notice.</p>

					<p>b. Unauthorized use of this website may give rise to a claim for damages and/or be a criminal offense.</p>

					<p>c. Your use of any information or materials on this website is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility to ensure that any products, services, or information available through this website meet your specific requirements.</p>
				
					<h3>3. Privacy Policy</h3>
					<p>Our Privacy Policy, which outlines how we collect, use, and protect your information, is incorporated into these terms and conditions. You can view our  <a href="<?=base_url();?>privacy-policy">Privacy Policy</a>.</p>				
				
					<h3>4. Copyright and Trademarks</h3>
					<p>a. This website contains material which is owned by or licensed to us. This material includes, but is not limited to, the design, layout, look, appearance, and graphics. Reproduction is prohibited without prior written consent.</p>
					<p>b. All trademarks reproduced on this website, which are not the property of, or licensed to the operator, are acknowledged on the website.</p>
					...
					<p>Global University reserves the right to change these terms and conditions at any time. Revised terms will apply to the use of our website from the date of the publication of the revised terms on our website.</p>
					...
					<?php if(!empty($terms_and_condition)){
						echo $terms_and_condition->terms_and_conditions;
					}?>
