...
$session = array( 
	'session_amount' 	=> $student_data->payment_amount, 
	'order_id' 			=> $student_data->id, 
); 
		...
		<div class="page-title-content"> 
			<h2>Re-evaluation Payment</h2>   
					<ul> 
						...
						<li class="active">Re-evaluation Payment</li> 
					</ul> 
				</div> 
			</div> 
		</div> 
	...
	<div class="container">
        ...
        <div class="card">
            <div class="card-header">
             ...
             <form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler">
				<div class="row">
					<div class="col-lg-12">
						<div class="btn_center" style="width: 205px;margin: 25px auto 0px;">
							<button type="submit" class="default-btn2" value="CheckOut">Click to pay</button>
						</div>
					</div>
				</div>
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student_data->id?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?=$student_data->payment_amount?>.00"/></td>
				</tr>
				<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$student_data->student_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$student_data->address?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing City	:</td><td><input type="text" name="billing_city" value="<?=$student_data->city_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing State	:</td><td><input type="text" name="billing_state" value="<?=$student_data->state_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$student_data->pincode?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Country	:</td><td><input type="text" name="billing_country" value="India"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$student_data->mobile?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=strtolower($student_data->email)?>"/></td>
		        </tr>
		        <tr>
		        	<td colspan="2">Shipping information(optional)</td>
		        </tr>
		        <tr>
		        	<td>Shipping Name	:</td><td><input type="text" name="delivery_name" value="<?=$student_data->student_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Shipping Address	:</td><td><input type="text" name="delivery_address" value="<?=$student_data->address?>"/></td>
		        </tr>
		        <tr>
		        	<td>shipping City	:</td><td><input type="text" name="delivery_city" value="<?=$student_data->city_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>shipping State	:</td><td><input type="text" name="delivery_state" value="<?=$student_data->state_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>shipping Zip	:</td><td><input type="text" name="delivery_zip" value="<?=$student_data->pincode?>"/></td>
		        </tr>
		        <tr>
		        	<td>shipping Country	:</td><td><input type="text" name="delivery_country" value="India"/></td>
		        </tr>
		        <tr>
		        	<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="<?=$student_data->mobile?>"/></td>
		        </tr>
		        <tr>
		        	<td>Merchant Param1	:</td><td><input type="text" name="merchant_param1" value="The Global University"/></td>
		        </tr>
		        <tr>
		        	<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="new_tbl_re_evaluation_student"/></td>
		        </tr>
				<tr>
