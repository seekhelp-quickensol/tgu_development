							...
							<ul class="navbar-nav ">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="<?= base_url() ?>public-self-disclosure" class="nav-link <?php if ($this->uri->segment(1) == "public-self-disclosure") { ?>active<?php } ?>">Public Self Disclosure</a>
										</li>
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<!--<li class="nav-item">-->
										<!--	<a href="<?= base_url() ?>faculty-of-paramedical" class="nav-link <?php if ($this->uri->segment(1) == "faculty-of-paramedical") { ?>active<?php } ?>">Faculty of Paramedical</a>-->
										<!--</li>-->
										<li class="nav-item">
											<a href="<?= $this->Digitalocean_model->get_photo('uploads/TGU-POLICY-FOR-CREDIT-TRANSFER-AND-RPL.pdf') ?>" target="_blank" class="nav-link">Policy for Credit Transfer and RPL</a>
										</li>
									</ul>
								</li>
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="<?= base_url() ?>aiu">AIU</a></li>
										<li><a href="<?= base_url() ?>grants-commission">University Grants Commission</a></li>
								...
								</li>								<li class="nav-item">									<a target="_blank" class="nav-link" href="<?=$this->Digitalocean_model->get_photo('documents/THE GLOBAL UNIVERSITY Digital Prospectus 2025.pdf')?>">Prospectus</a>								</li>
							</ul>
