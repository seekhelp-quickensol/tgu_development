<?php include('header.php');?>
		...
		<div class="page-title-area bg-15">
			<div class="container">
				<div class="page-title-content">
					<h2>Collaboration Foreign Form</h2>
					...
					<ul>
						...
						<li class="active">Collaboration Foreign Form</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-8 col-md-12">
                        ...
                        <div class="admission_box"> -->
							...
							<div class="billing-details mr-15">
								<h3 class="title">Center Details</h3>
								<small class=" ">Please provide your personal details</small>
						...
						<h3>Center Details</h3>
							...
							<div class="row">
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="center_name" name="center_name" autocomplete="off" placeholder="Center Name">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" name="head_name" id="head_name" class="form-control charector" autocomplete="off" placeholder="Head Name">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="head_email" name="head_email" autocomplete="off" placeholder="Head Email" value="">
									</div>
								...
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="head_contact_number" autocomplete="off" name="head_contact_number" placeholder="Head Contact Number" value="" maxlength="10" minlength="10">
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="contact_person_contact" autocomplete="off" name="contact_person_contact" placeholder="Contact Person Contact" value="">
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-3">
									...
									<label>Passport Number *</label>
										  <input type="text" name="passport_number" placeholder="Passport Number" autocomplete="off" id="passport_number" class="form-control">
									</div>
								</div>
							</div>
							<hr>
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="present_address" name="present_address" autocomplete="off" placeholder="Present Address" value="">
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4">
									...
									<select class="form-control select2_single" name="present_state" id="present_state">
										...
										<?php if(!empty($present_state)){ foreach($present_state as $state_result){?>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<select class="form-control select2_single" name="present_city" id="present_city">
											...
											<?php if(!empty($present_city)){ foreach($present_city as $city_result){?>
								...
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" autocomplete="off" id="present_pincode" name="present_pincode" placeholder="Pin Code" value="">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" autocomplete="off" id="collaboration_address" name="collaboration_address" placeholder="Present Address" value="">
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4">
									...
									<select class="form-control select2_single" name="collaboration_state" id="collaboration_state">
										<option value="">Select State</option>
										<?php if(!empty($collaboration_state)){ foreach($collaboration_state as $state_result){?>
										<option value="<?=$state_result->id?>" ><?=$state_result->name?></option>
										<?php }}?> 
									</select>
									<i class="ri-arrow-down-s-line"></i>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<select class="form-control select2_single" name="collaboration_city" id="collaboration_city">
											<option value="">Select City</option>
											<?php if(!empty($collaboration_city)){ foreach($collaboration_city as $city_result){?>
											<option value="<?=$city_result->id?>" ><?=$city_result->name?></option>
											<?php }}?> 
										</select>
									<i class="ri-arrow-down-s-line"></i>
								...
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										<label for="exampleInputConfirmPassword1">Pin Code *</label>
										<input type="text" class="form-control" autocomplete="off" id="collaboration_pincode" name="collaboration_pincode" placeholder="Pin Code" value="">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" autocomplete="off" id="permanent_address" name="permanent_address" placeholder="Permanent/Corresponding Address">
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4">
									...
									<select class="form-control select2_single" name="permanent_state" id="permanent_state">
										<option value="">Select State</option>
										<?php if(!empty($permanent_state)){ foreach($permanent_state as $state_result){?>
										<option value="<?=$state_result->id?>" ><?=$state_result->name?></option>
										<?php }}?> 
									</select>
									<i class="ri-arrow-down-s-line"></i>
								...
								<div class="col-lg-4 col-md-4">
									<div class="form-group">
										...
										<select class="form-control select2_single" name="permanent_city" id="permanent_city">
											<option value="">Select City</option>
											<?php if(!empty($permanent_city)){ foreach($permanent_city as $city_result){?>
											<option value="<?=$city_result->id?>" ><?=$city_result->name?></option>
											<?php }}?> 
										</select>
									<i class="ri-arrow-down-s-line"></i>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-3">
									<div class="form-group">
										...
										<input type="file" class="form-control" name="other_document[]" id="other_document" multiple placeholder="Upload Other Document">
									</div>
								</div>
	...
	$(document).ready(function() {
		...
		$.validator.addMethod("validate_passport", function(value, element) {
		...
		$('#collaboration_form').validate({
			...
			messages: {
				...
				head_contact_number: {
					...
					head_contact_number: "Please enter valid head contact number",
				...
				passport_number: {
					...
					validate_passport:"Please enter valid passport number",
					noHTML:"please enter valid passport number",
				},
				present_address: {
	...
	$("#head_email").keyup(function() {
		if($("#head_email").val() != ''){
            $.ajax({
                ...
                data: {
                    'head_email': $("#head_email").val(),'id':'<?= $id ?>'},
                success: function(data) {
				console.log(data);
                    if (data == "0") {
		...
		if($("#contact_person_email").val() != ''){
            $.ajax({
                ...
                data: {
                    'contact_person_email': $("#contact_person_email").val(),'id':'<?= $id ?>'},
                success: function(data) {
				console.log(data);
                    if (data == "0") {
