						...
						<div class="row">	
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input autocomplete="off" type="email" name="email" id="email" class="form-control" placeholder="Email Address" value="<?php if(!empty($old_student_details)){ echo $old_student_details->email;}?>">
						...
						<!-- 							
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="student_name" id="student_name" class="form-control charector" autocomplete="off" placeholder="Student Full Name" value="<?php if(!empty($old_student_details)){ echo $old_student_details->student_name;}?>">
								</div>
							</div> -->
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									<label>Student Name <span class="req">*</span></label>
									<input type="text" name="student_name" id="student_name" class="form-control charector" autocomplete="off" placeholder="Student Full Name">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="father_name" id="father_name" class="form-control charector" autocomplete="off" placeholder="Father's Full Name" value="<?php if(!empty($old_student_details)){ echo $old_student_details->father_name;}?>">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="father_profession" autocomplete="off" id="father_profession" class="form-control charector" placeholder="Father's/Husband's Profession" value="<?php if(!empty($old_student_details)){ echo $old_student_details->father_profession;}?>">
								</div>
							</div> 
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="mother_name" id="mother_name" autocomplete="off" class="form-control charector" placeholder="Mother's Full Name" value="<?php if(!empty($old_student_details)){ echo $old_student_details->mother_name;}?>">
								</div>
							</div>
							...
							<!-- <div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="mother_profession" autocomplete="off" id="mother_profession" class="form-control charector" placeholder="Mother's Profession" value="<?php if(!empty($old_student_details)){ echo $old_student_details->mother_profession;}?>">
								</div>
							</div>  -->
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="date_of_birth" id="date_of_birth" class="form-control datepicker" placeholder="DD-MM-YY" autocomplete="off" value="<?php if(!empty($old_student_details)){ echo $old_student_details->date_of_birth;}?>">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control rules" name="address" id="address" placeholder="Current Address" autocomplete="off" value="<?php if(!empty($old_student_details)){ echo $old_student_details->address;}?>">
								</div>
							</div>
							...
							<!-- <div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="id_number" id="id_number" placeholder="ID Number" autocomplete="off" class="form-control rules" maxlength="100" placeholder="" value="<?php if(!empty($old_student_details)){ echo $old_student_details->id_number;}?>">
								</div>
							</div> -->
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="nationality" id="nationality" autocomplete="off" class="form-control charector" maxlength="100" placeholder="Nationality" value="<?php if(!empty($old_student_details)){ echo $old_student_details->nationality;}?>">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6" id="religin_specify_div" <?php if(empty($old_student_details)){ ?>style="display:none" <?php }else if($old_student_details->religion == "Others"){ ?> style="display:block" <?php }?>>
								<div class="form-group">
									...
									<input type="text" name="religin_specify" id="religin_specify" class="form-control charector" placeholder="Please specify your religion" value="<?php if(!empty($old_student_details)){ echo $old_student_details->religin_specify;}?>"> 
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="hidden" name="hidden_userfile" id="hidden_userfile" value="<?php if(!empty($old_student_details)){ echo $old_student_details->photo;}?>">
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="hidden" name="hidden_noc" id="hidden_noc" value="<?php if(!empty($old_student_details)){ echo $old_student_details->noc;}?>">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input class="form-control number_only" required name="pincode" autocomplete="off" id="pincode" placeholder="Pin Code" value="<?php if(!empty($old_student_details)){ echo $old_student_details->pincode;}?>">
								</div>
							</div>
...
<!-- 
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="father_profession" id="father_profession" class="form-control charector" placeholder="Father/Husband Profession" value="<?php if(!empty($old_student_details)){ echo $old_student_details->father_profession;}?>">
								</div>
							</div> 
						</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									<label>Nationality <span class="req">*</span></label>
									<input type="text" name="nationality" id="nationality" class="form-control charector" maxlength="100" placeholder="Nationality" value="<?php if(!empty($old_student_details)){ echo $old_student_details->nationality;}?>">
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									<div class="form-group">
										<label>Address</label>
										<input type="text" class="form-control rules" name="address" id="address" placeholder="Address" value="<?php if(!empty($old_student_details)){ echo $old_student_details->address;}?>">
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<select id="course_mode" name="course_mode" class="form-control js-example-basic-single select2_single" value="<?php if(!empty($old_student_details)){ echo $old_student_details->course_mode;}?>">
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
									...
									<label style="display:none;" id="year_sem-error" class="error" for="year_sem">Please select duration</label>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="form-group">
...
$("#email").keyup(function () {
    if ($("#email").val() !== '') {
        $.ajax({
            type: "POST",
            url: "<?=base_url();?>web/Web_controller/get_unique_email",
            data: {
                'email': $("#email").val(),
                'id': '<?= $id ?>'
            },
			...
			if(opts){
				...
				$.ajax({
					...
					success: function(data){
						...
						$.each(streadata, function(i, d) { console.log(opts.stream +'-'+ d.id);
