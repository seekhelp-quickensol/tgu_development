						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3">
								...
								<div class="form-group">
									...
									<input type="text" id="year_sem" name="year_sem" readonly class="form-control" value="<?php if(!empty($student)){ echo $student->exam_sem;}?>"> 
								</div>
							...
							<input type="hidden" id="number_of_paper" name="number_of_paper" value="0">
							...
							<div class="col-lg-12 col-md-12"> 
								<div class="form-group"> 
									...
									<table > 
										...
										<?php if(!empty($subjects)){ foreach($subjects as $subject_result){?> 
										<tr> 
...
$(".subject").change(function(){
	var checkedCount = $(".subject:checked").length; 
    $("#number_of_paper").val(checkedCount);  
	$("#total_examination_fees").val(checkedCount*300);
		...
		$('#re_appear_form').validate({ 
			...
			messages: { 
				enrollment_number: { 
					...
					number:"Please enter valid entrollment number",
				}, 
				year_sem: { 
