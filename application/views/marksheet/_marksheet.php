...
<div style="/* float:right; *//* margin-top: -106px; *//* position: absolute; */position: relative;magin-right: -52px;right: 0;top: 0;">
			...
			<img style="width: 80px;" src="<?=base_url("images/signature_contrroler/SIGNATURE_OF_CONTROLLER_OF_EXAMINATIONS.png");?>">

			<?php }else if($marksheet->examination_month == "January"  && $marksheet->examination_year =="2021"){?>

			<img style="width: 80px;" src="<?=base_url("images/signature_contrroler/sahakhan.png");?>"> 
                        ...
                        <div class="row"><!--row start-->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="right-bar-code">
                                    ...
                                    <p>Serial No:<?=$marksheet->marksheet_number?></p>
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 students-details">
                            ...
                            <div class="row"><!--row start-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6  col-xs-12 students-info" style="padding:0 0 0 130px">
                                    ...
                                    <p><strong>Seat No.</strong>: 112233</p>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                         ...
                                         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div style="float: right;">
                                                ...
                                                <img style="width: 80px;margin-right: -124px;margin-bottom: 88px;" src="<?=base_url("images/signature_contrroler/sahakhan.png");?>"> 
