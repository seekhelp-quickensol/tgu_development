    ...
    <div class="transcript_container">
        ...
        <?php 
							...
							for($l=1;$l<=$transcript->sem;$l++){
								...
								$subject = $this->Separate_students_model->get_this_transcript_subject($l,$transcript->id);
                ...
                <td class="w-50">
                  ...
                  <table class="mb-10 table_heading">
                      ...
                      <th class="border p-6 w-50">SUBJECTS</th>

                      <th class="border p-6 w-50">TYPE</th>

                      <th class="border p-6 w-50">MARKS
        ...
        <?php 
			...
			$total = $this->Separate_students_model->get_this_transcript_total($transcript->id); 
                ...
                <table class="top_table">
                    ...
                    <tr>
                      ...
                      <td class="w-50 text-center">
                          ...
                          <?php if($transcript->issue_date < "2022-02-19"){?>

                          <img style="width: 140px" src="<?=$this->Digitalocean_model->get_photo('images/transtsin.png')?><?=base_url();?>" alt="">

                          <?php }else{?>

                          <img style="width: 140px" src="<?=$this->Digitalocean_model->get_photo('images/seprate_reg.PNG')?>" alt="">

                          <?php }?>

                          <br><span>Registrar <br> GLOBAL UNIVERSITY</span></td>
