			...
			<div class="page">
				<div class="subpage"  style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/250-350.png')?>)">
					...
					<!-----------------Final statement start----------------------->
							...
							<table class="students-exam-details" style="margin-bottom:44px;width: 97%;">
								<body>
									<div class="clearfix"></div>
									<tr class="student-marks-total">
										<td>SEM/YEAR</td>
										<?php for($y=1;$y<=$marksheet->year_sem;$y++){?>
										<td><?=$y?></td>
										<?php }?> 
										<td>Grand Total</td>
										<td>Result</td>
									...
									<tr class="student-marks-total">
										...
										<?php 
											...
											for($y=1;$y<=$marksheet->year_sem;$y++){
				 ...
				 <img style="width: 98px;display: block;margin: 0px auto;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>">
			...
			<div class="page" >
				<div class="subpage"  style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/250-350.png')?>)">
					...
					<div class="print-wrapper">
						...
						<div class="students-info student-info-right" style="height:30px;">
						  <p>Mother Name : <?=$marksheet->mother_name?></p>
						  <p>Enrollment .No. : <?=$marksheet->enrollment_number?></p>
						</div>
						<div style="clearboth"></div>
		...
		/*$("#print_btn").click(function () {
			...
			var divToPrint=document.getElementById('letter_section');
			  ...
			  newWin.document.open();
				...
				newWin.document.write('<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>');
				newWin.document.write('<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">');
				newWin.document.write('<link href="https://fonts.googleapis.com/css?family=Roboto:400,700" rel="stylesheet">');
				newWin.document.write('<link href="https://fonts.googleapis.com/css?family=Abel|Barlow+Semi+Condensed:400,500,700,800,900&display=swap" rel="stylesheet">');
				newWin.document.write('<style type="text/css">.page,.subpage{position:relative}.statement::after,.statement::before{left:30px;content:" ";width:94%;height:2px}*{box-sizing:border-box;-moz-box-sizing:border-box}.page{width:210mm;min-height:250mm;padding:0;margin:0 auto;border-radius:5px;background:#fff}.subpage{min-height:350mm;background-size:cover;background-position:center;border-left:6px solid #fff;border-right:7px solid #fff}.print{background:#ed1765;color:#fff;width:100px;font-weight:500;border:none;outline:navajowhite;padding:10px;cursor:pointer;position:absolute;right:10px;top:10px;font-size:14px}.print-title,.right-bar-code p{text-align:center;font-weight:600}.print-title{color:#262626;font-size:32px}.right-bar-code p{color:#000;font-size:14px;padding:0 0 0 90px;margin-bottom:0;margin-top:0}.markshit-header h2,.markshit-header h3{text-transform:uppercase;margin-bottom:15px;text-align:center}.scan-img{float:left}.right-bar-code{float:right}.markshit-header{text-align:center;padding-top:90px;padding-right:15px}.markshit-header h2{font-size:28px;font-weight:700;color:#b73710;position:relative;margin-top:15px}.statement::before{position:absolute;top:0;background:#a60000;background-image:-webkit-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-moz-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-ms-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-o-linear-gradient(left,#d53a9d,#743ad5,#d53a9d)}.statement::after{position:absolute;top:100%;background:#a60000;background-image:-webkit-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-moz-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-ms-linear-gradient(left,#d53a9d,#743ad5,#d53a9d);background-image:-o-linear-gradient(left,#d53a9d,#743ad5,#d53a9d)}.markshit-header h3{color:#05549e;font-size:24px;font-weight:600;margin-top:10px;padding-left:28px;padding-right:28px}.students-info.student-info-left,.students-info.student-info-right{float:left;width:50%;padding-left:30px;margin-bottom:10px}.students-info p{font-size:13px;font-weight:500;color:#000;line-height:1}.students-exam-details th{color:#d53a9d;}.students-exam-details .heading_table{height:47px}table{border-collapse:collapse}.students-exam-details th,td{font-size:10px;font-weight:500;border-collapse:collapse!important;border:1px solid #8a6eaf;padding:3px}tbody tr{border-image-source:linear-gradient(to left,#743ad5,#d53a9d)!important;border-collapse:collapse!important}.marks-center,.student-marks-total{text-align:center}.remark-info,.result-date span{font-size:12px;color:#000;font-weight:500}.result-date{font-size:15px;color:#000000ba}.result-date span{display:inline-block}.result-date p{display:inline;padding:0 5px}.first-row{display:block;height:80px;padding:35px 15px 0}.left-remark{float:left;width:32.5%;position:relative;top:80px}.barcode-middle{float:left;width:32.5%}.bottom-sign-section{position:absolute;bottom:95px;width:100%;padding:0 15px}.barcode-img{max-width:85%;height:33px;position:relative;top:77px}.right-controller{float:left;width:32.5%;position:relative;top:46px}.students-exam-details{width:100%;margin:0 auto}.bottom_strip{position:absolute;bottom:0}.bottom_strip img{width:100%}.scan-img img{width:75%}.total_marks{width:92%;margin:15px auto}.credit_note{position:absolute;padding:0 15px; margin:2px 0px;}.rotate{writing-mode:vertical-rl;transform:rotate(270deg);white-space:nowrap;vertical-align:middle;text-orientation:mixed;-ms-transform:rotate(-180deg);-moz-transform:rotate(-180deg);-webkit-transform:rotate(-180deg);-o-transform:rotate(-180deg)}.print{display:none}.col-lg-6{width:50%;float:left}.row{display:table;width:97%;clear:both;margin:0 auto}</style></head><body>');
