    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">ID Card</h2>
                    <ul class="nav osahan-tabs nav-tabs flex-column flex-sm-row ">
                        <li class="nav-item"></li> 
                    </ul>
                    <div class="clearfix"></div>
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1  margin_box">
							...
							<div class="table-responsive box-table mt-3" id="printable_div">
								<div class="card-wrapper" >
									  ...
									  <button id="btn" class="btn btn-primary print_btn" style="position:absolute; top:-10px; right:18px;" onclick="window.print()">Click Here To Print</button>
										...
										<div class="row">
										  <div class="col-2"> -->
											<!-- <img class="header-logo" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->logo)?>"> -->
                      <!-- <div class="logo_background"> -->
											<!-- <img class="header-logo" src="<?=base_url();?>assets/images/global_university_logo.png"/> -->
											<!-- <img class="header-logo" src="<?=$this->Digitalocean_model->get_photo('images/logo/global_university_logo.png')?>"> -->

                      <!-- </div>

										  </div>
										  <div class="col-10">
											<h3 class="header-brand">The Global University</h3>
											<p class="header-text m-0 p-0"><?php if(!empty($university_details)){ echo $university_details->address;}?></p>
											<p class="header-text m-0 p-0">www.tgu.ac.in</p>
										  </div>
										</div>
									  </div>
									  <div class="card-body">
										<div class="row">
										  <div class="col-4" style="height: 220px;">
											<img class="id-image" src="<?=$this->Digitalocean_model->get_photo('images/profile_pic/'.$student->photo)?>">
										  </div>
										  <div class="col-8">
											<img class="body-image" src="<?=$this->Digitalocean_model->get_photo('images/logo/global_university_logo.png')?>">
											<div class="body-text-wrapper">
											  <h2 class="card-holder-name pt-2"><?=$student->student_name?></h2>
											  <p class="p-0 m-0 body-text">Session: <?=$admission->session_name;?></p>
											  <p class="p-0 m-0 body-text">Course: <?=$admission->print_name;?></p>
											  <p class="p-0 m-0 body-text">Stream: <?=$admission->stream_name;?></p>
											  <p class="p-0 m-0 body-text">Enrollment No: <?=$student->enrollment_number?>&nbsp;</p>
											   <p class="p-0 m-0 body-text">D.O.B: <?= date('d-m-Y', strtotime($student->date_of_birth)) ?></p>
											  <p class="p-0 m-0 body-text">Father's/Husband Name: <?=$student->father_name?></p>
											  <p class="p-0 m-0 body-text">Address: <?=$student->address?></p>
											  <p class="p-0 m-0 body-text">Contact No: <?=$student->mobile?></p>
											</div>
										  </div>
										</div>
										<div>
									  ...
									  <div class="card-body">
										<div class="row">
										  ...
										  <div class="body-back-image">
											<img class="back-image" src="<?=$this->Digitalocean_model->get_photo('images/logo/global_university_logo.png')?>" >
										  </div>
										  <ol>
											<li>The holder of the Identity card is identify as the student of The Global University, Itanagar.</li>
											<li>In case of loss, student should report immediately and will pay Rs.100/- for issuing a new card. </li>
											<li>This identity card is only for the bonafied student of The Global University</li>
							...
							<div class="row">
								...
								<div class="col-8">
									...
									<div class="body-text-wrapper" style="position:relative !important">
										...
										<p class="p-0 m-0 body-text">Enrollment No: <?= $student->enrollment_number ?>&nbsp;</p>
										<p class="p-0 m-0 body-text">D.O.B: <?=date("d/m/Y",strtotime($student->date_of_birth))?></p>
										<p class="p-0 m-0 body-text">F/H Name: <?= $student->father_name ?></p>
										<p class="p-0 m-0 body-text">Address: <?= $student->address ?></p>
										<p class="p-0 m-0 body-text">Contact No: <?= $student->mobile ?></p>
									</div>
								</div>
					...
					<div class="card-wrapper">
						...
						<div class="card-body">
							<div class="row">
								...
								<ol>
									<li>The holder of the Identity card is identify as the student of THE GLOBAL UNIVERSITY.</li>
									<li>In case of loss, student should report immediately and will pay Rs.100/- for issuing a new card. </li>
									<li>This identity card is only for the Bona-fide student of THE GLOBAL UNIVERSITY.</li>
									<li>Unauthorized use is denied and punishable by law.</li>
								</ol>
							</div>
							<!-- <div class="back-footer">
