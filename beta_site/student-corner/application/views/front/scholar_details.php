...
if(!empty($single_student)){
    $guide = $this->Front_model->get_assigned_guide($single_student->guide_id);
    // echo "<pre>";print_r($guide);exit;
    $co_guide = $this->Front_model->get_assigned_guide($single_student->co_guide_id);
?>
						...
						<div class="card">
							<div class="card-body">
                                <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" class="form-control" id="student_id" name="student_id" value="<?php echo $this->session->userdata('student_id'); ?>">
                                    <div class="row">
                                        <div class="col-md-3">
...
$(document).ready(function () {	
    // $("#course_work_start_date").datepicker({
