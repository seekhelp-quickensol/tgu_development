...
// $consolidate_fee = 3500; 
//$transcript_fee = 1; 
$session = array( 
	// 'session_amount' 	=> $consolidate_fee, 
	// 'session_amount' 	=> $certificate_fee,
	'consolidate_id' 	=> $consolidate->id, 
); 
$this->session->set_userdata($session); 

$certificate_amount = $this->Front_model->get_certificate_fees('12');
?> 
<script> 
											...
											<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
												<div class="row"> 
												    ...
												    <div class="step_Box">
														...
														<p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of 
														<!-- <b>Rs. <?=$consolidate_fee?></b> -->
														<b>Rs. <?php if(!empty($certificate_amount)){ echo $certificate_amount->certificate_fees; }?></b>

														to get your Consolidate Marskheet, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
												...
												<tr> 
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$consolidate->id?>"/></td> 
												</tr> 
												<tr> 
													<!-- <td>Amount	:</td><td><input type="text" name="amount" value="<?=$consolidate_fee?>.00"/></td>  -->
												...
												<tr> 
													<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$student_details->student_name?>"/></td> 
												</tr> 
												<tr> 
													<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$student_details->address?>"/></td> 
												</tr> 
												<tr> 
													<td>Billing City	:</td><td><input type="text" name="billing_city" value="<?=$student_details->city_name?>"/></td> 
												</tr> 
												<tr> 
													<td>Billing State	:</td><td><input type="text" name="billing_state" value="<?=$student_details->state_name?>"/></td> 
												</tr>

												<tr>

													<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$student_details->pincode?>"/></td>
												...
												<tr>
													...
													<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$student_details->mobile?>"/></td>

												</tr>

												<tr>

													<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$student_details->email?>"/></td>
												...
												<tr>
													...
													<td>Shipping Name	:</td><td><input type="text" name="delivery_name" value="<?=$student_details->student_name?>"/></td>

												</tr>

												<tr>

													<td>Shipping Address	:</td><td><input type="text" name="delivery_address" value="<?=$student_details->address?>"/></td>

												</tr>

												<tr>

													<td>shipping City	:</td><td><input type="text" name="delivery_city" value="<?=$student_details->city_name?>"/></td>

												</tr>

												<tr>

													<td>shipping State	:</td><td><input type="text" name="delivery_state" value="<?=$student_details->state_name?>"/></td>

												</tr>

												<tr>

													<td>shipping Zip	:</td><td><input type="text" name="delivery_zip" value="<?=$student_details->pincode?>"/></td>
												...
												<tr>
													...
													<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="<?=$student_details->mobile?>"/></td>
												...
												<tr>
													...
													<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_consolidated_marksheet"/></td>
