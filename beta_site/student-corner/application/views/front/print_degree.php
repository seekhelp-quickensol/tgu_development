...
<body>
    <div class="page"
        style="background-image:url(<?=base_url();?>images/img/bg-img.jpg);background-position: center;background-size: cover;">
        <div id="letter_section" style="padding:22px;">
            <div
                                ...
                                <div class="letter_area">
                                    <div class="head_row"
                                        ...
                                        <div style="padding-left: 20px; padding-top: 15px;">
                                            <?php 							$smart = $degree->id."-".$degree->student_id."-".$degree->enrollment_number."-".$degree->student_name."-".$degree->father_name."-".$degree->created_on;							$course_year = $this->Front_model->get_year_duration($degree->course_id,$degree->stream_id);							 						?>
                                            <img style="height: 55px; width: 55px;"
                                                src="https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=<?=$smart?>&choe=UTF-8"
                                                alt=""> </div>
                                        <div> <img style="height: 20px; padding-left: 60px;"
                                                src="<?=base_url();?>images/img/Picture2.png" alt=""> </div>
                                        <div style="padding-right: 20px;">
                                            <p>Serial No.: <?=$degree->sr_no?></p>
                                        </div>
                                    </div>
                                    <div class="padd_wrapper">
                                        <div class="head_top_logo"><img src="<?=base_url();?>images/img/Picture.png">
                                        </div>
                                        <h1
                                            style="font-family: sans-serif-400; color: #000; text-align: center; font-size: 30px; margin-bottom: 0px; text-transform:uppercase; padding-top:60px;">
                                            <?=$degree->print_name; ?></h1>
                                        <h3
                                        ...
                                        <p
                                            ...
                                            in this University in the examination of <span
                                                style="font-family: Windsor W01 Antique Bold; color: #000; padding-left: 10px;padding-right: 10px;"><?=date("Y",strtotime($division["date"]));?></span>
                                            in <br> and that he/she was placed in the <br> <span
                                                style="font-family: Windsor W01 Antique Bold; color: #000; padding-left: 10px;padding-right: 10px;"><?=$division["division"]?></span>
                                            Divison. </p>
                                        <p
                                            style="font-family: Ascender Serif W02 Italic; color: #000; text-align: center; font-size: 20px; padding-top: 30px;padding-bottom: 5px;">
                                            Given under the seal of the University</p>
                                        <div
                                            style="display:flex; justify-content: space-between; align-items: center; padding-top: 30px;gap: 85px;">
                                            <div style="text-align: center;"> <img style="width: 115px;"
                                                    src="<?=base_url();?>images/img/registrar-sign.png" alt="">
                                                <p
                                                    style="font-family: sans-serif; color: #000; text-align: center;font-size: 14px;">
                                                    Registrar <br> The Global University</p>
                                            </div>
                                            <div style="text-align: center;"> <img style="width: 115px;"
                                                    src="<?=base_url();?>images/img/stamp.png" alt="">
                                                <p
                                                    style="font-family: sans-serif; color: #000; text-align: center;font-size: 14px;">
                                                    Manipur, Dated the
                                                    <?=date('jS F Y',strtotime($degree->issue_date)); ?></p>
                                            </div>
                                            <div style="text-align: center;"> <img style="width: 90px;"
                                                    src="<?=base_url();?>images/img/vc-sign.png" alt="">
                                                <p
                                                    style="font-family: sans-serif; color: #000; text-align: center;font-size: 14px;">
                                                    Vice Chancellor<br> The Global University</p>
                                            </div>
                                        </div>
                                        <div style="position: absolute; bottom: 30px;">
                                            <p>Enrol. No. <?=$degree->enrollment_number;?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
