		...
		?>
            ...
            <div class="first-row">
                        ...
                        <div class="right-bar-code">
                            <p><?php ?>Serial No:<?=$marksheet->sr_number?><?php ?></p>
                        </div>
                    </div>
                    <div style="clear:both"></div>
                    <div class="markshit-header ">
                        <h2 style="font-size:14px;color: #335c9e;margin-bottom: 6px; margin-top: 66px;">Imphal Manipur, INDIA</h2>
                   ...
                   <tr class="heading_table">
					...
					<tbody>
                    <?php 
					$subject = $this->Front_model->get_selected_subject_for_result($marksheet->result_id); 
			...
			<?php }else if($marksheet->examination_month == "January"  && $marksheet->examination_year =="2022"){?>
				<img style="width: 80px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>"> 
			<?php }else if($marksheet->examination_month == "August"  && $marksheet->examination_year =="2023"){?>
				<img style="width: 80px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>"> 
			<?php }else if($marksheet->examination_month == "April"  && $marksheet->examination_year =="2023"){?>
				<img style="width: 80px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>"> 
			<?php }?> 
	...
	?>
	 <div class="print-wrapper">
		...
		<div class="first-row">
			...
			<div class="right-bar-code">
				<p> Serial No:<?=$marksheet->sr_number?></p>
			</div>
		</div>
		<div style="clear:both"></div>
		<div class="markshit-header ">
		...
		<div class="students-info student-info-right">
			...
			<p>  <?php if($marksheet->display_mode == "1"){?>Year/Sem<?php }else{?>Year/Sem<?php }?></strong>: <?=$roman_arr[$marksheet->year_sem]?></p>
