...
$order_id = $order_id[1];
	...
	$this->db->where('id',$order_id); 
	$real_fees =$this->db->get('tbl_credit_transfer_certificate'); 
...
$this->db->select('tbl_credit_transfer_certificate.*,tbl_student.student_name, tbl_student.mobile,tbl_student.address, tbl_student.pincode, countries.name as country_name, states.name as state_name, cities.name as city_name');
$this->db->where('tbl_credit_transfer_certificate.id',$order_id);
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
						...
						<td class="tm_width_4">Credit Transfer Fees</td>
