...
for($i = 0; $i < $dataSize; $i++) 
	...
	$this->db->select('tbl_student_provisional_degree.*, tbl_student.student_name, tbl_student.mobile, tbl_student.address, tbl_student.pincode, countries.name as country_name, states.name as state_name, cities.name as city_name');
...
<body>
	<div class="container">
		...
		<a href="<?=base_url()?>student-provisional-degree" style="text-decoration: none;margin-top:10px;background:#000;color:#fff;padding:10px 21px;border-radius:3px;border:none;cursor:pointer;font-size: 13px;">Back</a>
		<?php }?>
	</div>
<script>
	function myFunction() {
