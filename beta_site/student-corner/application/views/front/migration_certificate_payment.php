...
$amount = $this->Front_model->get_certificate_fees('0');
?>
<script>
									...
									<?php /*<form enctype="application/json" action="https://checkout.freecharge.in/api/v1/co/pay/init" id="searchForm" method="post">
										...
										<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler">
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="<?=$student->mobile?>"/></td>
												</tr>
												<tr>
													<td>Merchant Param1	:</td><td><input type="text" name="merchant_param1" value="The Global University"/></td>
												</tr>
												<tr>
													<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_student_migration"/></td>
												</tr>
												<tr>
