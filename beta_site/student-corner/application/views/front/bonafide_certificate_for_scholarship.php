<?php include('header.php');
	if(!empty($bonafide) && $bonafide->payment_status != '1'){
		redirect('pay_bonafide_scholarship_fees');
	}		
?>
<style>
@page {
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Bonafide Certificate for Scholarship</h2>
							...
							<div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
								<?php if(empty($bonafide)){ ?> 
										<div class="box_layer_t"> 
											...
											<p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete Bonafide Certificate payment/fees to get your Certificate.</p>
										<a style="text-align:center" href="<?=base_url("pay_bonafide_scholarship_fees");?>" class="btn btn-success">Pay Bonafide Certificate fees</a> 
									</div>
								<?php }else{ ?>  
								<?php if($bonafide->approve_status == '0'){ ?> 
									<div class="box_layer_t">
										<div class="btn_center"> 
											<div class="step_Box">
												<ul>
										...
										<p class="mid_bix">Dear <b><?=$student->student_name?></b>, Please be patient your Bonafide Certificate is under process, once it will approved your Bonafide Certificate will be availble here.</p>
									</div> 
								<?php }else if($bonafide->approve_status == "1"){ ?>  
									<div class="box_layer_t">
										<div class="btn_center"> 
											<div class="step_Box">
												<ul>
										...
										<p class="mid_bix">Congratulations! your Bonafide Certificate has been approved, please <a href="<?=base_url();?>print_bonafide_scholarship/<?=base64_encode($bonafide->id);?>" target="_blank">Click here</a> to print your Bonafide Certificate.</p>
									</div> 
								<?php } ?> 
								<?php } ?>	  
							</div>
