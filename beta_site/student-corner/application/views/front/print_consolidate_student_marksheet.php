...
<body>
<?php  
$course_details = $this->Front_model->get_selected_marksheet_course_stream_details($marksheet->course_id,$marksheet->stream_id,$marksheet->course_type,$marksheet->course_mode);
//if($marksheet->course_mode == '2'){
	
$subject = $this->Front_model->get_selected_subject_for_result_consolidate($marksheet_id->id);
				...
				<div class="subpage"  style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/250-350.png')?>)">
					...
					<div class="print-wrapper">
						<?php  
							...
							$last_exam = $this->Front_model->get_last_exam_year($marksheet->id);
							?>
						<div class="first-row">
							<div class="scan-img">
						...
						<div class="markshit-header ">
							<h2 style="font-size:14px;color: #335c9e;margin-bottom: 6px; margin-top: 66px; visibility:hidden;"></h2>
						...
						<div class="row">
								...
								<?php 
									...
									$subject = $this->Front_model->get_selected_semester_subject_for_result_consoliddate($marksheet_id->id,$i);
					...
					<!-----------------Final statement start----------------------->
							...
							<table class="students-exam-details" style="margin-top: 44px;width: 97%;">
								<body>
									...
									<tr class="student-marks-total">
										...
										<?php 
											...
											for($y=1;$y<=$marksheet->year_sem;$y++){
												$mark = $this->Front_model->get_total_marks_cons($y,$marksheet_id->id);	
												$total_mark += $mark;
										?>
										<td><?=$mark?></td>
										<?php }?> 	
									...
									<tr class="student-marks-total">
										<td>Mark Obtained</td>
										<?php for($y=1;$y<=$marksheet->year_sem;$y++){
											$mark_obtaind = $this->Front_model->get_total_obt_marks_cons($y,$marksheet_id->id);
							...
							<?php $exam_month_year = $this->Front_model->get_student_last_exam_month_year($marksheet->id)?>
