...
if(empty($student_fees)){ 
	redirect('student_no_split'); 
}  
$session = array( 
	'session_amount' => $student_fees->amount, 
	'recommendation_order_id' 	=> $student->id, 
); 
$this->session->set_userdata($session); 

$certificate_amount = $this->Front_model->get_certificate_fees('7');
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">No Split Issue</h2>
											...
											<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
													...
													<div class="box_layer_t"> 
														<div class="btn_center"> 
														    ...
														    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($certificate_amount)){ echo $certificate_amount->certificate_fees; }?></b> to get your No Split Issue Letter ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
															<button type="submit" class="btn btn-success" value="CheckOut">Click to Pay</button> 
														</div> 
													</div> 
												
												<table style="display:none;" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table> 
												<table  height="100" border='1' align="center" style="display:none;"> 
													<tr> 
													...
													<tr> 
														<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student_fees->id?>"/></td> 
													</tr> 
													<tr> 
														<!-- <td>Amount	:</td><td><input type="text" name="amount" value="<?=$student_fees->amount?>.00"/></td>  -->
														<td>Amount	:</td><td><input type="text" name="amount" value="<?=$certificate_amount->certificate_fees?>.00"/></td> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_no_split_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_no_split_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
													...
													<tr> 
														<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$student_fees->student_name?>"/></td> 
													</tr> 
													<tr> 
														<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$student_fees->address?>"/></td> 
													</tr> 
													<tr> 
														<td>Billing City	:</td><td><input type="text" name="billing_city" value="<?=$student_fees->city_name?>"/></td> 
													</tr>   
													<tr> 
														<td>Billing State	:</td><td><input type="text" name="billing_state" value="<?=$student_fees->state_name?>"/></td> 
													</tr> 
													<tr> 
														<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$student_fees->pincode?>"/></td> 
													</tr> 
													<tr> 
														<td>Billing Country	:</td><td><input type="text" name="billing_country" value="India"/></td> 
													</tr> 
													<tr> 
														<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$student_fees->mobile?>"/></td> 
													</tr> 
													<tr> 
														<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$student_fees->email?>"/></td> 
													</tr> 
													<tr> 
														<td colspan="2">Shipping information(optional)</td> 
													</tr> 
													<tr> 
														<td>Shipping Name	:</td><td><input type="text" name="delivery_name" value="<?=$student_fees->student_name?>"/></td> 
													</tr> 
													<tr> 
														<td>Shipping Address	:</td><td><input type="text" name="delivery_address" value="<?=$student_fees->address?>"/></td> 
													</tr> 
													<tr> 
														<td>shipping City	:</td><td><input type="text" name="delivery_city" value="<?=$student_fees->city_name?>"/></td> 
													</tr> 
													<tr> 
														<td>shipping State	:</td><td><input type="text" name="delivery_state" value="<?=$student_fees->state_name?>"/></td> 
													</tr> 
													<tr>   
														<td>shipping Zip	:</td><td><input type="text" name="delivery_zip" value="<?=$student_fees->pincode?>"/></td> 
													</tr> 
													<tr> 
														<td>shipping Country	:</td><td><input type="text" name="delivery_country" value="India"/></td> 
													</tr> 
													<tr> 
														<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="<?=$student_fees->mobile?>"/></td> 
													</tr> 
													<tr> 
														<td>Merchant Param1	:</td><td><input type="text" name="merchant_param1" value="The Global University"/></td> 
													</tr> 
													<tr>  
														<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_no_split_application"/></td> 
													</tr> 
													<tr> 
