...
$session = array( 
	'session_amount' => $transfer->amount, 
	'transfer_order_id' 	=> $transfer->id, 
); 
$this->session->set_userdata($session); 

$amount = $this->Front_model->get_certificate_fees('1');
?> 
<script>
                        ...
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											...
											<div class="btn_center"> 
											  ...
											  <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees;}?></b> to get your Transfer Certificate, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
												...
												<table width="40%" height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$transfer->id?>"/></td> 
													</tr> 
													<tr> 
														<!-- <td>Amount	:</td><td><input type="text" name="amount" value="<?=$transfer->amount?>.00"/></td>  -->
													...
													<tr> 
														<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_student_transfer"/></td>
													</tr> 
													<tr> 
