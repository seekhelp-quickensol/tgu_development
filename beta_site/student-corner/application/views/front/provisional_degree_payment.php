...
$amount = $this->Front_model->get_certificate_fees('3');
?> 
<script> 
                        ...
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											...
											<div class="btn_center"> 
											  ...
											  <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees; }?></b> to get your Provisional Degree ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_student_provisional_degree"/></td>
												</tr>
												<tr>
