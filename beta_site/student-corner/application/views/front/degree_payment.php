...
$session = array(
	...
	'provisional_order_id' 	=> $student_fees->id,
);
$this->session->set_userdata($session);


$amount = $this->Front_model->get_certificate_fees('2');
?> 
<script> 
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Degree Certificate</h2>
                    ...
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1">
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											...
											<!-- <form method="post" name="customerData" action="<?=base_url();?>student_degree_ccavRequestHandler"> -->
											...
											<div class="btn_center"> 
											  ...
											  <!-- <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if($student->center_id == "9"){?>10000<?php }else{?>3500<?php }?></b> to get your Degree ,If you click on payment button, you will be redirect to payment gateway page immediately</p>  -->
											  <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees; } ?></b> to get your Degree ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_student_degree"/></td>
												</tr>
												<tr>
