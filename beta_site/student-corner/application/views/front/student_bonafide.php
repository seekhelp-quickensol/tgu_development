                        ...
                        <div class="tab-pane active" id="active">
							<div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
								<?php if(empty($bonafide)){ ?> 
										...
										<a style="text-align:center" href="<?=base_url("pay_bonafide_fees");?>" class="btn btn-success">Pay Bonafide Certificate fees</a> 
									</div>
								<?php }else{ ?>  
								...
								<?php }else if($bonafide->approve_status == "1"){ ?>  
									<div class="box_layer_t">
										...
										<p class="mid_bix">Congratulations! your Bonafide Certificate has been approved, please <a href="<?=base_url();?>print_bonafide/<?=base64_encode($bonafide->id);?>" target="_blank">Click here</a> to print your Bonafide Certificate.</p>
									</div> 
								<?php } ?> 
								<?php } ?>	  
							</div>
