...
$certificate_amount = $this->Front_model->get_certificate_fees('5');
?> 
<script> 
                    ...
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1">
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											<!-- <form method="post" name="customerData" action="<?=base_url();?>student_medium_inst_ccavRequestHandler">  -->
											<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
													...
													<div class="box_layer_t"> 
														<div class="btn_center"> 
														    ...
														    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($certificate_amount)){ echo $certificate_amount->certificate_fees; }?></b> to get your Medium of Instruction Letter ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr>  
														<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_medium_instruction_application"/></td> 
													</tr> 
													<tr> 
