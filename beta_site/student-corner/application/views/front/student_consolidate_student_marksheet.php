							...
							<div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
								...
								<div class="box_layer_t">
								    <div class="btn_center"> 
											...
											<p class="mid_bix">Dear <b><?=$student->student_name?></b>, Please apply for your consolidated marksheet and pay Rs. <?php if(!empty($certificate_amount)){ echo $certificate_amount->certificate_fees;}?> to complete process. <a href="<?=base_url();?>apply_consolidate_student">Click to apply</a></p>
								</div>
								<?php }?>					  
							</div> 
						</div>
