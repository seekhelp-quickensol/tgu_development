...
$certificate_amount = $this->Front_model->get_certificate_fees('9');
?> 
<script> 
							...
							<div class=" box-table mt-3">
											<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr>  
														<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_reccom_letter_application_second"/></td> 
													</tr> 
													<tr> 
