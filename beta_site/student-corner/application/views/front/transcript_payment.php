...
$transcript_fee = 3500; //
//$transcript_fee = 1; $session = array( 	'session_amount' 	=> $transcript_fee, 	'transcript_id' 	=> $transcript->id, ); $this->session->set_userdata($session);
$amount = $this->Front_model->get_certificate_fees('11'); 
                        ...
                        <div class="tab-pane active" id="active">
                            <div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
                                <div class="col-lg-12" style="display:block;">
                                    <!--<form enctype="application/json" action="https://checkout.freecharge.in/api/v1/co/pay/init" id="searchForm" method="post"> 												<fieldset> 													<div><input type="hidden" id="merchantId" value="<?= $req['merchantId']?>" name="merchantId"></div> 													<div><input type="hidden" id="merchantTxnId" value="<?= $req['merchantTxnId']?>" name="merchantTxnId" ></div> 													<div><input type="hidden" id="amount" value="<?= $req['amount']?>" name="amount"></div> 													<div><input type="hidden" id="currency" name="currency" value="<?= $req['currency']?>"></div> 													<div><input type="hidden" id="furl" name="furl" value="<?= $req['furl']?>"></div> 													<div><input type="hidden" id="surl" name="surl" value="<?= $req['surl']?>"></div> 													<div><input type="hidden" id="checksum" name="checksum" value="<?=$checksum?>"></div> 													<div><input type="hidden" id="email" name="email" value="<?= $req['email']?>"></div> 													<div><input type="hidden" id="mobile" name="mobile"  value="<?= $req['mobile']?>"></div> 													<div><input type="hidden" id="customerName" value="<?= $req['customerName']?>" name="customerName"></div> 													<div><input type="hidden" id="customNote" name="customNote" value="<?= $req['customNote']?>"></div> 													<div><input type="hidden" id="channel" name="channel" value="<?= $req['channel']?>" ></div> 												</fieldset> 												<div class="col-lg-12"> 													<div class="btn_center" style="width: 175px;margin: 25px auto 0px;"> 														<button id="checkout" class="btn signin btn-primary">Pay Via Freecharge</button>  													</div> 												</div> 												<p id="msg"></p> 											</form>-->
                                    <form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler">
                                    <!-- student_transcript_ccavRequestHandler -->
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="box_layer_t">
                                                    <div class="btn_center">
                                                        <div class="step_Box">
                                                            <ul>
                                                                <li>
                                                                    <div class="step_box">1</div>
                                                                    <div class="content_a">Apply</div>
                                                                </li>
                                                                <li class="step_active">
                                                                    <div class="step_box">2</div>
                                                                    <div class="content_a">Process Fee</div>
                                                                </li>
                                                                <li>
                                                                    <div class="step_box">3</div>
                                                                    <div class="content_a">Waiting For Approval</div>
                                                                </li>
                                                                <li>
                                                                    <div class="step_box">4</div>
                                                                    <div class="content_a">Print Certificate</div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please
                                                        complete the payment of 
                                                        
                                                        <!-- <b>Rs. <?=$transcript_fee?></b> -->
                                                        <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees; }?></b>                                       
                                                        to get
                                                        your Transcript Certificate, If you click on payment button, you
                                                        will be redirect to payment gateway page immediately</p> 
                                                        
                                                        <button
                                                        type="submit" class="btn btn-success" value="CheckOut">Click to
                                                        Pay</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table width="40%" height="100" border='1' align="center" style="display:none;">
                                            ...
                                            <tr>
                                                <td>Merchant Id :</td>
                                                <td><input type="text" name="merchant_id" value="<?=CCMERCHANT?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Order Id :</td>
                                                <td><input type="text" name="order_id" value="<?=$student->id?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Amount :</td>
                                                <td>
                                                    <!-- <input type="text" name="amount" value="<?=$transcript_fee?>.00" /> -->
                                                    <input type="text" name="amount" value="<?=$amount->certificate_fees?>.00" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Currency :</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="redirect_url"
                                                        value="<?=base_url();?>ccavResponseHandler" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Cancel URL :</td>
                                            ...
                                            <tr>
                                                <td>Billing City :</td>
                                                <td><input type="text" name="billing_city" value="<?=$student->city_name?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Billing State :</td>
                                                <td><input type="text" name="billing_state" value="<?=$student->state_name?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Billing Zip :</td>
                                                <td><input type="text" name="billing_zip"
                                             value="<?=$student->pincode?>" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Shipping Name :</td>
                                                <td><input type="text" name="delivery_name" value="<?=$student->student_name?>" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>shipping City :</td>
                                                <td><input type="text" name="delivery_city" value="<?=$student->city_name?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>shipping State :</td>
                                                <td><input type="text" name="delivery_state" value="<?=$student->state_name?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>shipping Zip :</td>
                                                <td><input type="text" name="delivery_zip" value="<?=$student->pincode?>" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="integration_type" value="iframe_normal" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
