...
$amount = $this->Front_model->get_certificate_fees('4');
?> 
<script> 
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Bonafide Certificate</h2>
                    ...
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1">
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											<!-- <form method="post" name="customerData" action="<?=base_url();?>student_bonafide_ccavRequestHandler">  -->
											<form method="post" name="customerData" action="<?=base_url();?>ccavRequestHandler"> 
													...
													<div class="box_layer_t"> 
														<div class="btn_center"> 
														    ...
														    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees;}?></b> to get your Bonafide Certificate ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														...
														<td>Amount	:</td><td><input type="text" name="amount" value="<?=$amount->certificate_fees?>.00"/></td> 
													...
													<tr>  
														<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_bonafide_cer_application"/></td> 
													</tr> 
													<tr> 
