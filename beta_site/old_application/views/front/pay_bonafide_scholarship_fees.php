    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Scholarship Bonafide Certificate</h2>
											...
											<form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler"> 
													...
													<div class="box_layer_t"> 
														<div class="btn_center"> 
														    ...
														    <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. 100<?php //if(!empty($amount)){ echo $amount->certificate_fees;}?></b> to get your Scholarship Bonafide Certificate ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_bonafide_scholarship_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_bonafide_scholarship_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
