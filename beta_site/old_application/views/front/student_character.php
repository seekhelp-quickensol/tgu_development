								...
								<?php }else{ ?>  
									<?php if($character->approve_status == '0'){ ?> 
										<div class="box_layer_t">
												...
												<p class="mid_bix">Dear <b><?=$student->student_name?></b>, Please be patient your Character Certificate is under process, once it will approved your Character Certificate will be availble here.</p>
										    </div> 
