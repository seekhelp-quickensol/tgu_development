        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 form-align-center grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Abstract Report</h4>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" name="abstract_form" id="abstract_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="remark" name="remark" value="<?php if(!empty($single_abstract)){ echo $single_abstract->paper_journal1;}?>" class="form-control custom_select"  aria-describedby="" placeholder="Paper journal">
                    </div>
					<div class="form-group">
