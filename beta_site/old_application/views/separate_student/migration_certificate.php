    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
		...
		<?php if(empty($migration)): ?>
						...
						<!--<a href="<?=base_url("s_pay_migration_certificate_fees");?>" class="btn btn-success">Pay Migration Certificate fees</a>-->

					<?php }else{ ?>

						<div class="col-lg-6" style="display:block;">

						<form method="post" action="<?=base_url();?>s-upload_old_migration_certificate" enctype="multipart/form-data">

							<label>Upload Old Migration</label><br>

							<input  type="file" name="userfile"><br><br>

							<input  type="hidden" name="student_id" value="<?php if(!empty($migration)){ echo $migration->id ; }  ?>">
			...
			<div class="row" id="letter_section">
				...
				<div class="col-md-10">
					...
					<div style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet-bg-with-logo.jpeg')?>);background-position: center;background-size: cover;padding: 370px 25px;border: 2px solid #e8612b;">
						...
						<p style="margin-top: -100px;text-align: center"><b>University Campus: </b>Canchipur, South View, Imphal West, Arunachal Pradesh, Pincode - 795003</p>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div style="width: 205px;float: right;text-align: center;margin-top: 35px;">
									...
									<?php }else{?>
									 ...
									 <img style="width: 110px" src="<?=$this->Digitalocean_model->get_photo('images/seprate_reg.PNG')?>" alt="">
