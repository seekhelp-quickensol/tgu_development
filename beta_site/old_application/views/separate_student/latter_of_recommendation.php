                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
					...
					<?php if(empty($recommendation)): ?>
						...
						<a href="<?=base_url("s_pay_recommendation_letter_fees");?>" class="btn btn-success">Pay Recommendation letter fees</a>
...
BIR TIKENDRAJIT UNIVERSITY
						...
						<p style="font: bold;text-align: right;font-weight: 600">Date : <?=date("d-m-Y",strtotime($recommendation->created_on));?></p>
						...
						<div class="row" style="padding-right: 20px;padding-left: 20px">
							...
							<div class="col-lg-12 col-md-12">
								...
								<div style="float: left;text-align: center;margin-top: 35px;"> 
									...
									<?php if(date("Y-m-d",strtotime($recommendation->issue_date)) < "2022-02-19"){?>

									<img style="width: 130px;" src="<?=$this->Digitalocean_model->get_photo('images/Deputy_Registrar.png')?>">

									<?php }else{?>

									 <img style="width: 130px" src="<?=$this->Digitalocean_model->get_photo('images/seprate_reg.PNG')?>" alt="">

									<?php }?><br>

									<img style="width: 130px" src="<?=$this->Digitalocean_model->get_photo('images/reccomendation_letter_mark_image.png')?>" alt="">
