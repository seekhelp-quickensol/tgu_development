...
<div class="row">
						...
						?>
					<!--	<a href="<?=base_url("pay_s_transcrip_certificate_fees");?>" class="btn btn-success">Pay Transcript Fees</a>-->
						<?php }
					...
					<button  class="btn btn-primary">Waiting for approval .....</button>
						...
						?>
					<a href="<?=base_url();?>s_print_transcript" target="_blank" class="btn btn-success">Print Transcript</a>
						<?php }?>
						</div>
