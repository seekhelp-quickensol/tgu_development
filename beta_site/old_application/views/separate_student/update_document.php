            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
				  ...
				  <p class="error" style="margin-bottom: 20px;"><b>Please update your Aadhaar Card details.</b></p>
                  ...
                  <form class="forms-sample" name="password_form" id="password_form" method="post"  enctype="multipart/form-data">
					...
					<div class="col-sm-12 uid_input">
						<div class="form-group">
							...
							<input type="text" class="form-control identity_numer" name="identity_numer" id="identity_numer" placeholder="Enter Aadhaar Number" value="<?php if(!empty($student_profile)){ echo $student_profile->id_number;} ?>">
						</div>
					</div>
