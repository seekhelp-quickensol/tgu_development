	...
	display:none;
		...
		<section class="candidates-resume-area ptb-100">
			<div class="container">
				<div class="candidates-resume-content">
					<form method="post" name="customerData" action="<?=base_url();?>admission_ccavRequestHandler">
				<div class="row">
					<div class="col-lg-12">
						<div class="btn_center" style="width: 250px;margin: 25px auto 0px;">
							<button type="submit" class="default-btn" value="CheckOut">Click To Pay</button>
						</div>
					</div>
				</div>
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$payment->id?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?=$total_fees?>.00"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>recharge_ccavResponseHandler"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>recharge_ccavResponseHandler"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$center_profile->head_name?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$center_profile->address?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing City	:</td><td><input type="text" name="billing_city" value="Arunachal Pradesh"/></td>
		        </tr>
		        <tr>
		        	<td>Billing State	:</td><td><input type="text" name="billing_state" value="AP"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$center_profile->pincode?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Country	:</td><td><input type="text" name="billing_country" value="India"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$center_profile->head_contact_number?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$center_profile->head_email?>"/></td>
		        </tr>
		        <tr>
