							...
							<ul class="header-left-content">
								<li>
									<a href="tel:+917042550366">
                                        ...
                                        Helpline Number : 7042550366   
									</a>
                                    | (10 AM to 5 PM) 
								</li>
                                <li>
                                    <a href="<?=base_url()?>caste-based-discrimination">GBD/Grievances</a>
                                </li>
							</ul>
						</div>
                    ...
                    <div class="container-fluid nav-container">
                        <nav class="navbar navbar-expand-md navbar-light">
                            <a class="navbar-brand" href="<?=base_url()?>">
								...
								<p class="logo-text">Empowering Minds, Transforming Futures</p>
                                ...
                                <ul class="navbar-nav ">
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="<?=base_url()?>faculty_of_school_education" class="nav-link <?php if($this->uri->segment(1)=="faculty_of_school_education"){?>active<?php }?>">Faculty Of School Education</a>
											</li>
											<li class="nav-item">
                                    ...
                                    <li class="nav-item">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="<?=base_url()?>apply-now" class="nav-link <?php if($this->uri->segment(1)=="admission-form"){?>active<?php }?>">Admission Form</a>
											</li>
                                            <li class="nav-item">
                                    ...
                                    <li class="nav-item">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="javascript:void(0);" class="nav-link ">Self Assessment Form </a>
											</li>
                                            <li class="nav-item">
												<a href="javascript:void(0);" class="nav-link ">Parent Assessment Form</a>
											</li>
											<li class="nav-item">
												<a href="javascript:void(0);" class="nav-link ">Teacher Assessment Form</a>
											</li>
											<li class="nav-item">
												<a href="javascript:void(0);" class="nav-link ">Industry Assessment Form</a>
											</li>
											<li class="nav-item">
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a href="<?=base_url()?>collaboration-enquiry" class="nav-link <?php if($this->uri->segment(1)=="collaboration-enquiry"){?>active<?php }?>">Collaborations Enquiry</a>
											</li>
											<li class="nav-item">
												<a href="<?=base_url()?>collaboration-form" class="nav-link <?php if($this->uri->segment(1)=="collaboration-form"){?>active<?php }?>">Collaborations Form</a>
											</li>
                                            <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
											...
											<li class="nav-item">
												...
												<ul class="dropdown-menu">
													...
													<li class="nav-item">
														<a href="<?=base_url()?>phd-exam-login" class="nav-link <?php if($this->uri->segment(1)=="phd-exam-login"){?>active<?php }?>">Entrance Examination Login</a>
													</li>
													<li class="nav-item">
											...
											<li class="nav-item">
												...
												<ul class="dropdown-menu">
													...
													<li class="nav-item">
														<a href="<?=base_url()?>course-work-login" class="nav-link <?php if($this->uri->segment(1)=="course-work-login"){?>active<?php }?>">Course Work Examination Login</a>
													</li>
												</ul>
											</li>
                                            <li class="nav-item">
