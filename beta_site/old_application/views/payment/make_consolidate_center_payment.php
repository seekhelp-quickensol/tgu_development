	...
	<div class="container">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
             ...
             <form method="post" name="customerData" action="<?=base_url();?>consolidated_payment_ccavRequestHandler">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			...
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					...
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>consolidated_payment_ccavResponseHandler"/></td>

				</tr>

			 	<tr>

			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>consolidated_payment_ccavResponseHandler"/></td>
