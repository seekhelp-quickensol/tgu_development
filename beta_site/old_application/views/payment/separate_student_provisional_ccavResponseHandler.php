<?php include('Crypto.php');
	...
	$exist = $this->db->get('tbl_separate_student_provisional_degree');
	...
	$real_fees =$this->db->get('tbl_separate_student_provisional_degree');
...
for($i = 0; $i < $dataSize; $i++) 
	...
	$this->db->select('tbl_separate_student_provisional_degree.*, tbl_separate_student.student_name, tbl_separate_student.mobile, tbl_separate_student.address');

	$this->db->where('tbl_separate_student_provisional_degree.id',$order_id);
...
<body>
	...
	<div class="container">
		...
		<a href="<?=base_url()?>s-student-provisional-degree" style="text-decoration: none;margin-top:10px;background:#000;color:#fff;padding:10px 21px;border-radius:3px;border:none;cursor:pointer;font-size: 13px;">Back</a>
