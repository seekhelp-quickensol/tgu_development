...
$session = array(
	'session_amount' 	=> $student->balance_fees,
	'order_id' 			=> $student->balance_id,
);
...
<!-- <div class="header_cc_area" style="background-image:url('<?=$this->Digitalocean_model->get_photo('images/header_area.jpg')?>')">
				<div class="container">
					<div class="row">
						<h1>Examination Payment Form</h1>
						<p>Examination / Examination Payment Form</p>
					</div>
				</div>
			</div> -->
			...
			<div class="container">
				<div class="page-title-content">
					<h2>Examination Payment Form</h2>
					<ul>
						<li>
							<a href="index.php">
							Examination 
						...
						<li class="active">Examination Payment Form</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student->balance_id?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?=$student->balance_fees?>.00"/></td>
				</tr>
				<tr>
		        ...
		        <tr>
		        	<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" value="tbl_balance_student"/></td>
		        </tr>
				<tr>
