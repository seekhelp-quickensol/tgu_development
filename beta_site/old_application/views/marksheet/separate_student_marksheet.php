		...
		?>
            ...
            <div class="first-row">
                        ...
                        <div class="right-bar-code">
                            <p>
								<?php if(date("Y-m-d",strtotime($marksheet->created_on)) < "2022-08-23"){?>Serial No:<?=$marksheet->sr_number?><?php }?>
			 ...
			 if(in_array($marksheet->enrollment_number,$old) && $marksheet->year_sem == 1){?>
				...
				<?php }else{?>
				    ...
				    <img style="width: 81px;display: block;margin: 0px auto;margin-bottom: -22px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>">
				    <?php }else if($marksheet->examination_month == "June"  && $marksheet->examination_year =="2022"){?>
				    <img style="width: 81px;display: block;margin: 0px auto;margin-bottom: 0px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>">
				    <?php }?> -->
				    
					

					<img style="width: 81px;display: block;margin: 0px auto;margin-bottom: 0px;" src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$marksheet->signature)?>">   
		...
		<div class="students-info student-info-right">
            ...
            <table class="students-exam-details">
				...
				<div class="bottom-sign-section" style="">
					...
					<div class="barcode-middle" style="text-align:center;">
					<img style="top: 65px;" class="barcode-img" alt="<?=$barcode?>" src="<?=base_url();?>barcode.php?codetype=Code39&size=40&text=<?=$barcode?>&print=true" />
					</div>
                    <div class="right-controller" style="padding-top: 5px;">
                        <div style="text-align:center;"> 
							   <!-- <?php $old = array(2020069063020779,2020069067071990,2020069067060985,2020069067062976);
            				    ...
            				    <?php }else if($marksheet->examination_month == "January"  && $marksheet->examination_year =="2023"){?>
				    <img style="width: 81px;display: block;margin: 0px auto;margin-bottom: -22px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>">
				    			<?php }else if($marksheet->examination_month == "May"  && $marksheet->examination_year =="2023"){?>
				    <img style="width: 81px;display: block;margin: 0px auto;margin-bottom: -22px;" src="<?=$this->Digitalocean_model->get_photo('images/signature_contrroler/sahakhan.png')?>">
				    ...
				    <?php }?> -->
								...
								<img src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$marksheet->signature)?>">   
								<p><?=$marksheet->dispalay_signature;?></p>
