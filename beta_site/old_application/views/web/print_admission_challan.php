...
<table width="765" class="challanTable" border="0" align="center">
  <tr>
    <td width="255" style="border-right:dotted"><table width="250" border="0">
      ...
      <tr>
        <td>Acct. No.</td>
        <td class="data"><?=$fees->account_number?></td>
      </tr>
      <tr>
        <td>Bank Name:</td>
        <td class="data"><?=strtoupper($fees->bank_name)?></td>
      </tr>
      <tr>
        <td>Branch:</td>
        <td class="data"><?=strtoupper($fees->branch)?></td>
      </tr>
      <tr>
        <td>Name:</td>
      ...
      <tr>
        <td>Course:</td>
        <td class="data"><?=strtoupper($student->course_name). " - " . strtoupper($student->stream_name)?></td>
      </tr>
      <tr>
        <td>Session:</td>
        <td class="data"><?=$student->session_name?></td>
      </tr>
      <tr>
        <td>Date of Registration:</td>
        <td class="data"><?=date("d-m-Y",strtotime($student->admission_date))?></td>
      </tr>
      <tr>
        <td>Student ID:</td>
      ...
      <tr>
        <td>Amount:</td>
        <td class="data"><?=$fees->total_fees?></td>
      </tr>
      <tr>
        <td>Deposit Date:</td>
        <td class="data"><?=date("d-m-Y",strtotime($fees->payment_date))?></td>
      </tr>
      <tr>
