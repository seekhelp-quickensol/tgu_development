               ...
               <div class="col-md-6">
                  ...
                  <div class="right-icons">
                     <a title="student login" href="<?= base_url(); ?>student-login" target="_blank" class="center_login hidden-xs">
                        <i class="top-btns student" aria-hidden="true"></i>
                        <img src="images/icons/student2.png" width="18" height="18px">
                     ...
                     <span class="span-pipe">|</span>
                     <a title="Employee Login" href="<?= base_url(); ?>erp-access" target="_blank" class="center_login hidden-xs">
                        <i class="top-btns" aria-hidden="true"></i>
                        <img src="images/icons/employee.png" width="18" height="18px">
                        <span> Employee </span>
                     </a>
                     <span class="span-pipe">|</span>
                     <a title="Faculty Login" href="<?= base_url(); ?>faculty_login" target="_blank" class="center_login hidden-xs">
                        <i class="top-btns" aria-hidden="true"></i>
                        <img src="images/icons/faculty2.png" width="18" height="18px">
                        <span> Faculty Login </span>
                     </a>
                     <span class="span-pipe">|</span>
                     <a title="Pay Online" href="<?= base_url(); ?>direct_pay" target="_blank" class="center_login hidden-xs">
                        <i class="top-btns" aria-hidden="true"></i> 
                        <img src="images/icons/pay-online2.png" width="18" height="18px">
