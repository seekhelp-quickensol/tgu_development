        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h4 class="card-title">Separate Student Migration Certificates</h4>
              </div>
                <div class="card-body">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Separate Student Migration Certificates List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_separate_student_migration_certificates_list",
			"type": "POST",
