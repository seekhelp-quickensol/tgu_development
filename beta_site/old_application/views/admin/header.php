...
<head>
	...
	<style>
		<?php if (in_array('view_blended_verify_details', $access)) { ?>.view_blended_verify_details {
		...
		<?php } ?><?php if (in_array('update_student', $access)) { ?>.update_student {
			display: inline-block !important;
		}
					...
					<div class="sidebar card1" id="sidebar">
						...
						<?php } ?> -->
						 ...
						 <?php }?>
							...
							<?php if (in_array('duplicate_marksheet', $access) || in_array('search_marksheet', $access) || in_array('generated_results_excel', $access) || in_array('generated_results_excel_pre', $access)) { ?>
