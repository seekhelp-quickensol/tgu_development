                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" enctype="multipart/form-data">
                                                        <?php if ($document_result->signature == "") { ?><span style="font-size: 16px; color: red;">❌</span><?php } else { ?><span style="font-size: 16px; color: green;">✔️</span><?php } ?>
                                                        <input type="file" name="signature">
                                                        <input type="submit" name="signature_btn" value="Upload" class="btn btn-primary">
                                                        <input type="hidden" name="id" value="<?= $document_result->id ?>">
