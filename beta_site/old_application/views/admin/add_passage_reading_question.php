			...
			<div class="row">
				...
				<form method="post" enctype="multipart/form-data" name="topic" id="topic">
					<div class="row">
					    	...
					    	<textarea type="text" class="form-control" id="passage" name="passage" placeholder="Passage Description" required></textarea>
			    			</div>	
					    	<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
					    		<label>Question Marks<span class="required_input">*</span></label>
