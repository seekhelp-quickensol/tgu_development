                ...
                <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="cv_file" class="form-control-file" id="cv_file" value="<?php if(!empty($profile)){ echo $profile->cv_file; } ?>">

                         <?php if(!empty($profile) && $profile->cv_file != ""){?>

                         <div class="view_btn">

                          <a  title='view' target='_blank' href="<?php echo base_url('images/faculty_staff/cv/'.$profile->cv_file); ?>">View</a>
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="eligibility_document" class="form-control-file" id="eligibility_document" value="<?php if(!empty($profile)){ echo $profile->eligibility_document; } ?>">

                         <?php if(!empty($profile) && $profile->eligibility_document != ""){?>

                         <div class="view_btn">

                          <a  title='view' target='_blank' href="<?php echo base_url('images/faculty_staff/ed/'.$profile->eligibility_document); ?>">View</a>
                    ...
                    <?php 
                     if(!empty($profile)){
                    $city = $this->Faculty_model->get_selected_city($profile->state);
   ...
   $('#profile_form').validate({
      ...
      rules: {
       ...
       <?php if($profile->photo == '') {?>
        ...
        <?php if($profile->eligibility_document == '') {?>
      ...
      <?php if($profile->adhar_file == '') {?>
       ...
       <?php if($profile->photo == '') {?>
        ...
        userfile3 : {
            ...
            required:"Please upload eligible document",
