							   ...
							   <div class="row">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" autocomplete="off" class="form-control" name="name" id="name" value="<?php if(isset($_GET['name'])){ echo $_GET['name'];}?>" style="color: #454545;" placeholder="Name"> 
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" autocomplete="off" class="form-control datepicker" name="start_date" id="start_date" value="<?php if(isset($_GET['start_date'])){ echo $_GET['start_date'];}?>" style="color: #454545;" placeholder="Start Date"> 
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" autocomplete="off" class="form-control datepicker" name="end_date" id="end_date" value="<?php if(isset($_GET['end_date'])){ echo $_GET['end_date'];}?>" style="color: #454545;" placeholder="End Date"> 
									...
									<div class="col-md-12">
                                        ...
                                        <a href="<?=base_url();?>student_assessment" class="btn btn-danger">Reset</a>
									</div> 
              ...
              <div class="card">
                ...
                <div class="card-body">
                 ...
                 <!-- <p class="card-description">
                    ...
                    All list of Self assesment details 
					 ...
					 if(!empty($self_assement)){
						...
						<tr>
                            ...
                            <td>
                                ...
                                <a href="<?=base_url()?>approve_assesment/<?=$self_assement->id?>/tbl_self_assesments" onclick="return confirm('Do You Want To Approve This Assesment?');" class="btn btn-primary">Approve</a>

                                </td>

                            <td>

                                <form name="rejection_remark_form" id="rejection_remark_form" method="post">
        ...
        var table = $('#example').DataTable({
            ...
            buttons: [
...

                {
					...
					filename: 'Student Assessment List',
