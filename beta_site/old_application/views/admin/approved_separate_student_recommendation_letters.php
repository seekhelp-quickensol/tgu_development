        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved Separate Student Recommendation letters</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved Separate Student Recommendation letters List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_approved_separate_student_recommendation_letter_list",
			"type": "POST",
		},	
		"complete": function() {
