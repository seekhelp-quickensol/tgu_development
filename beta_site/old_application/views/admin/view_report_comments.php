        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Report Comments</h4>
                  <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
					...
					<tbody>
						<?php if(!empty($comments)){$i=1; foreach($comments as $comments_result){?>
							<tr>
								<th><?=$i++;?></th>
								<td><?=date("d-m-Y",strtotime($comments_result->created_on));?></td>
								<td><?=$comments_result->description;?></td>
							</tr>
						<?php }}?>
					</tbody>
				</table>
