        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Payment Details for Medium of Instrunction</h4>
                    ...
                    <div class="row">
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="issue_date" name="issue_date" placeholder="Issue date" value="<?php if(!empty($single) && $single->approval_date !="0000-00-00"){ echo date("d-m-Y",strtotime($single->approval_date));}?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
