	...
	<div class="main-panel">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">User Setting
								<a href="<?= base_url(); ?>external_verification_user" class="btn btn-primary mr-2 float-right">View List</a>
							</h4>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="name" name="name" placeholder="Please enter full name" value="<?php if (!empty($single)) {
																																							echo $single->name;
																																						} ?>">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="email" name="email" placeholder="Please enter email" value="<?php if (!empty($single)) {
																																						echo $single->email;
																																					} ?>">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="mobile_number" name="mobile_number" placeholder="Contact Number" value="<?php if (!empty($single)) {
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="password" name="password" placeholder="Please enter password" value="<?php if (!empty($single)) {
		...
		<script>
			...
			$("#email").keyup(function() {
				$.ajax({
					type: "POST",
					url: "<?= base_url(); ?>admin/Ajax_controller/get_verification_emp_unique_email",
					data: {
						'email': $("#email").val(),
						'id': '<?= $id ?>'
					},
			...
			$("#mobile_number").keyup(function() {
				$.ajax({
					type: "POST",
					url: "<?= base_url(); ?>admin/Ajax_controller/get_verification_emp_unique_contact_number",
					data: {
