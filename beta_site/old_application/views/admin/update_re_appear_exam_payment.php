                ...
                <div class="card-body">
				  ...
				  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" autocomplete="off" class="form-control" id="id" name="id" placeholder="Transaction Number" value="<?php if(!empty($single)){ echo $single->id;}?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" id="payment_date" name="payment_date" placeholder="Payment Date" value="<?php if(!empty($single) && $single->payment_date != "1970-01-01" && $single->payment_date != "0000-00-00"){ echo date("d-m-Y",strtotime($single->payment_date));}?>">
					 </div>
					 </div>
					 <div class="col-md-3">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="total_fees" name="total_fees" placeholder="Total Fees" value="<?php if(!empty($single)){ echo $single->amount;}?>">
					 </div>
					 </div>
					 <div class="col-md-7">
                    <div class="form-group">
