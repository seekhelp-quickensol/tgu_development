					...
					<form id="topic" method="post" enctype="multipart/form-data">
						 ...
						 <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
						 	...
						 	<select class="form-control" style="height:34px;" name="correct_answer" id="correct_answer">
						 		...
						 		<option value="A"<?php if(($question->correct_answer) == "A"){?> selected="selected" <?php } ?> >A</option>
						 		<option value="B" <?php if(($question->correct_answer) == "B"){?> selected="selected" <?php } ?> >B</option>
						 		<option value="C" <?php if(($question->correct_answer) == "C"){?> selected="selected" <?php } ?>>C</option>
						 		<option value="D" <?php if(($question->correct_answer) == "D"){?> selected="selected" <?php } ?> >D</option>
						 	</select>
						 </div>
						 <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
