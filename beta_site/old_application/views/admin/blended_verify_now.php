    ...
    <div >
        <div class="container-fuild formv">
            <div class="row">
				...
				<hr>
				<?php //echo "<pre>";print_r($admission);?>
...
<table class="examTable" width="100%" cellpadding="6">
     <tbody>
			...
			<tr>
				...
				<td class="data">
					<?php if($admission->identity_softcopy !="" && $admission->identity_softcopy !=null){?>
     ...
     <tbody>
			...
			<tr>
				<td>
					...
					<a target="_blank" href="<?=base_url();?>view_doc?name=<?=base64_encode($admission->document_path)?>&naming=<?=$admission->document?>">Click to view</a>
					<?php }else{?>
					&nbsp; Not Uploaded
					<?php }?>
				...
				<td>
					<div class="radio-box">
						<input type="radio" name="document_verified" value="1" <?php if(!empty($verified) && $verified->document_verified == "1"){?>checked="checked"<?php }?>>&nbsp; Yes
						&nbsp;
						<input type="radio" name="document_verified" value="0" <?php if(!empty($verified) && $verified->document_verified == "0"){?>checked="checked"<?php }?>>&nbsp; No
					</div>
				</td>
				<td>
					<input class="form-control" type="text" name="documents_remark" value="<?php if(!empty($verified)){ echo $verified->documents_remark;}?>" placeholder="Remark if any?">
				</td>
			</tr>
