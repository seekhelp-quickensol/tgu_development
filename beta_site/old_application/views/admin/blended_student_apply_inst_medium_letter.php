        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Apply Blended Student Medium Of Instruction Letter
				  </h4>
     ...
     $("#enrollment_no").keyup(function(){ 
      ...
      if (enrollmentNumber.length >= 5) {
        $.ajax({
              ...
              data:{'enrollment_no':$("#enrollment_no").val(),'table':'tbl_medium_instruction_application_blended'},
