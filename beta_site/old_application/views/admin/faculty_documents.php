                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="head" name="head" placeholder="Document Name" value="<?php if(!empty($single)){ echo $single->head;}?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="old_userfile" name="old_userfile"  value="<?php if(!empty($single)){ echo $single->file;}?>">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_my_faculty_documents",
			"type": "POST",
		},	
		"complete": function() {
			$('[data-toggle="tooltip"]').tooltip();			
