              ...
              <form class="pt-3" id="login_form" name="login_form" method="post" >
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="username" name="username" placeholder="Please enter your username">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="<?=base_url();?>student-forgot" class="auth-link text-black">Forgot password?</a>
                </div>
                <div class="my-3">
