...
<?php 			
	...
	} 	$exam_fees = '1000';	if($this->session->userdata('center_id') == 31 && $center_profile->payment_term == 2){		$exam_fees = '500';	}else if($this->session->userdata('center_id') == 58 && $center_profile->payment_term == "2"){		$exam_fees = '500';	}
?>
