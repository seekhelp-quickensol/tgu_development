            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?=base_url();?>pay_student_bonafide/<?php if(!empty($student)){ echo $student->id;}?>" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label for="exampleInputUsername4" class="hidden-label">Mobile : <?php if(!empty($student)){ echo $student->mobile;}?></label><br>
                                <!-- <label for="exampleInputUsername4" class="hidden-label">Fees : Rs. 1000 /-</label> -->
                                <label for="exampleInputUsername4" class="hidden-label">Fees : Rs. <?php if(!empty($bonafide)){ echo $bonafide->certificate_fees;}?> /-</label>
                            </div>
                        </div>
					</div>	

					<button type="submit" id="single_button" class="btn btn-primary mr-2">Pay Now</button>
                  </form>
                </div>
              </div>
            </div>
