					...
					<div class="form-group">
                      <label for="exampleInputUsername1">Upload File * 
							<?php if(!empty($single) && $single->file != ""){?>
								<a href="<?=$this->Digitalocean_model->get_photo('uploads/papers/'.$single->file)?>" target="_blank" class="btn btn-info btn-small">View</a>
							<?php }?>
					  </label>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">  
                  ...
                  <a href="<?=base_url();?>center_add_paper" class="btn btn-primary" style="float:right">Back</a>
                  <p class="card-description">
                    All list of Papers
                  </p>
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_controller/get_all_paper_ajax_course_wise",
			"type": "POST",
            "data":{"course_id":<?php echo $this->uri->segment(2);?>,"stream_id":<?php echo $this->uri->segment(3);?>},
		},	
		"complete": function() {
