        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Self Assessment Pending List</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_ajax_controller/get_self_assessment_pending_ajax",
			"type": "POST",
		},	
		"complete": function() {
