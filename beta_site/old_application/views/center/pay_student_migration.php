    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">Payment for Migration</h2>
												...
												<br><br>
													<div class="box_layer_t">
													    <div class="btn_center"> 
														 ...
														 <p class="mid_bix">Please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees;}?></b> to get your migration, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
...
<?php }}else{
	redirect('apply_student_migration/'.$this->uri->segment(2));
} include('footer.php');?>
