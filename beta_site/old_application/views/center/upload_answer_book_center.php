        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Upload Answer book</h4>
                  <p class="card-description">
                    Please enter answer book details
                  </p>
                  <form class="forms-sample" name="paper_form" id="paper_form" method="post" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="form-group">
						  ...
						  <select class="form-control js-example-basic-single course_relation book_relation" id="course" name="course">
						...
						<div class="form-group">
						  ...
						  <select class="form-control js-example-basic-single course_relation book_relation" id="stream" name="stream">
						...
						<div class="form-group">
						  ...
						  <select class="form-control js-example-basic-single course_relation book_relation" id="subject" name="subject">
					...
					<div class="form-group">
                      ...
                      <input type="text" readonly class="form-control" id="student_name" name="student_name">
                    </div>
					</div>
					<div class="col-md-6">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Answerbook List</h4>
                  <p class="card-description">
                    All list of Answerbook
                  </p>
 ...
 $(document).ready(function () {		
	...
	$('#paper_form').validate({
		...
		messages: {
			...
			year_sem: {
				required: "Please select year/sem/month",
			},
			file: {
...
$("#course").change(function(){
  ...
  $("#stream").change(function(){
	...
	$("#course_mode").html("<option value=''>Select Course Mode</option>");
	 $.ajax({
		 type: "post",
		 url: "<?=base_url();?>center/Center_controller/get_subject_name_stream",
		 data:{'stream':$("#stream").val(),'course':$("#course").val()},
		 success: function(data){   
			// alert(data); 
			 console.log(data);
			 $('#subject').empty(); 
...
$("#enrollment_number").change(function(){ 
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>center/Center_ajax_controller/get_student_name_ajax",
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>center/Center_ajax_controller/get_all_answer_book_ajax",
			"type": "POST",
...
$(".book_relation").change(function(){  
	if($("#course").val() != '' && $("#stream").val() != '' && $("#subject").val() != ''){
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>center/Center_ajax_controller/get_unique_answer_book_relation",
		data:{'course':$("#course").val(),'stream':$("#stream").val(),'subject':$("#subject").val(),'id':'<?=$id?>'},
		success: function(data){
