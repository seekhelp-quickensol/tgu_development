	...
	<div class="main-panel">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" name="student_name" id="student_name" class="form-control remove_mr no-dot" placeholder="Student Full Name">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" name="father_name" id="father_name" class="form-control remove_mr no-dot" placeholder="Father's/Husband's Name">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" name="mother_name" id="mother_name" class="form-control charector remove_mr no-dot" placeholder="Mothers Name">
						...
						<div class="row"> -->
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input autocomplete="off" type="text" name="email" id="email" class="form-control" placeholder="Email ID">
						...
						<div class="row"> -->
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="file" name="undertaking" id="undertaking" class="form-control" accept=".pdf,.doc,.docx,.jpeg,.png,.jpg">
										</div>
									</div>
								...
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-12 edu">
											<div class="form-group">
												<input type="checkbox" name="mycheckbox" id="mycheckbox" value="0" required /><label style=" margin:0px;">&nbsp; I Agree to the declaration<span class="req">*</span></label>
		...
		<script>
			...
			$("#session").change(function() {
				final_calculation();
				$("#course_mode").html('<option value="">Select Mode</option>');
		...
		$(document).ready(function () {
			...
			jQuery.validator.addMethod("validate_email", function(value, element) {
				...
				messages: {
					...
					father_name:{
						required: "Please enter father's/husband's name",
						noSpaceatfirst: "First letter can't be space",	
						alphabetsOnly:"Father's/Husband's name must contain only alphabets",
					}, 
					mother_name: {
					...
					father_profession: {
						...
						noSpaceatfirst: "First letter can't be space",
						alphabetsOnly:"Father's/Husband's profession must contain only alphabets",	
					},
					...
					identity_numer: {
						...
						number: "Please enter only number",
						validateAadhaarNumber:"Please enter a valid aadhaar number (12 digits)",
