            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Add Subject <a href="<?=base_url();?>my_list_subject" class="btn btn-primary mr-2 float-right">View List</a></h4><p class="card-description">
						...
						<div class="col-md-6">
							<div class="form-group">
							  ...
							  <select class="form-control js-example-basic-single exist_fees course_list" id="course" name="course">
								...
								<option value="<?=$course_result->course?>"><?=$course_result->course_name?></option>
								<?php }}?>
							  </select>
							 ...
							 <table class="resultTable">
								...
								?>                      
									<tr><td><input type="text" name="txtSubjectCode[]" id="txtSubjectCode<?php echo $i ?>" class="form-control" maxlength="20" value=""/></td>
										...
										<td><input type="text" name="txtCredit[]" id="txtCredit<?php echo $i ?>" class="form-control" maxlength="1" onkeypress="return isNumber(event)" oninput="checkValue(this)" /></td>
									</tr>
								<?php
									}
								?>
