									...
									<div class="card">
											...
											if(!empty($course)) { 
												foreach($course as $course_result) {
													if((isset($_GET['search']) && $_GET['search'] == $course_result->course_name) || (!isset($_GET['search']) && !empty($course_result))){
														$stream = $this->Center_model->get_course_stream_with_fees($course_result->id,$session_id,$this->uri->segment(2));
										?>
										...
										<div class="paarent_stream">
											...
											<table border="1">
												...
												<tbody>
													<tr>
														<td><input type="checkbox" class="all stream-checkbox" name="stream_data" id="stream_data___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?=$stream_result->fees_peky?>" <?php if($stream_result->fees_peky !="0") { ?>checked="checked"<?php } ?>></td>
														...
														<td><input type="text" class="form-control fees_cal actual_fees" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="fees[]" id="fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?=$stream_result->fees?>"></td>
														<td><input type="text" class="form-control percentage" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="percentage" id="percentage___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?=$stream_result->percentage?>"></td>
														<td><input type="text" class="form-control total_paid_fees" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="total_paid_fees" id="total_paid_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?=$stream_result->paid_fees?>"></td>
														<td><input type="text" class="form-control foreign_fees" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="foreign_fees" id="foreign_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?=$stream_result->foregin_fees?>"></td>
														<td><input type="text" class="form-control" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="registration_fees" id="registration_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?php if($stream_result->registration_fees == "") { echo "100"; } else { echo $stream_result->registration_fees; } ?>"></td>
														<td><input type="text" class="form-control" onkeyup="return saver_dis('<?=$course_result->id?>___<?=$stream_result->stream?>');" name="examination_fees" id="examination_fees___<?=$course_result->id?>___<?=$stream_result->stream?>" value="<?php if($stream_result->exam_fees == "") { echo "1000"; } else { echo $stream_result->exam_fees; } ?>"></td>
													</tr>
												</tbody>
												<?php }} ?>
											</table>
...
$("#session").change(function(){
	window.location.href="<?=base_url()?>/assign_course/<?=$this->uri->segment(2)?>?session="+$("#session").val();
});
</script>