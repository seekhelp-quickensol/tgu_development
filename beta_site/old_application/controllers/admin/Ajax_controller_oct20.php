	...
	public function get_all_document_ajax(){
        ...
        if(!empty($document)){
			...
			foreach($document as $print){
				...
				$sub_array[] = $print->head_name;
				$sub_array[] = $print->name;
				$sub_array[] = "<a type='button' target='_blank' title='View' data-toggle='tooltip' href=" . base_url() . "uploads/".$print->document."  class='btn btn-success btn-sm upload_document_class'><i class='mdi mdi mdi-eye'></i></a>";
	...
	public function get_new_admission_list(){
        ...
        if(!empty($document)){
			...
			foreach($document as $print){
				...
				<a type='button' title='Edit' data-toggle='tooltip' href=" . base_url() . "update_student/".$print->id."  class='btn btn-success btn-sm edit_class'><i class='mdi mdi-table-edit'></i></a>
				<a type='button' title='Accounts' data-toggle='tooltip' href=" . base_url() . "manage_student_account/".$print->id."  class='btn btn-success btn-sm manage_student_account'><i class='mdi-credit-card'></i></a>
				<a onclick=\"return confirm('Are you sure to approved admission?')\"' data-toggle='tooltip' title='Approved Admission' href=" . base_url() . "approved_admission/" . $print->id . " class='btn btn-danger btn-sm approved_admission'><i class='mdi mdi-check'></i></a>
			...
			foreach($document as $print){
				...
				if($print->status == "1"){
					$sub_array[] = "<a onclick=\"return confirm('Are you sure, you want to deactivate this record?')\"' data-toggle='tooltip' title='Deactivate' href=" . base_url() . "inactive/" . $print->id . "/tbl_staff_faculty class='btn btn-success btn-sm inactivate_clas'><i class='mdi mdi-bookmark-check'></i></a>   
									...
									<a onclick=\"return confirm('Are you sure, you want to Update this record ?')\"' data-toggle='tooltip' title='Is Not Left' href=" . base_url() . "faculty_not_left/" . $print->id . " class='btn btn-warning btn-sm faculty_not_left'><i class='mdi mdi-login'></i></a>
									";
				}else{
					$sub_array[] = "<a onclick=\"return confirm('Are you sure, you want to activate this record?')\"' data-toggle='tooltip' title='Activate' href=" . base_url() . "active/" . $print->id . "/tbl_staff_faculty class='btn btn-danger btn-sm activate_clas'><i class='mdi mdi-playlist-remove'></i></a>
									<a onclick=\"return confirm('Are you sure, you want to delete this record permanently?')\"' data-toggle='tooltip' title='Permanently Delete' href=" . base_url() . "delete/" . $print->id . "/tbl_staff_faculty class='btn btn-danger btn-sm delete_class'><i class='mdi mdi-delete'></i></a>
	...
	public function get_all_e_library_ajax(){
        ...
        if(!empty($document)){
			...
			foreach($document as $print){
				...
				$sub_array[] = "<a target='_blank' type='button' title='View Book' data-toggle='tooltip' href=" . base_url() . "images/ebook/".$print->ebook."  class='btn btn-success btn-sm'><i class='mdi mdi-eye'></i></a>"; 
				$sub_array[] = $print->year_sem; 
				if($print->status == "1"){
	...
	public function get_all_account_vendor_bill_ajax(){
        ...
        if(!empty($document)){
			...
			foreach($document as $print){
				...
				$sub_array[] = $print->amount; 
				$sub_array[] = date("d/m/Y",strtotime($print->date)); 
				$sub_array[] = "<a target='_blank' type='button' title='View Bill' data-toggle='tooltip' href=" . base_url() . "images/bills/".$print->bill."  class='btn btn-success btn-sm'><i class='mdi mdi-eye'></i></a>"; 
	...
	public function get_all_paper_ajax_course_wise(){
        ...
        if(!empty($document)){
			...
			foreach($document as $print){
				...
				if($print->status == "1"){
					$sub_array[] = "<a onclick=\"return confirm('Are you sure, you want to delete this record permanently?')\"' data-toggle='tooltip' title='Permanently Delete' href=" . base_url() . "delete/" . $print->id . "/tbl_papers class='btn btn-danger btn-sm delete_class'><i class='mdi mdi-delete'></i></a><a type='button' title='Edit' data-toggle='tooltip' href=" . base_url() . "add_paper/".$print->id."  class='btn btn-success btn-sm edit_class'><i class='mdi mdi-table-edit'></i></a>";
				}else{
					$sub_array[] = "<a onclick=\"return confirm('Are you sure, you want to delete this record permanently?')\"' data-toggle='tooltip' title='Permanently Delete' href=" . base_url() . "delete/" . $print->id . "/tbl_papers class='btn btn-danger btn-sm delete_class'><i class='mdi mdi-delete'></i></a><a type='button' title='Edit' data-toggle='tooltip' href=" . base_url() . "add_paper/".$print->id."  class='btn btn-success btn-sm edit_class'><i class='mdi mdi-table-edit'></i></a>";
							}
