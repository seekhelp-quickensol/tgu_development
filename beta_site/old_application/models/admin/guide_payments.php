              ...
              <div class="card">
                <div class="card-body">
				  ...
				  <div class="col-md-3">
					...
					//   print_r($guide);exit();
					  ?>
						<input type="text" placeholder="Bank Account Number" class="form-control" id="guide_account" name="guide_account" value="<?php if(!empty($guide)){ echo $guide->account_number;}else{ echo "NA"; }?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="bank_name" name="bank_name" value="<?php if(!empty($guide)){ echo $guide->bank_name;}?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="account_name" name="account_name" value="<?php if(!empty($guide)){ echo $guide->account_name;}?>">
					 <div class="error" id="transaction_error"></div>
					 </div>
					 </div> 
					 <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="guide_ifsc" name="guide_ifsc" value="<?php if(!empty($guide)){ echo $guide->ifsc_code;}?>">
					 <div class="error" id="transaction_error"></div>
					 </div>
					 </div> 
					<div class="col-md-3">
