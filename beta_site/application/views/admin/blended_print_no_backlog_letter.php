...
if(!empty($single)){
    $division = $this->Separate_student_certificate_model->get_student_division_for_degree_new_degree($single->student_id); 
					...
					<div>
						<div class="letter_area" style="background-image:url(<?=$this->Digitalocean_model->get_photo('images/marksheet_background.png')?>);background-position: center;background-size: cover;border: 2px solid #e8612b;height: 100%;">  
            							...
            							<div class="head_top_logo">
                                            <!-- <img src="<?=$this->Digitalocean_model->get_photo('images/only-logo.png')?>"> -->
                                    </div>
									...
									<p style="color: #000;font-weight: 700;font-size: 25px; margin-top: 25px;text-align: center"><u>No Backlog Letter</u> </p>
							...
							<div style="display: block;">
                                    ...
                                    was a bonafide student of <b><?php echo $course_name;?> (<?php echo $stream_name;?>)</b> in The Global University.
                                    He/She
                                    has credit transferred from APJ Abdul Kalam Technological University and successfully completed the course and cleared all the backlogs in the examination held in <b>
                                        <!-- <?=$division['date'];?> -->
                                    <?= isset($division['date']) ? $division['date'] : '' ?></b> The Global University and placed in 
                                    
                                    <!-- First Class.    -->
                                    <!-- <b><?=$division['division'];?></b>. -->
                                    <b><?= isset($division['division']) ? $division['division'] : '' ?></b>.
									</p>
									<p style="margin-top: 10px;color: #000;font-size: 18px;font-weight: 500;margin-bottom: 0px;line-height: 40px; word-spacing: 7px;float:left">
                                    his/her
                                    conduct was good.
								...
								<div>
                                    ...
                                    <div style="width: 205px;float: right;text-align: center;margin-top: 125px;">
											<img src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$single->signature)?>">   
                            ...
                            <img style="width: 145px;margin-top: 200px;" src="<?=$this->Digitalocean_model->get_photo('images/logo/'.$university_details->stamp)?>">   
