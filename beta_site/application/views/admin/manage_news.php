              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="news_type" name="news_type" placeholder="News Type" value="<?php if(!empty($single)){ echo $single->news_type;}?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">News Heading *</label>
                      ...
                      <textarea class="form-control" id="content" name="content" placeholder="Short Description"><?php if(!empty($single)){ echo $single->news;}?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Long Description*</label>
                      <textarea class="form-control" id="long_content" name="long_content" placeholder="Long Description"><?php if(!empty($single)){ echo $single->long_news;}?></textarea>
                      <label style="display:none;" for="summernote" generated="true" class="error">Please enter Long Description*</label>
                    </div>
                    <div class="form-group">
                      <label>File</label>
 ...
 $(document).ready(function () {		
    ...
    ignore: ":hidden:not(#long_content),.note-editable.panel-body",
      ...
      // },
		...
		messages: {
      news_type:{
				required: "Please enter news type",
      },
			heading: {
			...
			content: {
				required: "Please enter short description of news",
			},
      // long_content: {
			// 	required: "Please enter long description of news",
			// },
      // photo:{
			// 	required: "Please upload image of news",
      // },
		},
		errorElement: 'span',
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_news_ajax",
			"type": "POST",
		},	
		"complete": function() {
