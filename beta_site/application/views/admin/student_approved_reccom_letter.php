        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                   <h4 class="card-title">Approved Recommendation Letter</h4><p class="card-description">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved Recommendation Letter",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_approv_reccom_list",
			"type": "POST",
		},	
		"complete": function() {
		...
		"drawCallback": function(settings) {
			$(".tranfer_uni").keyup(function(){
				...
				$.ajax({
					...
					data:{'id':id[1],'tranfer_university':$(this).val(),'tbl':'tbl_reccom_letter_application'},
