                  ...
                  <form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="added_by_name" id="added_by_name" class="form-control" placeholder="" value="<?php if(!empty($single_cbd_form)){ echo $single_cbd_form->added_by_name;}?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" id="dispatch_date" name="dispatch_date" placeholder="" value="<?php if(!empty($single_cbd_form)){ echo $single_cbd_form->dispatch_date;}?>">
					          </div>
					          </div>
                 </div>
