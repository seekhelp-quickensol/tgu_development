                            ...
                            <div>
                                <div class="letter_area">
                                    <div class="head_row"
                                        ...
                                        <div style="padding-left: 20px;">
                                            <!-- <p style="font-family: sans-serif;font-size: 15px;">Sr No.: -->
                                                <!-- <?=$degree->sr_no?></p> -->
                                                <!-- <?=$degree->id?></p> -->
                                                <p style="float: left;padding-left: 30px; margin-bottom:0px;font:bold; font-weight: 700">Sr No. : <?=date('Y',strtotime($degree->created_on));?><?=substr($degree->enrollment_number,-6);?></p>	
                                    ...
                                    <div class="padd_wrapper">
                                        ...
                                        <!--</div>-->
                                        <h1
                                            style="font-family: sans-serif-400; color: #000; text-align: center; font-size: 30px; margin-bottom: 0px; margin-top:-45px; text-transform:uppercase; padding-top:55px;">
                                        ...
                                        <div
                                            style="display:flex; justify-content: space-between; align-items: end; padding-top: 30px;gap: 50px;">
                                            ...
                                            <div style="width: 205px;float: right;text-align: center;margin-top: 125px;">
                                                <img style="width: 170px;" src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$degree->signature)?>">   
                                                <p style="color: #000;font-size: 16px;font-weight: 600;margin-bottom: 0px;"><?=$degree->dispalay_signature;?></p>
                                            </div>
                                            ...
                                            <!-- <img style="width: 115px;"  src="<?=base_url();?>images/img/stamp.png" alt=""> -->
                                                ...
                                                <p style="font-family: sans-serif; color: #000; text-align: center;font-size: 14px;margin:0px;">
                                                    Arunachal Pradesh, Dated <?=date('jS F Y',strtotime($degree->issue_date)); ?>
                                                </p>
                                            </div>
                                            ...
                                            <div style="width: 205px;float: right;text-align: center;margin-top: 125px;">
                                                <img src="<?=$this->Digitalocean_model->get_photo('certificate_signature/'.$degree->chancellor_signature)?>" style="width:100%">   
                                                <p style="color: #000;font-size: 16px;font-weight: 600;margin-bottom: 0px;"><?=$degree->display_chacellor_signature;?></p>
                                            </div>
                                        </div>
                                        <div style="position: absolute; bottom: 30px;">
                                            <p style="font-family: sans-serif;font-size: 13px;">Enrol. No.
                                                <?=$degree->enrollment_number;?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
