						...
						<div class="card-body">
							...
							<form class="forms-sample" name="single_form" id="single_form" method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-md-3 course_update_reason" <?php if($student->course_update_reason !=""){?>style="display:block;"<?php }else{?>style="display:none;"<?php }?>>
										<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input class="form-control number_only" required name="pincode" id="pincode" placeholder="PinCode" value="<?=$student->pincode?>">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label>Photo <?php if($student->photo !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/profile_pic/'.$student->photo)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="photo" id="photo">
											<input type="hidden" class="form-control" name="old_photo" id="old_photo" value="<?=$student->photo?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>NOC <?php if($student->noc !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/noc/'.$student->noc)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="noc" id="noc">
											<input type="hidden" class="form-control" name="old_noc" id="old_noc" value="<?=$student->noc?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Permission Letter <?php if($student->permission_letter !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/permission_letter/'.$student->permission_letter)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="permission_letter" id="permission_letter">
											<input type="hidden" class="form-control" name="old_permission_letter" id="old_permission_letter" value="<?=$student->permission_letter?>">
										</div>
									</div>
										
									<div class="col-sm-3">
										<div class="form-group">
											<label>Signature <?php if($student->signature !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/signature/'.$student->signature)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="signature" id="signature">
											<input type="hidden" class="form-control" name="old_signature" id="old_signature" value="<?=$student->signature?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Affidavit <?php if($student->affidavit_file !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/affidavit/'.$student->affidavit_file)?>">View</a><?php }?></label>
											<input type="file" name="affidavit_file" id="affidavit_file" class="form-control upload_photo" accept=".pdf,.doc,.docx,.jpeg,.png,.jpg">
											<input type="hidden" name="old_affidavit_file" id="old_affidavit_file" value="<?=$student->affidavit_file?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Adhar/Passport soft copy <?php if($student->identity_softcopy !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/student_identity_softcopy/'.$student->identity_softcopy)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="identity_softcopy" id="identity_softcopy">
											<input type="hidden" class="form-control" name="old_identity_softcopy" id="old_identity_softcopy" value="<?=$student->identity_softcopy?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Collaborator undertaking<?php if($student->ohter_files !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/student_identity_softcopy/'.$student->ohter_files)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="ohter_files" id="ohter_files">
											<input type="hidden" class="form-control" name="old_ohter_files" id="old_ohter_files" value="<?=$student->ohter_files?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="show_collaborator_undertaking" id="show_collaborator_undertaking">
												<option value="0" <?php if($student->show_collaborator_undertaking == "0"){?>selected="selected"<?php }?>>No</option>
												<option value="1" <?php if($student->show_collaborator_undertaking == "1"){?>selected="selected"<?php }?>>Yes</option> 
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="show_center_collaborator_undertaking" id="show_center_collaborator_undertaking">
												<option value="0" <?php if($student->show_center_collaborator_undertaking == "0"){?>selected="selected"<?php }?>>No</option>
												<option value="1" <?php if($student->show_center_collaborator_undertaking == "1"){?>selected="selected"<?php }?>>Yes</option> 
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label>Student Undertaking <?php if($student->undertaking !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/permission_letter/'.$student->undertaking)?>">View</a><?php }?></label>
											<input type="file" class="form-control" name="undertaking" id="undertaking">
											<input type="hidden" class="form-control" name="old_undertaking" id="old_undertaking" value="<?=$student->undertaking?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="show_undertaking" id="show_undertaking">
												<option value="0" <?php if($student->show_undertaking == "0"){?>selected="selected"<?php }?>>No</option>
												<option value="1" <?php if($student->show_undertaking == "1"){?>selected="selected"<?php }?>>Yes</option> 
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" name="show_center_undertaking" id="show_center_undertaking">
												<option value="0" <?php if($student->show_center_undertaking == "0"){?>selected="selected"<?php }?>>No</option>
												<option value="1" <?php if($student->show_center_undertaking == "1"){?>selected="selected"<?php }?>>Yes</option> 
											</select>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" required="required" name="admission_status" id="admission_status">
												...
												<option value="0" <?php if($student->admission_status == '0'){ echo "selected='selected'"; } ?>>Pending</option>
												<option value="1" <?php if($student->admission_status == '1'){ echo "selected='selected'"; } ?>>Active</option>
												<option value="2" <?php if($student->admission_status == '2'){ echo "selected='selected'"; } ?>>Cancel</option>
												<option value="3" <?php if($student->admission_status == '3'){ echo "selected='selected'"; } ?>>Hold</option>
												<option value="4" <?php if($student->admission_status == '4'){ echo "selected='selected'"; } ?>>Pass out</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select class="form-control" required="required" name="employement_type" id="employement_type">
												...
												<option value="Government Employee" <?php if($student->employement_type == 'Government Employee'){ echo "selected='selected'"; } ?>>Government Employee</option>
												<option value="Private Sector Employee" <?php if($student->employement_type == 'Private Sector Employee'){ echo "selected='selected'"; } ?>>Private Sector Employee</option>
												<option value="Not Working" <?php if($student->employement_type == 'Not Working'){ echo "selected='selected'"; } ?>>Not Working</option>
									...
									<div class="col-sm-3"> 
										<div class="form-group"> 
											...
											<select id="category" name="category" class="form-control js-example-basic-single"> 
												...
												<option value="General" <?php if($student->category == 'General'){ ?>selected="selected" <?php } ?>>General (Open)</option> 
												<option value="Other Backward Class" <?php if($student->category == 'Other Backward Class'){ ?>selected="selected" <?php } ?>>Other Backward Class (OBC)</option> 
												<option value="Scheduled Caste" <?php if($student->category == 'Scheduled Caste'){ ?>selected="selected" <?php } ?>>Scheduled Caste (SC)</option> 
												<option value="Scheduled Tribe" <?php if($student->category == 'Scheduled Tribe'){ ?>selected="selected" <?php } ?>>Scheduled Tribe (ST)</option> 
											</select>
										</div> 
									</div> 
