          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
				 ...
				 <div class="row">
					...
					<div class="col-md-3" style="display:none;">
						<div class="form-group">
							...
							<input type="text" autocomplete="off" name="issue_date" id="issue_date" class="form-control datepicker" value="">
						</div>
					</div>
					<div class="col-md-3" style="display:none;">
						<div class="form-group">
					...
					<div class="col-md-3" style="display:none;">
						<div class="form-group">
							...
							<input type="text" autocomplete="off" name="payment_date" id="payment_date" class="form-control datepicker" value="<?=date("d-m-Y")?>">
						</div>
					</div>
					 <div class="col-md-3" style="display:none;">
						<div class="form-group">
							<label>Payment ID</label>
							<input type="text" autocomplete="off" name="payment_id" id="payment_id" class="form-control" value="">
						</div>
					</div>
				...
				<hr>
				<p>THE GLOBAL UNIVERSITY Appeared papers details</p>
				<hr>
				<?php if(!empty($subject)){ foreach($subject as $subject_result){?>
                    <div class="row" id="appending_div">                          
                          <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="year_sem[]" id="year_sem" class="form-control subject_code"> 
                                        ...
                                        <option value="<?=$subject_result->year_sem_value?>"><?=$subject_result->year_sem_value?></option>
                                    </select>
                                </div>
                            </div>                        
                            <div class="col-md-2">
							...
							<div class="col-md-2">
                                <div class="form-group">
                                    <label>Credit</label>
                                    <input type="text" name="credit[]" id="credit" class="form-control subject_code" value="<?=$subject_result->credit?>">
                                </div>
                            </div> 
							<div class="col-md-2">
                                <div class="form-group">
						...
						<div class="col-md-12">
							<div class="form-group">
							<?php if(!empty($student)){?>
								<input type="submit" name="show_subject" id="show_subject" class="btn btn-primary btn-sm" value="Finish">
								<input type="submit" name="show_subject" id="show_subject" class="btn btn-info btn-sm" value="Continue With other University Subject">
