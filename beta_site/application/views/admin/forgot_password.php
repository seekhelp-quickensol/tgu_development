      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
          <div class="col-lg-12 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3"  style="border-radius: 6px;border: 1px solid;">
               <div class="brand-logo" style="text-align:center">
                <img src="https://theglobaluniversity.edu.in/images/logo/eaeafcf7cd3654e5460a698921e6cbf1.png" alt="logo">
              </div>
              <h4 style="text-align:center;font-size: 28px;font-weight: 600;color: #991b30;text-transform: uppercase;margin-top: 0px;margin-bottom: 0px;">The Global University</h4> 
              ...
              <form class="pt-3" id="login_form" name="login_form" method="post" >
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="<?=base_url();?>erp-access" class="auth-link text-black">Back to Login?</a>
                </div>
                <div class="my-3">
