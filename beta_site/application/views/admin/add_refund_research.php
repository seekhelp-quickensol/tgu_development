            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
				...
				<h4 class="card-title">Add 
					<?php 
						if(!empty($name_success)){
							echo $name_success->student_name;
						}else if(!empty($name_failed)){
							echo $name_failed->student_name;
						}else if(!empty($payment_refund)){
							echo $payment_refund->student_name;
						}
					?> Refunds
				</h4>
				
				<!-- <h4 class="card-title">Add <?php if(!empty($name_success)){ echo $name_success->student_name;}?> Refunds</h4> -->
				<!-- <h4 class="card-title">Add <?php if(!empty($name_failed)){ echo $name_failed->student_name;}?> Refunds</h4> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="research_id" id="research_id" value="<?=$this->uri->segment(2);?>">
                    </div>
</div>
...
<div class="col-md-3">
					...
					<div class="col-md-3">
                    <div class="form-group">
                      <label for="exampleInputUsername1"> Document  
						<!-- <?php if($qualification->userfile !=""){?><a target="_blank" href="<?=$this->Digitalocean_model->get_photo('images/qualification/'.$qualification->userfile)?>">View</a><?php }?> -->
					</label>
