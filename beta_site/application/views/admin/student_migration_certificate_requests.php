          ...
          <div class="card">
            <div class="card-header custom-header">
              <h4 class="card-title"><?php if (isset($_GET['type']) && $_GET['type'] == '1') {
                ...
                Student Migration Certificate Requests</h4>
            </div>
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        var table = $('#example').DataTable({
          ...
          buttons: [{
            extend: "excelHtml5",
            title: "Student Migration Certificate Requests",
          ...
          "ajax": {
            "url": "<?= base_url(); ?>admin/Ajax_controller/get_all_migration_certificate_requests_list",
            "type": "POST",
            "data": {
