                  ...
                  <form method="POST" id="generate-result-excel" autocomplete="off">
                    <div class="row">
                      <div class="col-3">
					   ...
					   <div class="col-3">
                        <input type="text" name="to_date" id="to_date" class="form-control datepicker" autocomplete="off" Placeholder="Please Select From Date">
                      </div>
					   <div class="col-3">
                        <input type="text" name="enrollment_number" id="enrollment_number" class="form-control" autocomplete="off" Placeholder="Enrollment Number">
                      </div>
                      <div class="col-3">
