...
<!-- 
						...
						<div class="form-group col-lg-3">
							<label for="exampleInputUsername1">Currect Answer *</label>
							<input type="text" class="form-control" value="<?php if(!empty($question)){ echo  $test_data->options->selected_ans ; } ?>" id="current_answer" name="current_answer" placeholder="Currect Answer">
						</div>
					</div>
