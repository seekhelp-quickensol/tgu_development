        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h4 class="card-title">Student Character Certificate List</h4>
              </div>
                <div class="card-body">
...
$(document).ready(function() { 
	...
	var table = $('#example').DataTable({
		...
		buttons:[
			...
			{
				extend: "excelHtml5",
        title:"Approved Character Certificate List",
		...
		"ajax":{
			"url" : "<?=base_url();?>admin/Ajax_controller/get_all_student_charector_certificate_approved_list",
			"type": "POST",
