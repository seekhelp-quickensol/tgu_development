	...
	<div class="container">
		...
		<table>
				...
				<h2 style="font-size: 15px;margin: 0px;margin-bottom:5px; text-align:left">Student Details:</h2>
					...
					<span style="float:left">Name- <?=$student_data->name?></span><br>

					

					<span style="float:left">Student Name- <?=$student_data->student_name?></span><br>

					<span style="float:left">Invoice No - <?=$student_data->transaction_id?></span><br>

					<span style="float:left">Payment status - <?php echo $student_data->payment_status == '1'?'success':'failed';?></span><br>

					<span style="float:left">Address: <?=$student_data->address?></span><br/>

					<span style="float:left">Contact Number: <?=$student_data->mobile_number?></span><br/>
				...
				<tr style="text-align:center;">
					...
					<td><?=date("d/m/Y",strtotime($student_data->created_on));?></td>

					<td>Document Verification Fees</td>

					<td colspan="4"><?=$student_data->transaction_id?></td>

					<td>Rs. <?=$student_data->amount?></td>
				...
				<tr style="background:#ccc;text-align:center;">
					...
					<td><b>Rs.<?=$student_data->amount;?></b></td>
