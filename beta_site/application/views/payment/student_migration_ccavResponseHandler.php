...
$order_id = explode("___", $ex_order_id);
$order_id = $order_id[1];
$this->db->select('tbl_student_migration.*, tbl_student.student_name, tbl_student.mobile, tbl_student.address, tbl_student.pincode, countries.name as country_name, states.name as state_name, cities.name as city_name');
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
						...
						<td class="tm_width_4">Migration Fees</td>
