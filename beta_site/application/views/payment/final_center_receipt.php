      ...
      <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb25">
            <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Payment Status: </b><?=$payment_status_display?></div>
            ...
            <div class="tm_invoice_left">
			 <p class="tm_mb2"><b class="tm_primary_color">Receipt To:</b></p>
              <p>
                ...
                Head Name: <?=$head_name?><br>
                Head Email:  <?=$head_email?><br>
                Head Contact Number: <?=$head_contact_number?><br>
                Center Address: <?=$address_display?><br>
