<?php include('Crypto.php');
	...
	*/
	...
	$this->db->select('tbl_consolidated_marksheet.*,tbl_student.center_id,tbl_student.student_name,tbl_student.mobile,tbl_student.email,tbl_student.address,tbl_student.pincode');
        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0" style="margin-right:10px">Receipt No: <b>#<?=$result->paymeent_id?></b></p>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
						...
						<td class="tm_width_4">Consolidate Marksheet Fees</td>
