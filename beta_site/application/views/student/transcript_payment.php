...
$session = array(
	...
	'transcript_id' 	=> $student_profile->id,
...
Arunachal Pradesh
										...
										<form method="post" name="customerData" action="<?=base_url();?>student_transcript_ccavRequestHandler">
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													...
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$student_profile->id?>"/></td>
												...
												<tr>
													...
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_transcript_ccavResponseHandler"/></td>

												</tr>

												<tr>

													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_transcript_ccavResponseHandler"/></td>
												...
												<tr>
													...
													<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?=$student_profile->student_name?>"/></td>

												</tr>

												<tr>

													<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?=$student_profile->address?>"/></td>
												...
												<tr>
													...
													<td>Billing Zip	:</td><td><input type="text" name="billing_zip" value="<?=$student_profile->pincode?>"/></td>
												...
												<tr>
													...
													<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?=$student_profile->mobile?>"/></td>

												</tr>

												<tr>

													<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?=$student_profile->email?>"/></td>
