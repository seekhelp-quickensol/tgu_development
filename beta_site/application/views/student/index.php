					...
					<div class="row">
							...
							<div class="card">
								<div class="card-body col-lg-12">
									...
									<div class="row icons-list">
										...
										<div class="col-sm-12">
											<a href="<?=base_url();?>id-card-print">
											  <i class="mdi mdi-access-point"></i> ID Card
											</a>
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url();?>asmission-form-print" target="_blank">
											  <i class="mdi mdi-file-check btn-icon-prepend"></i>
											  Admission Form
											</a>
										</div>
										<?php if($student_profile->noc !=""){?>
											<div class="col-sm-12">
											<a href="<?=base_url();?>my-noc">
											  <i class="mdi mdi-file-check btn-icon-prepend"></i>
											  NOC
											</a>
										</div>
										<?php }?>
										<div class="col-sm-12">
											<a href="<?=base_url();?>student-qualification-details">
											  <i class="mdi mdi-file-check btn-icon-prepend"></i>
											  Qualifications
											</a>
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url();?>my_results">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Results
											</a>
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url("marksheets");?>">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Marksheet
											</a>
										</div>
										<?php if($this->Students_model->get_student_profile()->course_id==23): ?>
										<div class="col-sm-12">
											<a href="<?=base_url();?>provisional_registration_letter" > 
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
										...
										<?php endif; ?>
										<div class="col-sm-12">
											<a href="<?=base_url('student-provisional-degree');?>">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Provisional Degree
											</a>									
										</div>
										<div class="col-sm-12">
											<!--<a href="<?=base_url("student-degree");?>">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Degree
											</a>-->
											<a href="#">
										...
										<!--<?php if($this->Students_model->get_student_profile()->course_id==23){ ?>
											<?php if($marksheet != '0'){?>
												<div class="col-sm-12">
													<a href="<?=base_url();?>print_student_course_work_marksheet">
													  <i class="fas fa-certificate" ></i>        
										...
										<div class="col-sm-12">
											<a href="<?=base_url("transfer-certificate");?>">
											 <i class="fas fa-certificate" ></i>                                                  
											  Transfer Certificate
											</a>										
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url("transcript_application");?>">
											  <i class="mdi mdi-upload btn-icon-prepend"></i>                                                    
											  Transcript
											</a>
										</div>
										...
										<div class="col-sm-12">
											<a href="<?=base_url("migration-certificate");?>">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Migration
											</a>
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url("latter-of-recommendation");?>">
												<i class="mdi mdi-file-check btn-icon-prepend"></i>
												Letter of Recommendation
											</a>
										</div>
										<div class="col-sm-12">
											<a href="<?=base_url();?>e_library" > 
										...
										<?php if(!empty($student_profile) && $student_profile->course_id == "23"){?>
											<div class="col-sm-12">
												<a href="<?=base_url("thesis_submission")?>">
													<i class="mdi mdi-file-check btn-icon-prepend"></i>
													Thesis Submission
												</a>									
											</div>
											<div class="col-sm-12">
												<a href="<?=base_url("synopsis_submission")?>">
													<i class="mdi mdi-file-check btn-icon-prepend"></i>
													Synopsis Submission
												</a>									
											</div>
											<div class="col-sm-12">
												<a href="<?=base_url("abstract")?>">
													<i class="mdi mdi-file-check btn-icon-prepend"></i>
													Abstract Report
												</a>									
											</div>
											<div class="col-sm-12">
												<a href="<?=base_url("progress_report")?>">
													<i class="mdi mdi-file-check btn-icon-prepend"></i>
													Progress Report 
 												</a>									
											</div>
											<?php $course_work = $this->Students_model->get_single_marksheet_result();
											if(count($course_work)>0){?>
											<div class="col-sm-12">
												<a target="blank" href="<?=base_url("course_work_result")?>">
													<i class="mdi mdi-file-check btn-icon-prepend"></i>
													Course Work Result
												</a>									
											</div>
						...
						<div class="col-sm-4 flex-column d-flex stretch-card">
							<div class="card congratulation-bg text-center" style="background: url(<?=$this->Digitalocean_model->get_photo('images/sort_profile.jpg')?>);background-size: cover;">
								...
								<?php if(!empty($student_profile) && $student_profile->photo !=""){ $pforfile = $student_profile->photo; }else{ $pforfile = "default.jpg"; }?>
									<img style="border-radius: 78px;height: 150px;" src="<?=$this->Digitalocean_model->get_photo('images/profile_pic/'.$pforfile)?>" alt="">  
									<h2 class="mt-3 text-white mb-3 font-weight-bold">Welcome
										<?=$student_profile->student_name?>!
									</h2>
									<p><?=$admission->print_name?> (<?=$admission->stream_name?>)
									</p>
								</div>
							</div>
						</div>
