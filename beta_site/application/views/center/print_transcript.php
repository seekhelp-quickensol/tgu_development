<?php $university_details = $this->Setting_model->get_university_details(); Naharlagun, Itanagar
$roman=array( 
	1	=>	"I", 
	2	=>	"II", 
	3	=>	"III", 
    ...
    <div class="transcript_container"> 
        <div class="header_details" style="height:140px;">  
            <div class="logo_details"> 
                <img src="<?=$this->Digitalocean_model->get_photo('images/btu_header_image.jpg')?>" style="display:block;max-width:50%;margin: 0px auto;"> 
		...
		">
		<h4 class="text-center" style="color: #335c9e;">Canchipur, Imphal West, Arunachal Pradesh-795003</h4>
