...
<style>
	...
	.candidates-resume-content h5{
		margin-bottom: 25px;
	}
	.candidates-resume-content img{
		    width: 37%;
		margin-bottom: 10px;
	}
...
<div class="page-title-area bg-15">
	...
	<div class="container">
		...
		<div class="page-title-content">
			...
			<h2>Download Agreement Document</h2>
			...
			<ul>
				...
				<li><a href="javascript:void(0);">Collaboration Form</a></li>

				<li class="active">Download Agreement Document</li>
			...
			<div class="col-lg-12 col-md-12">
				...
				<div class="admission_box">
					...
					<div class="candidates-resume-content">
						...
						<form class="resume-info" method="post" name="collaboration_form" id="collaboration_form" enctype="multipart/form-data">
							<div class="col-lg-12">
								<div class="row">
									<div class="col-lg-4">
										<a href="<?=$this->Digitalocean_model->get_photo('images/collaboration_agreement_document/collaboration.pdf')?>" target="_blank">
									...
									<div class="col-lg-4">
										<a href="<?=$this->Digitalocean_model->get_photo('images/collaboration_agreement_document/agreement_draft.pdf')?>" target="_blank">
											<img src="<?=base_url();?>assets/images/pdf.png">
											<h5>Agreement</h5>
										</a>
									</div>
									...
									<div class="col-lg-4">
										<a href="<?=$this->Digitalocean_model->get_photo('images/collaboration_agreement_document/application-form-non-medical.pdf')?>" target="_blank">
											<img src="<?=base_url();?>assets/images/pdf.png">
											<h5>Application Form Non Medical</h5>
										</a>
									</div>
									<div class="col-lg-12">
										<p>Kindly download the above documents, fill them out, and after completing, please email them along with the attached documents to <a href="mailto:info@tgu.ac.in">info@tgu.ac.in</a>.</p>
									</div>
								</div>
								<input type="hidden" name="center_id" id="center_id" value="<?php echo base64_decode($this->uri->segment(2));?>">
								<input type="hidden" name="payment_id" id="payment_id" value="<?php echo base64_decode($this->uri->segment(3));?>">
								<button type="submit" class="default-btn" name="agreement_status" id="skip" value="Continue">Continue</button>
							</div>
