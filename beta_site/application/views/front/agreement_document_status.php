				...
				<div class="admission_box">
					...
					<div class="candidates-resume-content">
						...
						<form class="resume-info" method="post" name="collaboration_form" id="collaboration_form" enctype="multipart/form-data">
							<div class="col-lg-12">
								<h5>Do you want the agreement document??</h5>
								...
								<button type="submit" class="default-btn" name="agreement_status" id="skip" value="Skip">Skip</button>
								<button type="submit" class="default-btn" name="agreement_status" id="yes" value="Yes">Yes</button>
							</div>
