				 ...
				 <div>
					<div class="box assesment_layer shadow-sm rounded bg-white ">
                     <div class="box-title border-bottom p-3">
                        <h6 class="m-0">My Results</h6>
                     </div>
                     <div class="box-body p-0">

                        <?php if($result){ foreach($result as $result_result){ 
                        ?>
								...
								<span class="ml-auto mb-auto text-right">
									<div class="btn-group">
										<button class="click_course set_layer_<?=$result_result->id?> dropdown-item" type="button" data-course='<?=$result_result->id?>'> 
											<a href="<?=base_url();?>show_my_result/<?=$result_result->id?>"><i class="fa fa-desktop" aria-hidden="true"></i> View Result</a>
										</button>
									</div>
									<br>
								</span> 
