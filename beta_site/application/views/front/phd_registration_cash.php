...
<button class="btn btn-primary" id="printButton" onclick="printChallan()">Print Receipt</button>
</div>
    ...
    <td width="255" style="border-right:dotted"><table width="250" border="0">
      <tr>
        <td colspan="2" align="center">
            ...
            <div class=""><img src="<?=$this->Digitalocean_model->get_photo('images/logo/global_university_logo.png')?>"></div>
...
<tr>
    ...
    <td width="255" style="border-right:dotted">
    <table width="255" border="0" style="padding-left:5px">
        <tr>
            <td colspan="2" align="center">
                <!-- <div class=""><img src="<?= base_url(); ?>images/logo/<?php if(!empty($university_details) && $university_details->logo != "") { echo $university_details->logo; } else { echo "demologo.png"; } ?>"></div> -->
                <div class=""><img src="<?=$this->Digitalocean_model->get_photo('images/logo/global_university_logo.png')?>"></div>   
