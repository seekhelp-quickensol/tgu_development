...
<div class="page-title-area bg-14">
			<div class="container">
				<div class="page-title-content">
					<h2>Download Hallticket Form</h2>
				...
				<div class="row justify-content-center align-items-center">
					...
					<div class="col-lg-6 col-md-6">
                        ...
                        <div class="admission_box">
                            ...
                            <form class="Enrollmentform" name="re_appear_hallticket_form" id="re_appear_hallticket_form" method="get" enctype="multipart/form-data">
	...
	jQuery.validator.addMethod("noHTMLtags", function(value, element){
		...
		$('#re_appear_hallticket_form').validate({
			rules: {
				enrollment_number: {
					required: true,   
				},	
