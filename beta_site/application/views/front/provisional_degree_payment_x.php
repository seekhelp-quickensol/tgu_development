                    ...
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1">
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
											...
											<form method="post" name="customerData" action="<?=base_url();?>student_provisional_ccavRequestHandler">
											...
											<div class="btn_center"> 
											  ...
											  <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. 1100</b> to get your Provisional Degree ,If you click on payment button, you will be redirect to payment gateway page immediately</p> 
