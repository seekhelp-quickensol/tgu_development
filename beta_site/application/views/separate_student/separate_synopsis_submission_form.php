            ...
            <div class="row">
                ...
                <?php if(empty($single_synopsis)){?>
                    ...
                    <div class="card"> 
                        <div class="card-body">
                            <form id="synopsis_form" id ="synopsis_form" method="POST"  enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="thesis_title" name="thesis_title" value="<?php if(!empty($single_synopsis)){ echo $single_synopsis->thesis_title;}?>" class="form-control custom_select"  aria-describedby="" placeholder="Thesis title name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="hidden_id" name="hidden_id" value="<?php if(!empty($single_synopsis)){ echo $single_synopsis->id;}?>" class="form-control custom_select"  aria-describedby="" placeholder="Category Name">
                                </div>
                                <div class="form-group">
                        ...
                        <?php } 
                        if(!empty($single_synopsis) && $single_synopsis->synopsis_status == "2"){ ?>
