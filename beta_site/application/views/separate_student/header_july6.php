...
<html lang="en">
	...
	<head>
		...
		.overlay__inner {
			...
			width: 100%;BIR TIKENDRAJIT UNIVERSITY
					...
					<div class="container-fluid">
						...
						<div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
							...
							<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
								...
								<a class="navbar-brand brand-logo" href="<?=base_url();?>student-dashboard"><img src="<?=base_url();?>images/logo/<?php if(!empty($university_details) && $university_details->logo != ""){ echo $university_details->logo;}else{ echo "demologo.png";}?>" alt="logo"/></a>

								<a class="navbar-brand brand-logo-mini" href="<?=base_url();?>student-dashboard"><img src="<?=base_url();?>images/logo/<?php if(!empty($university_details) && $university_details->logo != ""){ echo $university_details->logo;}else{ echo "demologo.png";}?>" alt="logo"/></a>
							...
							<ul class="navbar-nav navbar-nav-right">
								...
								<li class="nav-item nav-profile dropdown">
									...
									<a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
										...
										<img src="<?=base_url();?>images/profile_pic/default.jpg" alt="profile"/>

									</a>

									<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">

										<a class="dropdown-item" target="_blank" href="<?=base_url();?>s_admission_form_print">
