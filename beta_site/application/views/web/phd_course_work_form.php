               ...
               <div class="admission_div">
                  <form method="POST" name="admission_form" id="admission_form" >
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="col-sm-3">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="state_id"  value="<?php if(!empty($stu_data)){echo $stu_data->state_name;}?>" readonly>
                        ...
                        <div class="col-md-12" id="div1">
                           ...
                           <div class="col-sm-2">
                              <div class="form-group">
                                 ...
                                 <input placeholder="Amount " type="number" id="amount1" name="ammount[]" class="form-control" >
                              </div>
                           </div>
                        </div>
                        </div>
                     ...
                     <div class="col-sm-2">
                              <div class="form-group">
                                 <label>Amount <span class="req">*</span></label>
                                 <input type="text" class="form-control" name="payment_ammount" value="5000" readonly>
                              </div>
                           </div></div>
                     </div>
