								...
								<div class="col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group">
										  ...
										  <input type="text" name="passport_number" placeholder="Passport Number" id="passport_number" class="form-control">
										</div>
									</div>
								</div>	
							</div>
								...
								<div class="col-md-12">	
									<div class="col-md-4">
										<div class="form-group">
										  ...
										  <input type="text" class="form-control" id="present_address" name="present_address" placeholder="Present Address" value="<?php if(!empty($single)){ echo $single->present_address;}?>">
										</div>
									</div> 
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
										  ...
										  <input type="text" class="form-control" id="present_pincode" name="present_pincode" placeholder="Pincode" value="<?php if(!empty($single)){ echo $single->pincode;}?>">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-md-12"> 
									<div class="col-md-4">
										<div class="form-group">
										  ...
										  <input type="text" class="form-control" id="collaboration_address" name="collaboration_address" placeholder="Present Address" value="<?php if(!empty($single)){ echo $single->present_address;}?>">
										</div>
									</div> 
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
										  <label for="exampleInputConfirmPassword1">Pincode *</label>
										  <input type="text" class="form-control" id="collaboration_pincode" name="collaboration_pincode" placeholder="Pincode" value="<?php if(!empty($single)){ echo $single->pincode;}?>">
										</div>
									</div>
 ...
 $(document).ready(function () {		
  ...
  return this.optional(element) || /^[a-zA-Z0-9\-\s\&\.\,]+$/.test(value);
	...
	$.validator.addMethod("validate_passport", function(value, element) {
        return this.optional(element) || /^(?!^0+$)[a-zA-Z0-9]{3,20}$/i.test(value);
    });
...
$("#present_country").change(function(){  
	$.ajax({
		...
		data:{'country':$("#present_country").val()},
...
$("#collaboration_country").change(function(){  
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>admin/Ajax_controller/get_state_ajax",
		data:{'country':$("#collaboration_country").val()},
		success: function(data){
...
$("#collaboration_state").change(function(){  
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>admin/Ajax_controller/get_city_ajax",
		data:{'state':$("#collaboration_state").val()},
		success: function(data){
...
$("#permanent_country").change(function(){  
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>admin/Ajax_controller/get_state_ajax",
		data:{'country':$("#permanent_country").val()},
		success: function(data){
...
$("#permanent_state").change(function(){  
	$.ajax({
		type: "POST",
		url: "<?=base_url();?>admin/Ajax_controller/get_city_ajax",
		data:{'state':$("#permanent_state").val()},
		success: function(data){
...
$("#head_email").keyup(function(){  
	$.ajax({
		...
		data:{'head_email':$("#head_email").val()},
		success: function(data){
			if(data==0){
				$("#email_val").val(data);
			}else{
...
$("#head_contact_number").keyup(function(){  
	$.ajax({
		...
		data:{'head_contact_number':$("#head_contact_number").val()},
		success: function(data){
			if(data==0){
