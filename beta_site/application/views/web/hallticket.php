                                    ...
                                    <table style="width:100%; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="<?=base_url();?>images/logo/<?php if(!empty($university_details)){ echo $university_details->logo;}?>" alt="Logo" style="width: 75px; height: 75px;">
                                        ...
                                        <tr>
											 ...
											 <td>
                                                ...
                                                <div class="uni-details">
                                                    ...
                                                    <span style="color: #101444d1; font-size: 30px; font-weight: bold;">BIR TIKENDRAJIT UNIVERSITY</span>

													<p style="margin:2px 0px;">Complete Learning Management </p>	

													<p style="margin-top: 2px;margin-bottom: 5px;font-size: 18px;font-weight: 600;color: #3b3e66;">Canchipur, near Arunachal Pradesh University, South View. Imphal West, Arunachal Pradesh-795003</p>
                                ...
                                <td colspan="3" style="text-align: center;">
                                    ...
                                    <div style="float: right; border: 1px solid; width: 180px; height: 35px; margin-right: 7px;">
                                        ...
                                        <span style="float: right; margin-right: 30px; font-size: 15px; font-weight: bold;margin-top: 7px;">
                                            ...
                                            <label ID="lblIdno"><?=$student->enrollment_number?></label></span>
                                    ...
                                    <div style="float: right; border: 1px solid; margin: 30px -135px 0 0;">
                                        ...
                                        <img id="imgpo" width="100px" height="100px" Style="margin: 5px 5px 5px 5px;" src="<?=base_url();?>images/profile_pic/<?=$student->photo?>" />
                                    ...
                                    <div style="float: right; border: 1px solid; width: 180px; height: 40px; margin: 135px -184px 0 0;">
                                        ...
                                        <img id="Imagesignature" width="100px" height="30px" style="margin: 5px 5px 5px 5px;" src="<?=base_url();?>images/signature/<?=$student->signature?>" />
                                    ...
                                    <table style="border: 1px solid; margin: -209px 0 0 10px; width: 415px; height: 155px;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="uppercase"><?=$student->student_name?></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="uppercase"><?=$student->father_name?></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="uppercase"><?=date("d/m/Y",strtotime($student->date_of_birth))?></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="uppercase"><?=$student->print_name?></label>
										 ...
										 <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="uppercase"><?=$student->stream_name?></label>
										...
										<td style="padding-left: 10px;">
                                            ...
                                            <td>
											 ...
											 <td>
                                                ...
                                                <label class="uppercase"><?=$student->year_sem?></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <label class="uppercase"><?=$student->category?></label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label id="lbldoorno" ><?=$student->address?></label>
...
expulsion from the University.</p>
                            ...
                            <tr>
								...
								<td>
									...
									<li style="float:right"> <span style="">Signature of Student</span></li>
