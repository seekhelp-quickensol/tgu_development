	...
	window.onload = function() {
		...
		document.getElementById("tid").value = d;
		  ...
		  <!-----Axis Bank Payment---->
		   ...
		   <!--<form enctype="application/json" action="https://checkout.freecharge.in/api/v1/co/pay/init" id="searchForm" method="post" class="form-group">
		...
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"></font></caption></table>
			...
			<table width="40%" height="100" border='1' align="center" style="display:none;">
				...
				<tr>
					...
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>re_registration_ccavResponseHandler"/></td>

				</tr>

			 	<tr>

			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>re_registration_ccavResponseHandler"/></td>
