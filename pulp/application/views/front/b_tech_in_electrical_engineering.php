...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">B. Tech in Electrical Engineering</h5>
...
<section class="container diploma-sec">
    ...
    The Electrical Engineering Diploma is like a hands-on training course for people who want to work with electricity. It lasts for three years and teaches you all about electrical stuff like devices and power sources. You learn how to use these things in real-world situations, like in industries. By the end of the course, you're all set to jump into a job in the electrical field.
    </p>
