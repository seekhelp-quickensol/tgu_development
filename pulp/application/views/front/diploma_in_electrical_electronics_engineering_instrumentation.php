...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">Diploma in Electrical & Electronics and Engineering/Instrumentation</h5>
...
<section class="container diploma-sec">
   ...
   The course is suitable for those who want to develop and apply mathematics, science and engineering skills to identify, formulate, and solve electrical/electronic/instrumentation engineering problems. The field of electronics and Instrumentation is vast, and students choose various specialized subjects. This will provide a way for students to acquire specific and specialized knowledge. 
    </p>
