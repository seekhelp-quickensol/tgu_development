...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">Diploma in Mechanical Engineering/Nanotechnology</h5>
...
<section class="container diploma-sec">
    ...
    Diploma in Mechanical Engineering is the discipline of engineering that applies the principles of engineering, physics, materials science, and mathematics. The diploma’s syllabus typically covers subjects like fluid mechanics, manufacturing technology, and the theory of machines, providing students with a strong foundation in the field. The course is ideal for students who want to pursue a career in mechanics, machines & tools. The course enables one to make new tools and machinery. We have provided all the related information about the course
    </p>
	<p>Engineering is a field that is constantly evolving and changing; therefore, TGU is starting ONLINE PROGRAMS for working professionals (Join the course with proper process and employers’ permission).</p>
