...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">Diploma In Automobile Engineering</h5>
...
<section class="container diploma-sec">
   ...
   Automobile engineering is one of the most challenging careers now days. Due to demand and passion on vehicles automobile engineers has lot many opportunities in India as well in abroad. It is the study of engineering that deals with designing the vehicle, manufacturing new products/ new vehicle, Repairing, servicing vehicles. Automobile engineer should be innovative and dedicated to their work. Automobile engineer includes product design engineer, development engineer and manufacturing engineer and so on.
    </p>
    ...
    <ul>
        ...
        <li>Candidates who have completed a relevant ITI program from government recognized centre.</li>
