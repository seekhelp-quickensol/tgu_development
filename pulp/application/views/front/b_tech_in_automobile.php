...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">B. Tech in Automobile</h5>
...
<section class="container diploma-sec">
    ...
    <p>
In a B.Tech in Automobile Engineering, you'll learn all about cars and how they work. From the basics of mechanics to designing and building vehicles, this course covers everything. You'll study topics like vehicle dynamics, engine systems, safety regulations, and new technologies like electric cars. Plus, you'll get hands-on experience through projects and internships with car companies. By the end, you'll be ready for an exciting career in the automotive industry.
    </p>
