...
<div class="header_cc_area" style="background-image:url('<?=$this->Digitalocean_model->get_photo('images/header_area.jpg')?>')">
   <div class="container">
      <div class="row">
         <h1>Membership</h1>
         <p><a href="<?=base_url();?>" class="breadcrumb_heding">Home</a> / Membership</p>
      </div>
   </div>
</div>
      ...
      <div class="row">
         ...
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="border_img">
               <img src="<?=$this->Digitalocean_model->get_photo('images/membership/AIMA-letter.jpg')?>" class="img-responsive" alt=""> 
            </div>
         </div>
         <!--<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="border_img">
               <img src="<?=base_url();?>images/accreditation/iso_certificate_2.png" class="img-responsive" alt=""> 
            </div>
         </div>
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="border_img">
               <img src="<?=base_url();?>images/accreditation/iso_certificate_3.png" class="img-responsive" alt=""> 
            </div>
         </div>-->
      </div>
   </div>
</section>
<!-- <section class="accreditation_wrapper hidden-lg hidden-md hidden-sm mobile_certificate_slider" style="background-image:url('<?=$this->Digitalocean_model->get_photo('images/accreditation/univercity_bg.jpg')?>')">
   <div class="container">
      <div class="row">
...
<script>
      $(document).ready(function () {
         $('.main-dropdown2').addClass('active');
			$('.reco7').addClass('active');
		});
</script>