...
<div class="breakcrumb-wrapper">
    ...
    <div class="card text-white">
      ...
      <div class="card-img-overlay d-flex justify-content-center flex-column container">
        ...
        <h5 class="card-title">B. Tech in Civil Engineering</h5>
...
<section class="container diploma-sec">
    ...
    A B.Tech in Civil Engineering is all about creating the structures and systems that make our world function smoothly. From designing roads and buildings to constructing bridges and highways, civil engineers play a crucial role in shaping our infrastructure. Beyond the construction industry, civil engineers also find opportunities in sectors like oil and energy, transportation, environmental, and more. Whether it's building a new skyscraper or improving transportation networks, civil engineers are at the forefront of creating a better world for everyone.
    </p>
...
<!--
    ...
    <img src="https://www.tgu.ac.in/landing_assets/images/profiles-After-Engineering.png" alt="" class="mt-4 ">
