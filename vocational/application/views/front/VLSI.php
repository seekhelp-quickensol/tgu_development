...
<section class="container diploma-sec">
    ...
    <h2 class="mt-5 mb-2"> Online M.Tech Admissions (Professional unified Learning Programs) <?= $date = date("Y-") . date("y", strtotime("+1 year")); ?> at BTU
