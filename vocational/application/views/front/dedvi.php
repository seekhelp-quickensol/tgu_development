			...
			<div class="header_cc_area" style="background-image:url('<?=$this->Digitalocean_model->get_photo('images/header_area.jpg')?>')">
				...
				<div class="container">
					...
					<div class="col-lg-12 col-md-12">
						...
						<p>Home / Approval/ D.Ed.Spl.Edu(VI)</p>
							...
							<div class="para_area">
								...
								<div class="col-lg-12">
									...
									<div class="para_area_frame">
										<iframe src="<?=$this->Digitalocean_model->get_photo('images/approvals/D.Ed.Spl.Edu(VI).pdf')?>" width="100%" height="900px" frameborder="0"></iframe>
