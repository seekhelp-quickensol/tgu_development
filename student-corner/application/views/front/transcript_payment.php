                        ...
                        <div class="tab-pane active" id="active">
                            <div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
                                <div class="col-lg-12" style="display:block;">
                                    ...
                                    <form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler">
                                    ...
                                    <!-- student_transcript_ccavRequestHandler -->
                                        ...
                                        <table width="40%" height="100" border='1' align="center" style="display:none;">
                                            ...
                                            <tr>
                                                <td>Merchant Id :</td>
                                                <td><input type="text" name="merchant_id" value="266775" /></td>
                                            </tr>
                                            <tr>
                                                <td>Order Id :</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="redirect_url"
                                                        value="<?=base_url();?>student_transcript_ccavResponseHandler" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Cancel URL :</td>
                                            ...
                                            <tr>
                                                <td>Billing City :</td>
                                                <td><input type="text" name="billing_city" value="Manipur" /></td>
                                            </tr>
                                            <tr>
                                                <td>Billing State :</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="delivery_address"
                                                        value="room no.701 near bus stand" /></td>
                                            </tr>
                                            <tr>
                                                <td>shipping City :</td>
