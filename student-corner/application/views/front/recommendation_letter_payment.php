							...
							<div class=" box-table mt-3">
											...
											<div class="box_layer_t"> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_recommendation_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_recommendation_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
