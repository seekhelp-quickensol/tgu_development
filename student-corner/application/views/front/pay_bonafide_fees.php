							     ...
							     <?php if(!empty($student) && $student->admission_status == '4'){?>  
											...
											<form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler"> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_bonafide_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_bonafide_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
									...
									<?php }else{?>
                					    <div class="box_layer_t nodata_img d-flex justify-content-center" style="background-image:url('<?=base_url();?>images/nodata.jpg')">    
                					        <div class="btn_center"> 
            									<div class="step_Box">
            										<p>Sorry! You are not eligible to apply for Bonafide Certificate.</p>
            									</div>
            								</div> 
            							</div>
            					    <?php }?>
