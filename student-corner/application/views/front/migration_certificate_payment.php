...
$session = array(
	'session_amount' => $migration->amount,
	'migration_order_id' 	=> $migration->id,
);
                    ...
                    <div class="tab-content osahan-table bg-white rounded shadow-sm px-3 pt-1">
                        <div class="tab-pane active" id="active">
							<div class=" box-table mt-3">
									...
									<div class="card-body">
									<?php /*<form enctype="application/json" action="https://checkout.freecharge.in/api/v1/co/pay/init" id="searchForm" method="post">
											 <fieldset>
												...
												<div><input type="hidden" id="amount" value="<?= $migration['amount']?>" name="amount"></div>
										...
										<!-- <form method="post" name="customerData" action="<?=base_url();?>student_migration_ccavRequestHandler"> -->
										<form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler">
												...
												<div class="col-lg-12">
												    ...
												    <div class="step_Box">
												        <ul>
														 ...
														 <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete the payment of <b>Rs. <?php if(!empty($amount)){ echo $amount->certificate_fees; }?></b> to get your Migration Certificate, If you click on payment button, you will be redirect to payment gateway page immediately</p> 
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													<td>Order Id	:</td><td><input type="text" name="order_id" value="<?=$migration->id?>"/></td>
												</tr>
												<tr>
													<!-- <td>Amount	:</td><td><input type="text" name="amount" value="<?=$migration->amount?>.00"/></td> -->
												...
												<tr>
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_migration_ccavResponseHandler"/></td>
												</tr>
												<tr>
													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_migration_ccavResponseHandler"/></td>
												</tr>
												<tr>
