                        ...
                        <div class="tab-pane active" id="active">
							<div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
							    <div class="col-lg-12" style="display:block;">
											...
											<form method="post" name="customerData" action="<?=base_url();?>student_consolidate_ccavRequestHandler"> 
												<div class="row"> 
													<div class="col-lg-12">
												...
												<tr> 
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_consolidate_ccavResponseHandler"/></td> 
												</tr> 
												<tr> 
													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_consolidate_ccavResponseHandler"/></td> 
												</tr> 
												<tr> 
