                                        ...
                                        <div class="btn_center"> 
                                            ...
                                            <button type="submit" class="btn btn-success" value="CheckOut">Click to Pay</button> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_character_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_character_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
