							...
							<div class=" box-table mt-3">
											<form method="post" name="customerData" action="<?=base_url();?>online_payment_RequestHandler"> 
												...
												<table  height="100" border='1' align="center" style="display:none;"> 
													...
													<tr> 
														<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>second_student_recommendation_ccavResponseHandler"/></td> 
													</tr> 
													<tr> 
														<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>second_student_recommendation_ccavResponseHandler"/></td> 
													</tr> 
													<tr>	 
