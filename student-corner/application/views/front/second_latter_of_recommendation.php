<?php include('header.php');
	if(!empty($recommendation) && $recommendation->payment_status != '1'){
		redirect('second_pay_recommendation_letter_fees');
	}		
?>
<style>
@page {
    ...
    <div class="container">
        <div class="row">
            <div class="layer_data">
                <div class="col-md-12">
                    <h2 class="mb-3">II Letter of Recommendation</h2>
                        ...
                        <div class="tab-pane active" id="active">
							<div class="table-responsive box-table mt-3" style="padding-bottom: 20px;">
							    <?php if(!empty($student) && $student->admission_status == '4'){?> 
    								<?php  
    								if(empty($first_recommendation)){?>
    								
    								<div class="btn_center"> 
    									<div class="step_Box">
    										 <p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete I Recommendation Letter to apply for II Recommendation.</p>
    									</div>
    								</div>
    								...
    								if(empty($recommendation)){ ?> 
    										...
    										<a style="text-align:center" href="<?=base_url("second_pay_recommendation_letter_fees");?>" class="btn btn-success">Pay Recommendation letter fees</a> 
    									</div>
    								<?php }else{ ?>  
    										...
    										<div class="box_layer_t">
    										 ...
    										 <div class="box_layer_t">
    												<div class="btn_center"> 
    												    ...
    												    <p class="mid_bix">Congratulations! your Recommendation Letter has been approved, please <a href="<?=base_url();?>second_print_recommendation_letter/<?=base64_encode($recommendation->id);?>" target="_blank">Click here</a> to print your Recommendation Letter.</p>
    										    </div> 
    										<?php } ?> 
    								<?php }} ?>	  
    							<?php }else{?>
            					    <div class="box_layer_t nodata_img d-flex justify-content-center" style="background-image:url('<?=base_url();?>images/nodata.jpg')">    
            					        <div class="btn_center"> 
        									<div class="step_Box">
        										<p>Sorry! You are not eligible to apply for II Letter of Recommendation.</p>
        									</div>
        								</div> 
        							</div>
        					    <?php }?>
