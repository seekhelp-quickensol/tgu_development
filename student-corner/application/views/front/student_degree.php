							    ...
							    <?php if(!empty($student) && $student->admission_status == '4'){?>   
    								<?php if(empty($result_data)){?>
    									...
    									<div class="btn_center"> 
    										<div class="step_Box">
    											<p>Sorry! You are not eligible to apply Degree</p>
    										</div>
    									</div> 
        							<?php }else{?>
        								<?php if($student->center_id == "1" || $student->center_verification_status == "1"){?>
        								<?php if(empty($degree)){
        										/*if($student->degree_cert =="1" || $student->center_id == "1"){ 
        								?>
        									...
        									<p class="mid_bix">Dear <b><?=$student->student_name?></b>, please complete Degree payment/fees to get your Degree.</p>
        								<a style="text-align:center" href="<?=base_url("pay_degree_fees");?>" class="btn btn-success">Pay Degree fees</a> 
        							</div>
        									...
        									<?php }else{?>  
        											...
        											<p class="mid_bix">Dear <b> <?=$student->student_name?></b>, please accept our terms & conditions to continue for your degree, when you will click on <b>I Accept Terms & Conditions</b> you will received an email on your registered email you have to accept by clicking link that will received over mail, then payment button will be activate automatically</p>
        												<a href="<?=base_url("accept_degree_undertaking");?>" class="btn btn-success">I Accpet Terms & Conditions</a>
        											</div>
        										<?php  
        									}*/?>
        								...
        								<a style="text-align:center" href="<?=base_url("pay_degree_fees");?>" class="btn btn-success">Pay Degree fees</a> 
        									...
        									<?php }else{ ?>
        										<?php if($degree->approve_status == '0'){ ?>
        											<div class="box_layer_t"> 
        										<div class="btn_center"> 
        												    <div class="step_Box">
        												        <ul>
        												 	...
        												 	<p class="mid_bix">Dear <b><?=$student->student_name?></b>, Please be patient your  Degree is under process, once it will approved your  Degree will be availble here.</p>
        										...
        										<?php }else{ ?>
        										 <div class="box_layer_t">
        												    ...
        												    <p class="mid_bix">Congratulations! your  Degree has been approved, please <a href="<?=base_url();?>print_degree/<?=base64_encode($degree->id)?>" target="_blank">Click here</a> to print your Degree.</p>
        										    </div> 
        										<?php } ?> 
        										<?php } ?>	
        								...
        								?>
        									...
        									<div class="btn_center"> 
        										...
        										<p class="mid_bix">Your document is not verified yet. Please cordinate to your admission counselor.</p>
        									</div> 
        							<?php }}?>
        						<?php }else{?>
            					    <div class="box_layer_t nodata_img d-flex justify-content-center" style="background-image:url('<?=base_url();?>images/nodata.jpg')">    
            					        <div class="btn_center"> 
        									<div class="step_Box">
        										<p>Sorry! You are not eligible to apply for Degree.</p>
        									</div>
        								</div> 
        							</div>
        					    <?php }?>
