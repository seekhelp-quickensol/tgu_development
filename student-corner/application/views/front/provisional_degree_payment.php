							...
							<div class=" box-table mt-3">
											...
											<table width="40%" height="100" border='1' align="center" style="display:none;">
												...
												<tr>
													...
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url();?>student_provisional_ccavResponseHandler"/></td>

												</tr>

												<tr>

													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url();?>student_provisional_ccavResponseHandler"/></td>
